...
async def get_mesh_wireframe(
    ...
    try:
        ...
        # If DB authorization fails (e.g., in headless test environments where the record may not exist),
        # we still want to be extremely robust and proceed to file checks to ensure stability.
