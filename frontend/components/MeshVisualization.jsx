...
export default function MeshVisualization({ simId, vertices, elements, edges }) {
  ...
  return (
    <div className="relative w-full h-[680px] bg-[#111122] border border-slate-800 rounded-xl overflow-hidden shadow-2xl flex flex-col font-sans">
      {/* 1. Header Bar */}
      ...
      <div className="relative flex-1 bg-[#1a1a2e]">
        ...
        {loading && (
          <div className="absolute inset-0 bg-[#1a1a2e]/95 flex flex-col justify-center items-center z-20 transition-opacity">
            ...
            <p className="text-xs text-slate-455 mt-1 text-slate-400">Extracting and deduplicating tetrahedral edges from Palace output</p>
          </div>
        )}
        ...
        {error && (
          <div className="absolute inset-0 bg-[#1a1a2e] flex flex-col justify-center items-center px-8 text-center z-20">
            <div className="p-3.5 bg-red-955/40 text-red-400 rounded-full mb-4 border border-red-900/50">
        ...
        {!loading && !error && (
          <>
            ...
            <div className="absolute top-4 left-4 bg-[#16162d]/80 backdrop-blur-md p-3.5 rounded-xl shadow-lg border border-slate-800/60 flex flex-col space-y-3 z-10 w-60">
              <div className="text-xs font-semibold text-slate-200 flex items-center border-b border-slate-850 pb-1.5">
            ...
            <div className="absolute top-4 right-4 bg-[#16162d]/85 backdrop-blur-md p-3.5 rounded-xl shadow-lg border border-slate-800/60 z-10 w-56 flex flex-col space-y-2">
              <div className="text-xs font-semibold text-slate-200 flex items-center border-b border-slate-800/60 pb-1.5">
            ...
            {/* Bottom Info HUD Bar */}
            <div className="absolute bottom-4 left-4 right-4 bg-slate-955/90 backdrop-blur-md px-5 py-3.5 rounded-xl shadow-xl border border-slate-800/80 z-10 flex justify-between items-center text-white">
