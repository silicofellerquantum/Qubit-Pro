...
export default function VisualizationTab({ simId }) {
  ...
  return (
    <div className="w-full h-full min-h-[640px] flex flex-col lg:flex-row bg-[#080814] text-white p-4 gap-4 overflow-y-auto">
      {/* 3D Viewer Area */}
      <div className="flex-1 flex flex-col gap-3 min-h-[580px]">
        {/* Navigation Tabs */}
