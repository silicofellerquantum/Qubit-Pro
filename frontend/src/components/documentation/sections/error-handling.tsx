    ...
    <div className="documentation-page-content max-w-4xl">
      ...
      <section className="mb-16">
        ...
        <p className="text-[var(--muted)] leading-relaxed mb-4">
          <strong>What it is:</strong> Error Handling is a core sub-system of the Silicofeller Quantum Studio platform designed to bridge the gap between abstract quantum intent and physical layout.
        </p>
        <p className="text-[var(--muted)] leading-relaxed mb-4">
      ...
      <section className="mb-16">
        ...
        <div className="p-8 bg-black text-white font-mono text-sm rounded-xl overflow-x-auto whitespace-pre">
          {`Silicofeller Platform -> Error Handling Pipeline

[Parser / Intent Analyzer]
       ↓
[AST / Context Graph]
       ↓
[Core Execution Engine: Error Handling]
       ↓
