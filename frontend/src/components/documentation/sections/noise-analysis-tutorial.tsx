    ...
    <div className="documentation-page-content max-w-4xl">
      ...
      <section className="mb-16">
        ...
        <p className="text-[var(--muted)] leading-relaxed mb-4">
          This section contains documentation relating to Noise Analysis Tutorial. It covers fundamental concepts, practical application, and integration points within the Silicofeller Quantum Studio environment.
        </p>
      </section>
