...
export default function Section() {
  return (
    <>
      ...
      <table className="w-full text-left border-collapse mt-6 mb-8">
        ...
        <tbody className="text-sm text-[var(--muted)]">
          <tr className="border-b border-black/5 hover:bg-black/5 transition-colors">
            ...
            <td className="py-3 px-4">Enables strict type checking and validation for Enterprise Documentation.</td>
          </tr>
          <tr className="border-b border-black/5 hover:bg-black/5 transition-colors">
      ...
      <p className="mb-4">Below is a standard reference implementation used by the Silicofeller synthesis engine. It demonstrates how to initialize the Enterprise Documentation module correctly.</p>
      
      <CodeBlock language="qclang" code={`// Example configuration for Enterprise Documentation
config.enable('enterprise-documentation', true);

config.setOptions('enterprise-documentation', {
  strictMode: true,
  logLevel: 'debug'
});`} />
