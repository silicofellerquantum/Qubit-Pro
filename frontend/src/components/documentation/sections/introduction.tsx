    ...
    <div className="documentation-page-content animate-in fade-in duration-500">
      ...
      <div className="prose prose-lg max-w-none prose-headings:text-[var(--text)] prose-p:text-[var(--muted)] prose-a:text-blue-600">
          ...
          <p className="text-[var(--muted)] leading-relaxed mb-6 text-lg">
            This page provides an in-depth look at <strong>Introduction</strong> within the <strong>DOCUMENTATION</strong> domain. Silicofeller Quantum Studio is engineered from the ground up to handle complex quantum processor design tasks, bridging the gap between high-level logical requirements and low-level physical layout constraints. The system provides an end-to-end pathway from abstract topological requirements to fabrication-ready GDSII layouts, incorporating multi-domain design rule checking (DRC), electromagnetic analysis, and compiler synthesis optimization natively.
          </p>
