    ...
    <>
      <div className="section-heading">
        <div>
          ...
          <h2>Quantum Hardware Library</h2>
        </div>
      </div>
      
      <p className="text-[var(--muted)] mb-8 leading-relaxed">
        In-depth architectural overview and API integration details for Quantum Hardware Library. This module provides researchers and hardware engineers with the necessary tooling to optimize their quantum design lifecycle within the Silicofeller platform. It has been built from the ground up to support massive scale, seamless AI integration via the Copilot, and absolute precision down to the nanometer level.
      </p>
      ...
      <table className="w-full text-left border-collapse mt-6 mb-8">
        ...
        <tbody className="text-sm text-[var(--muted)]">
          <tr className="border-b border-black/5 hover:bg-black/5 transition-colors">
            ...
            <td className="py-3 px-4">Enables strict type checking and validation for Quantum Hardware Library.</td>
          </tr>
          <tr className="border-b border-black/5 hover:bg-black/5 transition-colors">
      ...
      <p className="mb-4">Below is a standard reference implementation used by the Silicofeller synthesis engine. It demonstrates how to initialize the Quantum Hardware Library module correctly.</p>
      
      <CodeBlock language="qclang" code={`// Example configuration for Quantum Hardware Library
config.enable('quantum-hardware-library', true);

config.setOptions('quantum-hardware-library', {
  strictMode: true,
  logLevel: 'debug'
});`} />
