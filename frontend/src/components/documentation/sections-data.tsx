  ...
  "fault-tolerant-quantum-computing": ({ activeHash, onNavigate }) => (
    <>
      ...
      <div className="parameter-table">
        ...
        <article><strong>QEC Threshold</strong><span>The critical physical error rate below which adding correction overhead reduces logical errors.</span></article>
        ...
        <details className="result-sheet result-root" open>
          ...
          <div className="result-nested">
            ...
            <details className="result-category" id="fault-physical-logical">
              ...
              <div className="parameter-table">
                <article><strong>Physical Qubits</strong><span>Real qubits present in quantum hardware (e.g. transmons, fluxoniums). Stores quantum information directly; highly noisy and error-prone.</span></article>
                <article><strong>Logical Qubits</strong><span>Created using multiple physical qubits. Protected by QEC to detect and correct errors automatically, making them error-corrected and reliable.</span></article>
                <article><strong>Overhead Ratio</strong><span>1 Logical Qubit = 100s to 1000s of Physical Qubits. Many physical qubits work together to behave like a stable logical qubit even when individual physical qubits fail.</span></article>
              </div>
            </details>
            ...
            <details className="result-category" id="fault-error-types">
              ...
              <div className="parameter-table">
                <article><strong>Bit Flip Error (X Error)</strong><span>Changes a qubit from |0&#x27E9; to |1&#x27E9; or |1&#x27E9; to |0&#x27E9;. Similar to a classical binary bit error, directly affecting the qubit&#x2019;s state value.</span></article>
                <article><strong>Phase Flip Error (Z Error)</strong><span>Changes the phase of a quantum state without changing the actual state value. Affects the relative phase between quantum states and can lead to incorrect quantum computations.</span></article>
                <article><strong>Combined Error (Y Error)</strong><span>Occurs when both bit-flip and phase-flip errors happen simultaneously. Affects both the state and phase of a qubit, making it more difficult to detect and correct.</span></article>
                <article><strong>Leakage Error</strong><span>Population escapes to non-computational states (|2&#x27E9;, |3&#x27E9;, ...) outside the qubit subspace. Standard QEC assumes a two-level system; leakage requires specialised detection and reset.</span></article>
            ...
            <details className="result-category" id="fault-metrics">
              ...
              <div className="parameter-table">
                ...
                <article><strong>Logical Error Rate (P_L)</strong><span>Probability that a logical qubit fails after error correction. Must satisfy P_L &amp;ll; p.</span></article>
                ...
                <article><strong>QEC Threshold (p_th)</strong><span>If Physical Error Rate &lt; Threshold, QEC improves reliability. If Physical Error Rate &gt; Threshold, QEC becomes ineffective. For the surface code, this threshold is ~1&#x0025;.</span></article>
              </div>
            </details>
            ...
            <details className="result-category" id="fault-code-strategies">
              ...
              <div className="parameter-table">
                ...
                <article><strong>Surface Code</strong><span>Practical implementation of topological QEC. Most widely used QEC code today, compatible with current 2D grids, and forms the foundation of IBM and Google roadmaps. 1 Logical Qubit &amp;tilde; 100-1000+ Physical Qubits.</span></article>
                <article><strong>Color Code</strong><span>Topological QEC code using a colored lattice. Supports more transversal logical gates than Surface Codes, simplifying certain fault-tolerant operations. 1 Logical Qubit &amp;tilde; 100-1000+ Physical Qubits.</span></article>
                <article><strong>Bacon-Shor Code</strong><span>Subsystem QEC code. Combines features of Shor Code and surface-like structures. Requires fewer stabilizer measurements, simplifying error detection. 1 Logical Qubit encoded using a grid of physical qubits.</span></article>
                ...
                <article><strong>Cat Code</strong><span>Bosonic QEC code. Encodes information using superpositions of coherent states ("cat states"). Protects against photon loss. 1 Logical Qubit = Cat States of an Oscillator.</span></article>
                <article><strong>XZZX Surface Code</strong><span>Advanced version of the Surface Code using a different arrangement of X and Z stabilizers. Performs better under biased noise. 1 Logical Qubit &amp;tilde; 100-1000+ Physical Qubits.</span></article>
            ...
            <details className="result-category" id="fault-code-comparison">
              ...
              <div className="parameter-table">
                <article><strong>Surface Code</strong><span>~100–1,000+ physical qubits per logical qubit. High threshold (~1&#x0025;). Compatible with 2D nearest-neighbor planar layouts. Most widely adopted.</span></article>
                <article><strong>Color Code</strong><span>~100–1,000+ physical qubits per logical qubit. Supports more transversal logical gates but requires more complex routing and connectivity.</span></article>
                ...
                <article><strong>GKP / Cat Codes</strong><span>1 oscillator mode per logical qubit. Highly hardware-efficient but sensitive to energy decay and photon loss in bosonic cavities.</span></article>
              </div>
            </details>
            ...
            <details className="result-category" id="fault-key-takeaways">
              ...
              <div className="parameter-table">
                ...
                <article><strong>Logical encoding</strong><span>Logical qubits are built from many noisy physical qubits (typically 100s to 1000s) to create stable, error-corrected units.</span></article>
                <article><strong>Surface Code dominance</strong><span>The Surface Code is the current leader due to its high threshold (~1&#x0025;) and compatibility with 2D planar layouts.</span></article>
                <article><strong>Threshold dependency</strong><span>If the physical error rate is below the threshold, scaling up the code distance improves reliability. Above the threshold, it degrades it.</span></article>
        ...
        <details className="result-sheet result-root"><summary><span>EPR / scQubits Result Tables</span><small>Workbook sheets as learning subcolumns</small></summary><div className="result-nested">
          ...
          <details className="result-category" id="epr-resonator-coupling"><summary>Resonator {"&"} Coupling</summary>
            ...
            <div className="result-nested inner">
              ...
              <details className="result-subcategory"><summary>A. Resonator Properties</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Description</th><th>Optimal / Best Value</th><th>Good Range</th><th>Acceptable Range</th><th>Poor / Worst Value</th><th>Physical Significance</th><th>Key References</th></tr></thead><tbody><tr><td>Resonator Frequency</td><td>ω_r/2π</td><td>GHz</td><td>Bare resonator frequency; should be detuned from qubit to remain in dispersive regime.</td><td>6.5 – 8.5 GHz</td><td>5 – 10 GHz</td><td>3 – 5 GHz</td><td>{"<"} 2 GHz</td><td>Must satisfy |Δ| = |ω_q - ω_r| {">"}{">"} g for dispersive approximation; EPR gives bare frequency.</td><td>Blais et al., PRA 2004; Wallraff et al., Nature 2004</td></tr><tr><td>Resonator Internal Q</td><td>Q_int</td><td>dimensionless</td><td>Internal (material-limited) quality factor of the readout resonator.</td><td>{">"} 10⁵</td><td>10⁴ – 10⁵</td><td>10³ – 10⁴</td><td>{"<"} 500</td><td>Low Q_int adds photon loss increasing measurement back-action and reducing readout SNR.</td><td>Megrant et al., APL 2012; Calusine et al., APL 2018</td></tr><tr><td>Resonator External Q</td><td>Q_ext</td><td>dimensionless</td><td>External quality factor set by coupling to transmission line; determines measurement bandwidth.</td><td>10³ – 10⁴ (fast readout)</td><td>500 – 2×10⁴</td><td>50 – 499</td><td>{"<"} 50</td><td>Too high → slow readout; too low → Purcell-enhanced qubit decay. Optimized with Purcell filter.</td><td>Reed et al., APL 2010; Houck et al., PRL 2008</td></tr><tr><td>Resonator–Qubit Detuning |Δ|</td><td>|Δ|/2π</td><td>GHz</td><td>Frequency detuning between qubit and resonator; must be large compared to coupling g.</td><td>1.0 – 3.0 GHz</td><td>0.5 – 4.0 GHz</td><td>0.1 – 0.5 GHz</td><td>{"<"} 0.05 GHz</td><td>Small detuning violates dispersive approximation; EPR hybridization factor χ tracks this.</td><td>Blais et al., PRA 2004; Gambetta et al., PRA 2006</td></tr><tr><td>Purcell Decay Rate</td><td>γ_P/2π</td><td>kHz</td><td>Qubit decay rate via resonator Purcell channel; κ * (g/Δ)². Must be {"<"}{"<"} 1/T1_target.</td><td>{"<"} 1 kHz</td><td>1 – 10 kHz</td><td>10 – 100 kHz</td><td>{">"} 500 kHz</td><td>Dominant T1 limit in many designs without Purcell filter; directly predicted by EPR p_J^res.</td><td>Houck et al., PRL 2008; Reed et al., APL 2010</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>B. Coupling Strengths</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Description</th><th>Optimal / Best Value</th><th>Good Range</th><th>Acceptable Range</th><th>Poor / Worst Value</th><th>Physical Significance</th><th>Key References</th></tr></thead><tbody><tr><td>Transverse Coupling g/2π</td><td>g/2π</td><td>MHz</td><td>Qubit-resonator coupling strength (Jaynes-Cummings); extracted from EPR as g = √(p_J^res * ω_r * ω_q / 2).</td><td>50 – 150 MHz</td><td>20 – 200 MHz</td><td>5 – 19 MHz</td><td>{"<"} 2 MHz</td><td>Sets χ and readout speed; g/|Δ| {"<"} 0.1 required for dispersive regime.</td><td>Wallraff et al., Nature 2004; Krantz et al., APR 2019</td></tr><tr><td>Dispersive Coupling g/Δ ratio</td><td>g/|Δ|</td><td>dimensionless</td><td>Dimensionless ratio quantifying proximity to strong-coupling limit; must be {"<"}{"<"} 1 for dispersive readout.</td><td>0.01 – 0.05</td><td>0.005 – 0.09</td><td>0.09 – 0.15</td><td>{">"} 0.20</td><td>Ratio {">"} 0.1 causes photon-number-dependent qubit dephasing and higher-order dispersive corrections.</td><td>Gambetta et al., PRA 2006; Boissonneault et al., PRA 2009</td></tr><tr><td>Bus Coupler Coupling (2Q)</td><td>J/2π</td><td>MHz</td><td>Exchange coupling between two qubits via bus resonator or direct capacitance.</td><td>5 – 20 MHz</td><td>2 – 30 MHz</td><td>0.5 – 1.9 MHz</td><td>{"<"} 0.1 MHz</td><td>Too weak → slow two-qubit gates; too strong → residual ZZ. EPR predicts J from geometry.</td><td>Majer et al., Nature 2007; Chen et al., PRL 2014</td></tr><tr><td>Residual ZZ (static)</td><td>ζ_ZZ/2π</td><td>kHz</td><td>Always-on longitudinal (ZZ) qubit–qubit interaction; source of conditional phase errors.</td><td>{"<"} 10 kHz</td><td>{"<"} 100 kHz</td><td>100 – 500 kHz</td><td>{">"} 1 MHz</td><td>Limits two-qubit gate fidelity via conditional phase accumulation; minimized by tunable couplers.</td><td>Ku et al., PRL 2020; Kandala et al., Nature 2021</td></tr><tr><td>Stray Coupling (nearest-neighbor)</td><td>J_stray/2π</td><td>kHz</td><td>Unintended coupling between non-adjacent qubits; extracted from full-chip EPR simulation.</td><td>{"<"} 10 kHz</td><td>{"<"} 50 kHz</td><td>50 – 200 kHz</td><td>{">"} 500 kHz</td><td>Degrades multi-qubit gate fidelity; EPR full-chip simulation essential to identify stray modes.</td><td>Arute et al., Nature 2019; Hertzberg et al., npj QI 2021</td></tr></tbody></table></div></details>
          ...
          <details className="result-category" id="epr-loss-dissipation"><summary>Loss {"&"} Dissipation</summary>
            ...
            <div className="result-nested inner">
              ...
              <details className="result-subcategory"><summary>A. Dielectric Loss (Bulk {"&"} Surface)</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Description</th><th>Optimal / Best Value</th><th>Good Range</th><th>Acceptable Range</th><th>Poor / Worst Value</th><th>Physical Significance</th><th>Key References</th></tr></thead><tbody><tr><td>Bulk Substrate Loss Tangent</td><td>tan δ_bulk</td><td>dimensionless</td><td>Intrinsic dielectric loss of the substrate material (Si, sapphire, SiO2); weighted by bulk EPR participation.</td><td>{"<"} 1×10⁻⁷ (Si, sapphire)</td><td>{"<"} 1×10⁻⁶</td><td>1×10⁻⁶ – 1×10⁻⁵</td><td>{">"} 1×10⁻⁴</td><td>Silicon and sapphire are preferred substrates; amorphous SiO2 has tan δ ~ 10⁻³ (very poor).</td><td>Martinis et al., PRL 2005; Calusine et al., APL 2018</td></tr><tr><td>Metal-Substrate Interface Loss</td><td>tan δ_MS</td><td>dimensionless</td><td>Effective loss tangent of metal–substrate (MS) two-level system (TLS) interface layer.</td><td>{"<"} 1×10⁻³</td><td>{"<"} 3×10⁻³</td><td>3×10⁻³ – 1×10⁻²</td><td>{">"} 5×10⁻²</td><td>MS interface is typically 2–5 nm thick oxide layer; dominant loss in many planar qubits.</td><td>Wang et al., APL 2015; Niepce et al., PRApplied 2019</td></tr><tr><td>Substrate-Air Interface Loss</td><td>tan δ_SA</td><td>dimensionless</td><td>Effective loss tangent of substrate–air (SA) interface; due to adsorbed surface oxides and organics.</td><td>{"<"} 3×10⁻³</td><td>{"<"} 1×10⁻²</td><td>1×10⁻² – 5×10⁻²</td><td>{">"} 0.1</td><td>Cleaning and surface passivation reduce SA loss; participation ratio from EPR isolates this channel.</td><td>Wenner et al., APL 2011; Quintana et al., APL 2014</td></tr><tr><td>Metal-Air Interface Loss</td><td>tan δ_MA</td><td>dimensionless</td><td>Effective loss tangent of metal–air (MA) interface; native oxide on superconducting film top surface.</td><td>{"<"} 3×10⁻³</td><td>{"<"} 1×10⁻²</td><td>1×10⁻² – 5×10⁻²</td><td>{">"} 0.1</td><td>Nb and Al form native oxides; replacing top surface with clean metal reduces MA loss.</td><td>Sandberg et al., APL 2012; Nersisyan et al., Quantum 2019</td></tr><tr><td>Surface Participation Ratio (MS)</td><td>p_MS</td><td>dimensionless</td><td>Fraction of electric field energy in metal-substrate interface region; computed from EPR E-field.</td><td>{"<"} 5×10⁻⁴</td><td>{"<"} 2×10⁻³</td><td>2×10⁻³ – 1×10⁻²</td><td>{">"} 5×10⁻²</td><td>Thinner gaps increase p_MS; EPR identifies geometry changes to reduce interface participation.</td><td>Wenner et al., APL 2011; Gambetta et al., npj QI 2017</td></tr><tr><td>TLS-Limited Quality Factor (1/f)</td><td>Q_TLS</td><td>dimensionless</td><td>Quality factor limited by two-level system (TLS) bath; power- and temperature-dependent.</td><td>{">"} 3×10⁶</td><td>10⁶ – 3×10⁶</td><td>10⁵ – 10⁶</td><td>{"<"} 10⁴</td><td>Q_TLS improves with high drive power (TLS saturation); EPR participations give TLS contribution breakdown.</td><td>Martinis et al., PRL 2005; Müller et al., PRB 2019</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>B. Radiation {"&"} Geometry Loss</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Description</th><th>Optimal / Best Value</th><th>Good Range</th><th>Acceptable Range</th><th>Poor / Worst Value</th><th>Physical Significance</th><th>Key References</th></tr></thead><tbody><tr><td>Radiation Loss Rate</td><td>γ_rad/2π</td><td>kHz</td><td>Energy loss due to electromagnetic radiation from non-closed geometry; computed by EPR from far-field.</td><td>{"<"} 1 kHz</td><td>{"<"} 10 kHz</td><td>10 – 100 kHz</td><td>{">"} 500 kHz</td><td>Open transmission line stubs or poorly designed ground planes lead to radiation loss.</td><td>Houck et al., PRL 2008; Solgun et al., PRApplied 2019</td></tr><tr><td>Seam Loss (3D cavities)</td><td>γ_seam/2π</td><td>kHz</td><td>Loss at mechanical seam between cavity halves; critical for 3D transmon and fluxonium devices.</td><td>{"<"} 1 kHz</td><td>{"<"} 5 kHz</td><td>5 – 50 kHz</td><td>{">"} 200 kHz</td><td>EPR current participation at seam predicts seam loss; improved by indium bonding or tight tolerances.</td><td>Reagor et al., PRB 2016; Brecht et al., npj QI 2016</td></tr><tr><td>Quasiparticle Loss Rate</td><td>γ_qp/2π</td><td>kHz</td><td>Qubit decay due to nonequilibrium quasiparticles tunneling across junction.</td><td>{"<"} 2 kHz</td><td>{"<"} 20 kHz</td><td>20 – 100 kHz</td><td>{">"} 500 kHz</td><td>Quasiparticle poisoning is stochastic; mitigated by gap engineering and quasiparticle traps.</td><td>Catelani et al., PRL 2011; Serniak et al., PRL 2018</td></tr><tr><td>Vortex Loss (in-field operation)</td><td>γ_vortex/2π</td><td>kHz</td><td>Loss from magnetic vortices in superconducting film when operated in residual magnetic field.</td><td>{"<"} 1 kHz ({"<"} 1 µT shield)</td><td>{"<"} 10 kHz</td><td>10 – 100 kHz</td><td>{">"} 500 kHz</td><td>Mitigated by magnetic shielding and moat structures; EPR current maps identify vortex-sensitive areas.</td><td>Stan et al., IEEE Trans. 2004; Chiaro et al., Supercond. Sci. Tech. 2016</td></tr><tr><td>Conductor (Ohmic) Loss</td><td>γ_ohm/2π</td><td>kHz</td><td>Residual ohmic loss from non-superconducting regions or above Tc contributions; usually negligible in Al.</td><td>{"<"} 0.1 kHz</td><td>{"<"} 1 kHz</td><td>1 – 10 kHz</td><td>{">"} 100 kHz</td><td>Typically negligible at mK temperatures; relevant for normal-metal contacts or resistive wirebonds.</td><td>Göppl et al., JAP 2008; Barends et al., APL 2010</td></tr></tbody></table></div></details>
          ...
          <details className="result-category" id="epr-summary-table"><summary>Summary Table</summary>
            ...
            <div className="result-nested inner">
              ...
              <details className="result-subcategory"><summary>Core EPR</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>1</td><td>Core EPR</td><td>Junction Participation Ratio</td><td>p_J</td><td>—</td><td>0.90–0.99</td><td>0.80–0.99</td><td>0.50–0.79</td><td>{"<"} 0.30</td><td>Sets anharmonicity {"&"} qubit nonlinearity</td><td>Increase pad size, reduce gap to substrate</td><td>Minev et al., Nature 2021</td></tr><tr><td>2</td><td>Core EPR</td><td>Resonator Junction Participation</td><td>p_J^res</td><td>—</td><td>{"<"} 1×10⁻³</td><td>{"<"} 1×10⁻²</td><td>1×10⁻²–5×10⁻²</td><td>{">"} 0.10</td><td>Determines Purcell T1 limit</td><td>Increase qubit-resonator detuning</td><td>Reed et al., PRL 2010</td></tr><tr><td>3</td><td>Core EPR</td><td>ZPF Voltage across Junction</td><td>V_zpf</td><td>µV</td><td>10–50 µV</td><td>5–100 µV</td><td>1–200 µV</td><td>{"<"} 0.5 µV</td><td>Governs qubit-photon coupling</td><td>Optimise mode volume and pad geometry</td><td>Minev et al., Nature 2021</td></tr><tr><td>4</td><td>Core EPR</td><td>ZPF Phase</td><td>φ_zpf</td><td>rad</td><td>0.1–0.5 rad</td><td>0.05–0.6 rad</td><td>0.6–0.9 rad</td><td>{">"} 1.0 rad</td><td>Validity of dispersive approximation</td><td>Reduce anharmonicity target or redesign</td><td>Minev Thesis 2018</td></tr><tr><td>5</td><td>Core EPR</td><td>Anharmonicity (EPR)</td><td>α/2π</td><td>MHz</td><td>150–350 MHz</td><td>100–400 MHz</td><td>50–99 MHz</td><td>{"<"} 30 MHz</td><td>Gate speed and leakage limit</td><td>Lower EJ/EC ratio; smaller junction</td><td>Koch et al., PRA 2007</td></tr><tr><td>6</td><td>Core EPR</td><td>Dispersive Shift χ</td><td>χ/2π</td><td>MHz</td><td>0.5–3 MHz</td><td>0.1–5 MHz</td><td>0.01–0.09 MHz</td><td>{"<"} 0.01 MHz</td><td>Readout contrast</td><td>Adjust g/|Δ| ratio via geometry</td><td>Blais et al., PRA 2004</td></tr><tr><td>7</td><td>Core EPR</td><td>Cross-Kerr ZZ</td><td>ζ_ij/2π</td><td>MHz</td><td>{"<"} 0.01 MHz</td><td>{"<"} 0.10 MHz</td><td>0.10–0.50 MHz</td><td>{">"} 1.0 MHz</td><td>Always-on 2Q gate error</td><td>Tunable coupler; echo sequences</td><td>Kandala et al., Nature 2021</td></tr></tbody></table></div></details>
              ...
              <details className="result-subcategory"><summary>Resonator & Coupling</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>14</td><td>Resonator & Coupling</td><td>Resonator Frequency</td><td>ω_r/2π</td><td>GHz</td><td>6.5–8.5 GHz</td><td>5–10 GHz</td><td>3–5 GHz</td><td>{"<"} 2 GHz</td><td>Dispersive regime requirement</td><td>Adjust resonator length/capacitance</td><td>Blais et al., PRA 2004</td></tr><tr><td>15</td><td>Resonator & Coupling</td><td>Resonator Internal Q</td><td>Q_int</td><td>—</td><td>{">"} 10⁵</td><td>10⁴–10⁵</td><td>10³–10⁴</td><td>{"<"} 500</td><td>Readout SNR and back-action</td><td>Improve substrate and metal quality</td><td>Megrant et al., APL 2012</td></tr><tr><td>16</td><td>Resonator & Coupling</td><td>Coupling Strength g/2π</td><td>g/2π</td><td>MHz</td><td>50–150 MHz</td><td>20–200 MHz</td><td>5–19 MHz</td><td>{"<"} 2 MHz</td><td>Sets χ and readout bandwidth</td><td>Adjust coupling capacitor geometry</td><td>Wallraff et al., Nature 2004</td></tr><tr><td>17</td><td>Resonator & Coupling</td><td>Purcell Decay Rate</td><td>γ_P/2π</td><td>kHz</td><td>{"<"} 1 kHz</td><td>1–10 kHz</td><td>10–100 kHz</td><td>{">"} 500 kHz</td><td>T1 limit via resonator</td><td>Add Purcell filter; increase detuning</td><td>Houck et al., PRL 2008</td></tr><tr><td>18</td><td>Resonator & Coupling</td><td>Residual ZZ Static</td><td>ζ_ZZ/2π</td><td>kHz</td><td>{"<"} 10 kHz</td><td>{"<"} 100 kHz</td><td>100–500 kHz</td><td>{">"} 1 MHz</td><td>Conditional phase error</td><td>Tunable coupler; frequency detuning</td><td>Ku et al., PRL 2020</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>Loss & Dissipation</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>19</td><td>Loss & Dissipation</td><td>Bulk Substrate Loss Tangent</td><td>tan δ_bulk</td><td>—</td><td>{"<"} 1×10⁻⁷</td><td>{"<"} 1×10⁻⁶</td><td>1×10⁻⁶–1×10⁻⁵</td><td>{">"} 1×10⁻⁴</td><td>Bulk energy dissipation</td><td>Use float-zone Si or sapphire</td><td>Martinis et al., PRL 2005</td></tr><tr><td>20</td><td>Loss & Dissipation</td><td>Metal-Substrate Interface Loss</td><td>tan δ_MS</td><td>—</td><td>{"<"} 1×10⁻³</td><td>{"<"} 3×10⁻³</td><td>3×10⁻³–1×10⁻²</td><td>{">"} 5×10⁻²</td><td>Dominant TLS loss channel</td><td>Ion mill before deposition; clean surfaces</td><td>Wang et al., APL 2015</td></tr><tr><td>21</td><td>Loss & Dissipation</td><td>Surface Participation (MS)</td><td>p_MS</td><td>—</td><td>{"<"} 5×10⁻⁴</td><td>{"<"} 2×10⁻³</td><td>2×10⁻³–1×10⁻²</td><td>{">"} 5×10⁻²</td><td>Weights MS interface loss to T1</td><td>Wider gaps; ground plane design</td><td>Wenner et al., APL 2011</td></tr><tr><td>22</td><td>Loss & Dissipation</td><td>TLS-Limited Q</td><td>Q_TLS</td><td>—</td><td>{">"} 3×10⁶</td><td>10⁶–3×10⁶</td><td>10⁵–10⁶</td><td>{"<"} 10⁴</td><td>TLS bath limitation</td><td>Surface treatment; new barrier materials</td><td>Müller et al., PRB 2019</td></tr><tr><td>23</td><td>Loss & Dissipation</td><td>Seam Loss Rate (3D)</td><td>γ_seam/2π</td><td>kHz</td><td>{"<"} 1 kHz</td><td>{"<"} 5 kHz</td><td>5–50 kHz</td><td>{">"} 200 kHz</td><td>3D cavity assembly limit</td><td>Indium sealing; tighter tolerances</td><td>Reagor et al., PRB 2016</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>Junction Parameters</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>24</td><td>Junction Parameters</td><td>Josephson Inductance</td><td>L_J</td><td>nH</td><td>5–20 nH</td><td>2–50 nH</td><td>50–200 nH</td><td>{">"} 500 nH</td><td>Sets qubit frequency</td><td>Junction area and J_c control</td><td>Koch et al., PRA 2007</td></tr><tr><td>25</td><td>Junction Parameters</td><td>Josephson Energy</td><td>EJ/h</td><td>GHz</td><td>10–50 GHz</td><td>5–100 GHz</td><td>100–500 GHz</td><td>{">"} 1 THz</td><td>Qubit spectrum with EC</td><td>Barrier thickness and area</td><td>Nakamura et al., Nature 1999</td></tr><tr><td>26</td><td>Junction Parameters</td><td>Charging Energy</td><td>EC/h</td><td>MHz</td><td>150–350 MHz</td><td>100–500 MHz</td><td>500–1000 MHz</td><td>{">"} 2 GHz</td><td>Anharmonicity and charge sensitivity</td><td>Shunt capacitor area tuning</td><td>Koch et al., PRA 2007</td></tr><tr><td>27</td><td>Junction Parameters</td><td>Junction Loss Tangent</td><td>tan d_J</td><td>—</td><td>{"<"} 3×10⁻⁶</td><td>{"<"} 1×10⁻⁵</td><td>1×10⁻⁵–1×10⁻⁴</td><td>{">"} 1×10⁻³</td><td>Intrinsic junction T1 limit</td><td>ALD AlOx; crystalline barriers</td><td>Martinis et al., PRL 2005</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>Simulation</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>28</td><td>Simulation</td><td>Eigenfrequency Convergence</td><td>Δf/f</td><td>ppm</td><td>{"<"} 5 ppm</td><td>{"<"} 50 ppm</td><td>50–500 ppm</td><td>{">"} 1000 ppm</td><td>Accuracy of all extracted parameters</td><td>More refinement passes; finer mesh</td><td>Minev Thesis Yale 2018</td></tr><tr><td>29</td><td>Simulation</td><td>Energy Error</td><td>ΔU/U</td><td>%</td><td>{"<"} 0.1%</td><td>{"<"} 0.5%</td><td>0.5–2%</td><td>{">"} 5%</td><td>Bounds participation ratio error</td><td>Increase mesh density at interfaces</td><td>Ansys HFSS Docs 2023</td></tr><tr><td>30</td><td>Simulation</td><td>Participation Sum Check</td><td>Σp</td><td>—</td><td>0.99–1.01</td><td>0.97–1.03</td><td>0.93–1.07</td><td>{"<"} 0.90 or {">"} 1.10</td><td>Simulation completeness check</td><td>Include all eigenmodes up to 20 GHz</td><td>Minev et al., Nature 2021</td></tr></tbody></table></div></details>
