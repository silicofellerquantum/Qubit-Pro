...
export const SECTIONS_DATA: Record<string, React.FC<SectionProps>> = {
  home: ({ activeHash, onNavigate }) => <HeroSection onNavigate={onNavigate} />,
  "getting-started": ({ activeHash, onNavigate }) => (
    <>
      ...
      <div className="section-heading">
        ...
        <div>
          {" "}
          <p className="eyebrow">Onboarding Tutorial</p> <h2>Onboarding Tutorial</h2>{" "}
        </div>{" "}
        <button className="copy-button" type="button" data-copy-section="getting-started">
          Copy page
        </button>{" "}
      </div>{" "}
      <p>
      ...
      <div className="info-box">
        ...
        <p>
          ...
          outputs fully validated quantum chip designs. You do not write <code>.qc</code> source
          files; you write natural language descriptions, and the parser engine converts them into
          validated JSON using Pydantic data models.{" "}
        </p>{" "}
      </div>{" "}
      <ol className="learning-list">
        {" "}
        <li>
          <strong>Foundational:</strong> understand what a QCLang prompt is, how the parser reads
          it, and what structured JSON output it produces (chip, qubits, resonators, couplers).
        </li>{" "}
        <li>
          <strong>Intermediate:</strong> learn qubit-count extraction, topology selection, automatic
          frequency assignment, position calculation, and Pydantic constraint validation.
        </li>{" "}
        <li>
          <strong>Advanced:</strong> connect QCLang through the backend API, understand{" "}
          <code>rules.json</code> hardware defaults, physics defaults, vocabulary maps, and how to
          extend them.
        </li>{" "}
      </ol>{" "}
    </>
  ...
  "hello-world": ({ activeHash, onNavigate }) => (
    <>
      ...
      <div className="section-heading">
        ...
        <div>
          {" "}
          <p className="eyebrow">Foundational</p> <h2>Hello World</h2>{" "}
        </div>{" "}
        <button className="copy-button" type="button" data-copy-section="hello-world">
          Copy page
        </button>{" "}
      </div>{" "}
      <p>
        ...
        describing the chip you want, and the <code>QLangParser</code> produces a complete validated
      ...
      <div className="code-card">
        ...
        <pre>
          <code>Just a basic 2 qubit line</code>
        </pre>{" "}
      </div>{" "}
      <div className="code-card">
        {" "}
        ...
        <pre>
          <code>{`{ "chip": { "name": "2_qubit_line_chip", "width_mm": 12.0, "height_mm": 12.0, "substrate": "sapphire", "layers": [ { "name": "metal", "material": "aluminum", "thickness_nm": 200.0 }, { "name": "junction", "material": "Al/AlOx/Al", "thickness_nm": 50.0 }, { "name": "dielectric", "material": "silicon_oxide", "thickness_nm": 100.0 } ] }, "qubits": [ { "id": "Q0", "component_type": "TransmonCross", "frequency_ghz": 5.0, "anharmonicity_mhz": -330.0, "junction": { "type": "single", "ej_ghz": 15.0, "ec_mhz": 300.0 }, "geometry": { "pos_x": "0um", "pos_y": "0um", "cross_width": "20um", "cross_length": "200um", "cross_gap": "20um" } }, { "id": "Q1", "component_type": "TransmonCross", "frequency_ghz": 5.2, "anharmonicity_mhz": -325.0, "junction": { "type": "single", "ej_ghz": 15.0, "ec_mhz": 300.0 }, "geometry": { "pos_x": "1000um", "pos_y": "0um", "cross_width": "20um", "cross_length": "200um", "cross_gap": "20um" } } ], "resonators": [ { "id": "R0", "component_type": "RouteMeander", "frequency_ghz": 7.0, "target_qubit": "Q0", "coupling_type": "capacitive", "coupling_strength_mhz": 50.0 }, { "id": "R1", "component_type": "RouteMeander", "frequency_ghz": 7.2, "target_qubit": "Q1", "coupling_type": "capacitive", "coupling_strength_mhz": 50.0 } ], "couplers": [ { "id": "C01", "component_type": "RoutePath", "source_qubit": "Q0", "target_qubit": "Q1", "strength_mhz": 4.0, "coupler_type": "capacitive" } ] }`}</code>
        </pre>{" "}
      </div>{" "}
      <div className="info-box">
        {" "}
        ...
        <p>
          ...
          substrate (sapphire), two <code>TransmonCross</code> qubits placed 1000 μm apart on a
          line, two <code>RouteMeander</code> readout resonators each offset +2 GHz above qubit
          frequency, and one <code>RoutePath</code> coupler at 4 MHz capacitive coupling strength.
  ...
  installation: ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Setup</p> <h2>Installation</h2>{" "}
      <p>
        {" "}
      ...
      <div className="code-card">
        ...
        <pre>
          <code>{`# From the project root pip install -r backend/requirements.txt # Core dependencies used by QCLang: # pydantic — data model validation # re — NLP regex extraction (stdlib) # json — rules.json loading (stdlib)`}</code>
        </pre>{" "}
      </div>{" "}
      <div className="code-card">
        {" "}
        ...
        <pre>
          <code>{`cd "backend/qclang model" python qlang_parser.py`}</code>
        </pre>{" "}
      </div>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          <strong>Parser file</strong>
          <span>
            <code>backend/qclang model/qlang_parser.py</code> — contains the{" "}
            <code>QLangParser</code> class and Pydantic models.
          </span>
        </article>{" "}
        <article>
          <strong>Rules file</strong>
          <span>
            <code>backend/qclang model/rules.json</code> — hardware defaults, physics defaults,
            constraints, and vocabulary. Loaded at import time.
          </span>
        </article>{" "}
        <article>
          <strong>Backend service</strong>
          <span>
            The full Qubit-Pro backend runs via <code>python backend/run.py</code> or Docker Compose
  ...
  "using-python": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Development</p> <h2>Using Python and QCLang</h2>{" "}
      <p>
        {" "}
        QCLang's parser is a pure Python class. You can instantiate <code>QLangParser</code>{" "}
        directly and call <code>parse_prompt()</code> with any natural-language string. The method
        returns a JSON string of the validated chip design, or an error JSON if the prompt cannot be
        understood or violates constraints.{" "}
      </p>{" "}
      <div className="code-card">
        {" "}
        <div className="code-title">Direct Python usage</div>{" "}
        <pre>
          <code>{`import sys sys.path.append("backend/qclang model") from qlang_parser import QLangParser parser = QLangParser() # Parse a natural language prompt result = parser.parse_prompt("Create a 4 qubit square chip for qiskit metal") print(result) # Returns validated JSON string # Or use word-form numbers result2 = parser.parse_prompt("Give me a square layout with four transmons") print(result2) # Same result — word_map converts "four" → 4 # Star topology example result3 = parser.parse_prompt("I want a 5-qubit star topology") print(result3)`}</code>
        </pre>{" "}
      </div>{" "}
      <div className="code-card">
        {" "}
        <div className="code-title">
          Internal parse flow (what parse_prompt does step by step)
        </div>{" "}
        <pre>
          <code>{`# 1. Lowercase the prompt prompt = prompt.lower() # 2. Extract qubit count (regex + word_map from rules.json) num_qubits = self._extract_qubit_count(prompt) # e.g. "4" or "four" → 4 # 3. Extract topology (checks for "line", "square", "star", "ring") topology = self._extract_topology(prompt) # defaults to "line" # 4. Calculate qubit positions based on topology and min_qubit_spacing_um (1000 μm) positions = self._calculate_positions(num_qubits, topology, self.spacing) # 5. Build raw data dict (chip, qubits, resonators) raw_data = { "chip": {...}, "qubits": [...], "resonators": [...], "couplers": [] } # 6. Add couplers based on topology self._build_couplers(raw_data["couplers"], num_qubits, topology) # 7. Validate with Pydantic (QLangOutputModel) → returns JSON string validated = QLangOutputModel(**raw_data) return validated.model_dump_json(indent=2)`}</code>
        </pre>{" "}
      </div>{" "}
      <div className="info-box">
        {" "}
        ...
        <p>
          {" "}
          If the parser cannot determine qubit count, it returns{" "}
          <code>{`{"error": "Could not determine the number of qubits from the prompt."}`}</code>.
          If constraints are violated (e.g. more than 5 qubits), Pydantic returns a validation error
          JSON.{" "}
        </p>{" "}
      </div>{" "}
    </>
  ...
  "user-guide": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">User Guide</p> <h2>User Guide</h2>{" "}
      <p>
        {" "}
        This guide teaches how QCLang fits into the full Qubit-Pro workflow: from writing a
        natural-language chip description to receiving a validated JSON design ready for Qiskit
        Metal or downstream simulation.{" "}
      </p>{" "}
      <div className="pipeline">
        ...
        <article>
          ...
          <h3>Write</h3>
          <p>
            Write a plain English prompt specifying qubit count, topology, and any design intent. No
        ...
        <article>
          ...
          <h3>Parse</h3>
          <p>
            The <code>QLangParser</code> extracts qubit count, topology, assigns frequencies,
            computes positions, and builds couplers.
          </p>
        </article>{" "}
        <article>
          <span>3</span>
          <h3>Validate</h3>
          <p>
            Pydantic models check all fields: frequency range (1–10 GHz), anharmonicity (must be
            negative), qubit count (1–5), and connectivity.
          </p>
        </article>{" "}
        <article>
          <span>4</span>
          <h3>Output</h3>
          <p>
            Receive a structured JSON chip design with chip metadata, qubits, resonators, and
            couplers — ready for Qiskit Metal or the Qubit-Pro frontend.
          </p>
        </article>{" "}
      </div>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          <strong>Supported topologies</strong>
          <span>
            <code>line</code> — qubits placed in a 1D row. <code>square</code> / <code>ring</code> —
            2×2 grid arrangement (requires ≥ 4 qubits). <code>star</code> — one central qubit
            connected to all others (requires ≥ 3 qubits).
          </span>
        </article>{" "}
        <article>
          <strong>Qubit count recognition</strong>
          <span>
            Digits ("4") and English words ("four", "single", "pair", "couple") are both recognized
            via the vocabulary word_map in rules.json.
          </span>
        </article>{" "}
        <article>
          <strong>Frequency assignment</strong>
          <span>
            Qubits Q0–Q4 are assigned frequencies [5.0, 5.2, 5.0, 5.2, 5.0] GHz from
            physics_defaults. Readout resonators are offset +2.0 GHz above each qubit frequency.
          </span>
        </article>{" "}
      </div>{" "}
    </>
  ...
  "qclang-overview": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Overview Tutorial</p> <h2>QCLang Overview Tutorial</h2>{" "}
      <p>
        {" "}
        ...
        users describe what they want in plain English, and QCLang's parser handles all the physics,
        geometry, and hardware defaults automatically.{" "}
      </p>{" "}
      <div className="info-box">
        {" "}
        ...
        <p>
          {" "}
          A user submits a natural-language prompt (e.g. "Design a 4-qubit square chip"). The{" "}
          <code>QLangParser</code> lowercases it, extracts the qubit count via regex and a word map,
          extracts the topology keyword, calculates 2D qubit positions using a topology algorithm
          and the 1000 μm minimum spacing constraint, assigns frequencies and anharmonicities from
          physics defaults, constructs readout resonators and couplers, then validates the entire
          structure through Pydantic's <code>QLangOutputModel</code> before returning validated
          JSON.{" "}
        </p>{" "}
      </div>{" "}
      <ul className="learning-list">
        {" "}
        <li>
          <strong>Input:</strong> a plain English prompt string — no file format, no special syntax.
        </li>{" "}
        <li>
          <strong>NLP extraction:</strong> regex + vocabulary word_map from <code>rules.json</code>{" "}
          identifies qubit count and topology.
        </li>{" "}
        <li>
          <strong>Position calculation:</strong> topology algorithms produce (x, y) coordinates with
          minimum 1000 μm qubit spacing.
        </li>{" "}
        <li>
          <strong>Pydantic validation:</strong> <code>QLangOutputModel</code> enforces frequency
          bounds, negative anharmonicity, qubit count limits (1–5), and connectivity rules.
        </li>{" "}
        <li>
          <strong>Output:</strong> validated JSON chip design returned to the frontend or backend
          API caller.
        </li>{" "}
      </ul>{" "}
    </>
    ...
    <>
      ...
      <div className="two-column">
        ...
        <article>
          ...
          <p>
            Use a digit or an English number word directly before the word "qubit", "qubits",
            "transmon", or "transmons". Both forms work:
          </p>{" "}
          <pre>
            <code>{`"Create a 4 qubit chip" ✓ digit form "Give me four transmons" ✓ word form "I want a 5-qubit chip" ✓ hyphenated digit "Design a pair of qubits" ✓ word_map: pair = 2 "Just a single transmon" ✓ word_map: single = 1`}</code>
          </pre>{" "}
        </article>{" "}
        <article>
          {" "}
          ...
          <p>
            Include one of the four topology keywords anywhere in the prompt. If none is found, the
            parser defaults to <code>line</code>:
          </p>{" "}
          <pre>
            <code>{`"line" → 1D row, any qubit count "square" → 2×2 grid, requires ≥ 4 qubits "ring" → 2×2 grid, requires ≥ 4 qubits "star" → hub-and-spoke, requires ≥ 3 qubits`}</code>
          </pre>{" "}
        </article>{" "}
      </div>{" "}
      <div className="code-card">
        ...
        <pre>
          <code>{`word_map = { "zero": 0, "one": 1, "two": 2, "three": 3, "four": 4, "five": 5, "single": 1, "double": 2, "couple": 2, "pair": 2 } valid_topologies = ["line", "square", "star", "ring"]`}</code>
        </pre>{" "}
      </div>{" "}
    </>
  ),
  "syntax-part-2": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        ...
        Part 2 documents what those defaults are, so you understand exactly what each prompt
        produces.{" "}
      </p>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          <strong>Chip defaults</strong>
          <span>
            Substrate: sapphire · Chip size: 12.0 × 12.0 mm · Metal layer: aluminum 200 nm ·
            Junction layer: Al/AlOx/Al 50 nm · Dielectric layer: silicon_oxide 100 nm
          </span>
        </article>{" "}
        <article>
          <strong>Qubit geometry defaults</strong>
          <span>
            Component type: TransmonCross · cross_width: 20 μm · cross_length: 200 μm · cross_gap:
            20 μm · claw_length: 30 μm · claw_width: 10 μm · claw_gap: 6 μm
          </span>
        </article>{" "}
        <article>
          <strong>Resonator defaults</strong>
          <span>
            Component type: RouteMeander · trace_width: 10 μm · trace_gap: 6 μm · total_length: 7 mm
            · fillet: 50 μm · meander_spacing: 200 μm · frequency = qubit_freq + 2.0 GHz
          </span>
        </article>{" "}
        <article>
          <strong>Coupler defaults</strong>
          <span>
            Component type: RoutePath · trace_width: 10 μm · trace_gap: 6 μm · coupling strength:
            4.0 MHz · coupler type: capacitive
          </span>
        </article>{" "}
        <article>
          <strong>Physics defaults</strong>
          <span>
            Qubit frequencies: [5.0, 5.2, 5.0, 5.2, 5.0] GHz · Anharmonicity base: −330 MHz, step:
            +5 MHz per qubit · E_J: 15 GHz · E_C: 300 MHz · Resonator coupling: 50 MHz capacitive
          </span>
        </article>{" "}
        <article>
          <strong>Hard constraints</strong>
          <span>
            Max qubits: 5 · Min qubits: 1 · Min qubit spacing: 1000 μm · Edge margin: 200 μm · Min
            frequency detuning: 100 MHz
          </span>
        </article>{" "}
      </div>{" "}
      <div className="info-box">
        ...
        <p>
          {" "}
          Requesting more than 5 qubits returns{" "}
          <code>{`{"error": "Validation failed", "details": "Maximum of 5 qubits allowed."}`}</code>
          . Requesting 0 qubits returns a similar minimum-qubit error. These are enforced by the
          Pydantic <code>validate_qubit_limit</code> validator.{" "}
        </p>{" "}
      </div>{" "}
    </>
  ),
  "language-reference": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Language Reference</p> <h2>QCLang Output Model Reference</h2>{" "}
      <p>
        {" "}
        Every QCLang prompt produces a JSON object with four top-level keys. This page documents
        each key, its fields, and where each value comes from.{" "}
      </p>{" "}
      <div className="reference-grid">
        ...
        <article>
          ...
          <h3>chip</h3>{" "}
          <p>
            Global chip metadata. Contains <code>name</code> (auto-generated from qubit count and
            topology), <code>width_mm</code>, <code>height_mm</code>, <code>substrate</code>, and a{" "}
            <code>layers</code> array (metal, junction, dielectric).
          </p>{" "}
        </article>{" "}
        <article>
          {" "}
          <h3>qubits</h3>{" "}
          <p>
            Array of qubit objects. Each has <code>id</code> (Q0, Q1…), <code>component_type</code>{" "}
            (TransmonCross), <code>frequency_ghz</code>, <code>anharmonicity_mhz</code> (always
            negative), a <code>junction</code> object (E_J, E_C), and a <code>geometry</code> object
            with position and cross dimensions.
          </p>{" "}
        </article>{" "}
        <article>
          {" "}
          <h3>resonators</h3>{" "}
          <p>
            Array of readout resonator objects. Each has <code>id</code> (R0, R1…),{" "}
            <code>component_type</code> (RouteMeander), <code>frequency_ghz</code> (qubit freq + 2
            GHz offset), <code>target_qubit</code> (which qubit it reads),{" "}
            <code>coupling_type</code>, and <code>coupling_strength_mhz</code>.
          </p>{" "}
        </article>{" "}
        <article>
          {" "}
          <h3>couplers</h3>{" "}
          <p>
            Array of inter-qubit coupler objects. Each has <code>id</code> (C01, C02…),{" "}
            <code>component_type</code> (RoutePath), <code>source_qubit</code>,{" "}
            <code>target_qubit</code>, <code>strength_mhz</code>, and <code>coupler_type</code>.
            Connectivity pattern is determined by topology.
          </p>{" "}
        </article>{" "}
      </div>{" "}
      <div className="code-card">
        ...
        <pre>
          <code>{`line: Q0-Q1-Q2-Q3-Q4 (chain) square: Q0-Q1, Q0-Q2, Q1-Q3, Q2-Q3 (2×2 grid) ring: same as square star: Q0-Q1, Q0-Q2, Q0-Q3... (Q0 is hub)`}</code>
        </pre>{" "}
      </div>{" "}
    </>
  ),
  "compiler-reference": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Compiler Reference</p> <h2>QCLang Parser Pipeline</h2>{" "}
      <p>
        {" "}
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Normalize</td>
            <td>
              <code>prompt.lower()</code>
            </td>
            <td>Lowercased string for consistent matching</td>
          </tr>{" "}
          <tr>
            <td>Count extraction</td>
            <td>
              <code>_extract_qubit_count()</code>
            </td>
            <td>Integer qubit count (digit regex or word_map lookup)</td>
          </tr>{" "}
          <tr>
            <td>Topology extraction</td>
            <td>
              <code>_extract_topology()</code>
            </td>
            <td>Topology string: "line" | "square" | "star" | "ring"</td>
          </tr>{" "}
          <tr>
            <td>Position calculation</td>
            <td>
              <code>_calculate_positions()</code>
            </td>
            <td>List of (x, y) coordinates in μm based on topology algorithm</td>
          </tr>{" "}
          <tr>
            <td>Data assembly</td>
            <td>Python dict construction</td>
            <td>Raw dict: chip + qubits + resonators (no couplers yet)</td>
          </tr>{" "}
          <tr>
            <td>Coupler building</td>
            <td>
              <code>_build_couplers()</code>
            </td>
            <td>Coupler list based on topology connectivity pattern</td>
          </tr>{" "}
          <tr>
            <td>Pydantic validation</td>
            <td>
              <code>QLangOutputModel(**raw_data)</code>
            </td>
            <td>Validated model — raises ValidationError on constraint violations</td>
          </tr>{" "}
          <tr>
            <td>JSON serialization</td>
            <td>
              <code>model.model_dump_json(indent=2)</code>
            </td>
            <td>Final JSON string returned to caller</td>
          </tr>{" "}
        </tbody>{" "}
      </table>{" "}
      <div className="info-box">
        ...
        <p>
          ...
          <code>Resonator</code> (frequency 1–12 GHz), <code>Coupler</code> (strength ≥ 0), and{" "}
          <code>QLangOutputModel</code> (1–5 qubits via <code>validate_qubit_limit</code>).{" "}
        </p>{" "}
      </div>{" "}
    </>
  ),
  "design-rules": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Design Rules</p> <h2>QCLang Design Rules and Constraints</h2>{" "}
      <p>
        {" "}
        QCLang enforces design rules automatically. All constraints are defined in{" "}
        <code>rules.json</code> and loaded at parser startup. Violations produce error JSON rather
        than partial outputs.{" "}
      </p>{" "}
      <div className="reference-grid">
        {" "}
        <article>
          ...
          <p>
            <strong>Min: 1 qubit.</strong> <strong>Max: 5 qubits.</strong> Prompts requesting 0 or
            more than 5 qubits return a Pydantic validation error. This reflects Qiskit Metal layout
        ...
        <article>
          ...
          <p>
            <strong>Min qubit spacing: 1000 μm (1 mm)</strong> between qubit centers. Edge margin:
            200 μm from chip boundary. All positions are calculated automatically — the parser
            enforces spacing, not the user.
          </p>{" "}
        </article>{" "}
        <article>
          {" "}
          ...
          <p>
            Qubit frequency must be between <strong>1.0 and 10.0 GHz</strong>. Resonator frequency
            must be between <strong>1.0 and 12.0 GHz</strong>. Min frequency detuning between
            adjacent qubits: <strong>100 MHz</strong> (alternating 5.0 / 5.2 GHz pattern).
          </p>{" "}
        </article>{" "}
        <article>
          {" "}
          ...
          <p>
            Anharmonicity must be <strong>negative (≤ 0 MHz)</strong>. Default starts at −330 MHz
            for Q0 and increases by +5 MHz per qubit (Q1: −325 MHz, Q2: −320 MHz…). Positive
            anharmonicity will fail Pydantic validation.
          </p>{" "}
        </article>{" "}
      </div>{" "}
      <div className="code-card">
        ...
        <pre>
          <code>{`"constraints": { "max_qubits": 5, "min_qubits": 1, "min_qubit_spacing_um": 1000, "edge_margin_um": 200, "min_frequency_detuning_mhz": 100 }`}</code>
        </pre>{" "}
      </div>{" "}
    </>
  ),
  targets: ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Output Targets</p> <h2>QCLang Output Targets</h2>{" "}
      <p>
        {" "}
        QCLang currently produces one primary output format: validated JSON. This JSON is structured
        to be directly usable with Qiskit Metal and the Qubit-Pro frontend. Future targets are
        planned as the project expands.{" "}
      </p>{" "}
      <div className="target-list">
        ...
        <article>
          ...
          <p>
            The default output of <code>parse_prompt()</code>. A structured JSON string containing
            chip metadata, qubits (TransmonCross), resonators (RouteMeander), and couplers
            (RoutePath). This is the JSON intermediate representation used by the Qubit-Pro frontend
            and backend APIs.
          </p>{" "}
        </article>{" "}
        <article>
          ...
          <h3>qiskit_metal</h3>{" "}
          <p>
            The component types in the JSON (<code>TransmonCross</code>, <code>RouteMeander</code>,{" "}
            <code>RoutePath</code>) map directly to Qiskit Metal component classes. The geometry
            parameters (cross_width, trace_width, fillet, etc.) are Qiskit Metal parameters. The
            JSON can be consumed to programmatically instantiate Qiskit Metal designs.
          </p>{" "}
        </article>{" "}
        <article>
          {" "}
          <h3>Qubit-Pro API</h3>{" "}
          <p>
            The parser is exposed through backend API endpoints (<code>/api/qclang/parse</code>,{" "}
            <code>/api/qclang/compile</code>). The frontend editor submits prompts to these
  ...
  "chip-synthesis": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Chip Synthesis</p> <h2>Chip Synthesis</h2>{" "}
      <p>
        {" "}
        Chip synthesis in QCLang means converting a natural-language prompt into a complete,
        placement-ready chip design graph. The <code>QLangParser</code> handles all five synthesis
        stages automatically without user intervention.{" "}
      </p>{" "}
      <div className="pipeline">
        {" "}
        <article>
          ...
          <h3>Parse intent</h3>
          <p>
            Extract qubit count and topology from the prompt using regex and the word_map vocabulary
            in rules.json.
          </p>
        </article>{" "}
        <article>
          ...
          <h3>Place qubits</h3>
          <p>
            Calculate 2D (x, y) positions for all qubits using the topology algorithm and the 1000
            μm minimum spacing constraint.
          </p>
        </article>{" "}
        <article>
          <span>3</span>
          <h3>Assign physics</h3>
          <p>
            Assign qubit frequencies from the physics_defaults list, compute anharmonicities (−330
            MHz base, +5 MHz step), and set E_J / E_C junction parameters.
          </p>
        </article>{" "}
        <article>
          <span>4</span>
          <h3>Build resonators and couplers</h3>
          <p>
            Create one RouteMeander readout resonator per qubit at qubit_freq + 2 GHz, and add
            RoutePath couplers between connected qubits based on topology connectivity rules.
          </p>
        </article>{" "}
        <article>
          <span>5</span>
          ...
          <p>
            Run all Pydantic model validators (frequency bounds, anharmonicity sign, qubit count
            limits), then serialize to JSON for the frontend or downstream tooling.
          </p>
        </article>{" "}
      </div>{" "}
    </>
  ...
  "superconducting-materials": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Chip Synthesis</p> <h2>Superconducting Materials</h2>{" "}
      <p className="section-lead">
        {" "}
        This page explains the material families that a superconducting quantum-chip design flow
        must describe before layout, fabrication, HFSS simulation, Q3D extraction, and EPR/scQubits
        analysis.{" "}
      </p>{" "}
      <div className="info-box">
        {" "}
        ...
        <p>
          ...
          functional layers: Each slide covers one material: Role · Properties · Critical
          Temperature · Importance for qubit coherence
        </p>{" "}
      </div>{" "}
      <div className="parameter-table material-family-grid">
        {" "}
        <article>
          <strong>Superconducting Metals</strong>
          <span>
            Aluminum (Al), Niobium (Nb), Molybdenum Rhenium (MoRe), and Indium (In). These materials
            form qubit electrodes, resonators, wiring, and flip-chip interconnects.
          </span>
        </article>
        <article>
          <strong>Superconducting Compounds</strong>
          <span>
            Titanium Nitride (TiN), Niobium Nitride (NbN), and Niobium Titanium Nitride (NbTiN).
            These support high kinetic inductance, photon detection, high-Q microwave circuits, and
            magnetic-field-tolerant designs.
          </span>
        </article>
        <article>
          <strong>Substrates and Barriers</strong>
          <span>
            Silicon (Si), Sapphire (Al2O3), and Aluminum Oxide (AlOx). These define the chip
            foundation and the Josephson junction tunnel barrier that creates qubit nonlinearity.
          </span>
        </article>{" "}
      </div>{" "}
    </>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <p>
            ...
            junctions — the heart of every superconducting qubit. Its long coherence times and
            CMOS-compatible deposition make it one of the most practical materials for scalable
        ...
        <div className="material-detail">
          ...
          <ul>
            <li>Type I superconductor — minimal trapped flux vortices</li>
            <li>Naturally forms AlOx tunnel barrier (~1–2 nm thick)</li>
            <li>Shadow evaporation enables precise Josephson junction fabrication</li>
            <li>Compatible with scalable superconducting qubit fabrication workflows</li>
            <li>Low decoherence from TLS defects when surface is clean</li>
          </ul>{" "}
        </div>{" "}
      </article>{" "}
    </>
  ...
  "material-niobium-nb": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Superconducting Materials</p> <h2>Niobium (Nb)</h2>{" "}
      <p className="section-lead">High-Tc Superconductor for Resonators {"&"} Wiring</p>{" "}
      <article className="material-card material-card-page">
        {" "}
        <div>
          {" "}
          <p className="eyebrow">Tc = 9.3 K</p> <h3>Niobium (Nb)</h3>{" "}
        ...
        <div className="material-detail">
          ...
          <strong>Why it matters</strong>{" "}
          <p>
            Niobium's higher critical temperature gives a wider thermal margin. It is the material
            of choice for resonators and readout structures in high-qubit-count processors.
            Sputter-deposited as thin films, it enables scalable multi-layer chip architectures for
        ...
        <div className="material-detail">
          ...
          <strong>Key facts</strong>{" "}
          <ul>
            <li>Type II superconductor — operates well in moderate magnetic fields</li>
            <li>Widely used in SRF (superconducting radio-frequency) cavities</li>
            <li>Preferred for multi-layer, high-qubit-count chip stacks</li>
            <li>Sputter-deposited as thin films on Si or sapphire wafers</li>
            <li>Critical for scalable quantum processor architectures</li>
          </ul>{" "}
        </div>{" "}
      </article>{" "}
    </>
  ...
  "material-silicon-si-substrate": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Superconducting Materials</p> <h2>Silicon (Si) Substrate</h2>{" "}
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <strong>Why it matters</strong>{" "}
          <p>
            High-resistivity intrinsic silicon is a common substrate because semiconductor
            fabrication techniques are directly compatible. It enables patterning of qubits using
            electron-beam and optical lithography at scale, including double-sided qubit chip
        ...
        <div className="material-detail">
          ...
          <strong>Key facts</strong>{" "}
          <ul>
            <li>Dielectric constant ~11.7; extremely well-characterised</li>
            <li>Float-zone (intrinsic) Si has very low impurity levels</li>
            <li>Compatible with standard cleanroom microfabrication tools</li>
            <li>Loss tangent must be carefully managed at millikelvin temperatures</li>
            <li>Supports double-sided 3-inch wafer fabrication workflows</li>
          </ul>{" "}
        </div>{" "}
      </article>{" "}
    </>
  ...
  "material-sapphire-al2o3-substrate": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Superconducting Materials</p> <h2>Sapphire (Al₂O₃) Substrate</h2>{" "}
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <strong>Why it matters</strong>{" "}
          <p>
            Sapphire offers extremely low dielectric loss and a very clean surface, resulting in
            longer qubit coherence times (\(T_1\), T2). It is useful in processor designs where
            maximising coherence is critical.
          </p>{" "}
        </div>{" "}
        <div className="material-detail">
          {" "}
          <strong>Key facts</strong>{" "}
          <ul>
            <li>Dielectric constant ~9–10; very low loss tangent</li>
            <li>Single-crystal c-plane (0001) orientation preferred</li>
            <li>Cleaner surfaces reduce two-level system (TLS) defects</li>
            <li>Well suited for high-coherence qubit layouts</li>
            <li>Higher cost than silicon but delivers superior coherence times</li>
          </ul>{" "}
        </div>{" "}
      </article>{" "}
    </>
  ...
  "material-titanium-nitride-tin": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Superconducting Materials</p> <h2>Titanium Nitride (TiN)</h2>{" "}
      <p className="section-lead">High Kinetic Inductance Superconductor</p>{" "}
      <article className="material-card material-card-page">
        {" "}
        <div>
          {" "}
          <p className="eyebrow">Tc = 4–5.6 K (tunable)</p> <h3>Titanium Nitride (TiN)</h3>{" "}
        ...
        <div className="material-detail">
          ...
          <p>
            ...
            makes it ideal for compact high-impedance resonators and microwave kinetic inductance
            detectors (MKIDs). Its Tc is tunable by adjusting nitrogen content during reactive
        ...
        <div className="material-detail">
          ...
          <strong>Key facts</strong>{" "}
          <ul>
            <li>High kinetic inductance — enables compact circuit elements</li>
            <li>Tc tunable via N₂ partial pressure during sputtering deposition</li>
            <li>Hard, chemically stable coating — easy to pattern by etching</li>
            <li>Useful in microwave kinetic inductance detector-style structures</li>
            <li>Relevant for next-generation qubit designs</li>
          </ul>{" "}
        </div>{" "}
      </article>{" "}
    </>
  ...
  "material-niobium-nitride-nbn": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Superconducting Materials</p> <h2>Niobium Nitride (NbN)</h2>{" "}
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <strong>Why it matters</strong>{" "}
          <p>
            NbN has the highest Tc among common superconducting nitrides and is prized for
            single-photon detection at near-infrared wavelengths. Its large superconducting gap
            makes it resistant to quasiparticle poisoning — a key decoherence mechanism in qubit
            circuits used in quantum networking nodes.
          </p>{" "}
        </div>{" "}
        <div className="material-detail">
          {" "}
          <strong>Key facts</strong>{" "}
          <ul>
            <li>Highest Tc among common nitrides — operable at 4 K with standard cryostats</li>
            <li>Used in SNSPDs for quantum communication {"&"} networking links</li>
            <li>Large superconducting gap reduces quasiparticle poisoning</li>
            <li>Deposited by reactive magnetron sputtering on MgO or sapphire</li>
            <li>Integrated into quantum networking nodes alongside transmon qubits</li>
          </ul>{" "}
        </div>{" "}
      </article>{" "}
    </>
  ...
  "material-niobium-titanium-nitride-nbtin": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Superconducting Materials</p> <h2>Niobium Titanium Nitride (NbTiN)</h2>{" "}
      <p className="section-lead">Optimised Alloy for Low-Loss Microwave Circuits</p>{" "}
      <article className="material-card material-card-page">
        {" "}
        <div>
          {" "}
          <p className="eyebrow">Tc ≈ 15 K</p> <h3>Niobium Titanium Nitride (NbTiN)</h3>{" "}
        ...
        <div className="material-detail">
          ...
          <strong>Why it matters</strong>{" "}
          <p>
            NbTiN combines the high Tc of NbN with improved thin-film uniformity and magnetic field
            resilience. It is widely used for microwave resonators requiring both high quality
            factor (Q) and resilience to in-plane magnetic fields, making it superior for
            large-scale qubit arrays and flux-tunable designs.
          </p>{" "}
        </div>{" "}
        <div className="material-detail">
          {" "}
          <strong>Key facts</strong>{" "}
          <ul>
            <li>Higher Q resonators compared to plain Nb films</li>
            <li>Resilient to in-plane magnetic fields — ideal for fluxonium qubits</li>
            <li>Excellent film uniformity over large (4-inch+) wafers</li>
            <li>Critical for SQUIDs and superconducting interference devices</li>
            <li>Useful for scalable quantum-platform fabrication flows</li>
          </ul>{" "}
        </div>{" "}
      </article>{" "}
    </>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <p>
            ...
            by controlled thermal oxidation of aluminum, it creates a ~1–2 nm amorphous oxide
            through which Cooper pairs tunnel, producing the non-linear inductance that makes a
            qubit distinct from a classical LC oscillator.
          </p>{" "}
        </div>{" "}
        <div className="material-detail">
          {" "}
          <strong>Key facts</strong>{" "}
          <ul>
            <li>Formed by controlled O₂ exposure of Al surface (thermal oxidation)</li>
            <li>Thickness (~1–2 nm) sets the critical current Ic of the junction</li>
            <li>Amorphous structure introduces TLS defects — primary decoherence source</li>
            <li>Shadow-angle evaporation produces self-aligned Josephson junctions</li>
            <li>Cleaner barriers can extend \(T_1\) coherence times</li>
          </ul>{" "}
        </div>{" "}
      </article>{" "}
    </>
  ...
  "material-molybdenum-rhenium-more": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Superconducting Materials</p> <h2>Molybdenum Rhenium (MoRe)</h2>{" "}
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <p>
            ...
            processes. They are being explored for qubit designs that must tolerate small magnetic
            fields, including topological qubit experiments using Majorana zero modes in
            semiconductor-superconductor hybrid systems.
          </p>{" "}
        </div>{" "}
        <div className="material-detail">
          {" "}
          <strong>Key facts</strong>{" "}
          <ul>
            <li>Tc tunable by adjusting the Mo:Re ratio during co-sputtering</li>
            <li>Compatible with semiconductor (Si) foundry fabrication processes</li>
            <li>Used in hybrid semiconductor-superconductor qubit devices</li>
            <li>Relevant for topological-qubit material stacks</li>
            <li>Useful for evaluating semiconductor-superconductor integration paths</li>
          </ul>{" "}
        </div>{" "}
      </article>{" "}
    </>
  ...
  "material-indium-in-bump-bonds": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Superconducting Materials</p> <h2>Indium (In) Bump Bonds</h2>{" "}
      <p className="section-lead">Superconducting 3D Integration for Scalable Processors</p>{" "}
      <article className="material-card material-card-page">
        {" "}
        <div>
          {" "}
          <p className="eyebrow">Tc = 3.4 K</p> <h3>Indium (In) Bump Bonds</h3>{" "}
          <p className="material-subtitle">
        ...
        <div className="material-detail">
          ...
          <p>
            ...
            multiple quantum chips in a 3D flip-chip stack. This technique enables qubit chips and
            control chips to be connected with low-loss superconducting contacts, crucial for
        ...
        <div className="material-detail">
          ...
          <strong>Key facts</strong>{" "}
          <ul>
            <li>Low melting point (157°C) — compatible with quantum chip processing</li>
            <li>Soft metal: forms reliable superconducting bump bonds under low pressure</li>
            <li>Superconducting at 3.4 K — well below qubit operating temperature (~15 mK)</li>
            <li>Enables scalable 3D quantum processor stacking architectures</li>
            <li>Supports 50–100 qubit multi-chip module workflows</li>
          </ul>{" "}
        </div>{" "}
      </article>{" "}
    </>
  ...
  "materials-summary": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Superconducting Materials</p> <h2>Materials Summary</h2>{" "}
      <p className="section-lead">Quick comparison table for superconducting material selection.</p>{" "}
        ...
        <table className="data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>1.2 K</td>
              <td>Qubit body, JJ electrodes</td>
            </tr>
            <tr>
              <td>Niobium (Nb)</td>
              <td>Superconductor</td>
              <td>9.3 K</td>
              <td>Resonators, wiring layers</td>
            </tr>
            <tr>
              <td>Silicon (Si)</td>
              <td>Substrate</td>
              <td>—</td>
              <td>Qubit chip foundation</td>
            </tr>
            <tr>
              <td>Sapphire (Al₂O₃)</td>
              <td>Substrate</td>
              <td>—</td>
              <td>High-coherence substrate</td>
            </tr>
            <tr>
              <td>Titanium Nitride (TiN)</td>
              <td>Compound SC</td>
              <td>4–5.6 K</td>
              <td>High-kinetic-inductance elements</td>
            </tr>
            <tr>
              <td>Niobium Nitride (NbN)</td>
              <td>Compound SC</td>
              <td>16 K</td>
              <td>SNSPDs, resonators</td>
            </tr>
            <tr>
              <td>NbTiN</td>
              <td>Compound SC</td>
              <td>15 K</td>
              <td>High-Q resonators, SQUIDs</td>
            </tr>
            <tr>
              <td>AlOx (tunnel barrier)</td>
              <td>Dielectric</td>
              <td>—</td>
              <td>Josephson junction tunnel barrier</td>
            </tr>
            <tr>
              <td>MoRe alloy</td>
              <td>Superconductor</td>
              <td>9–14 K</td>
              <td>Hybrid / topological qubits</td>
            </tr>
            <tr>
              <td>Indium (In)</td>
              <td>Superconductor</td>
              <td>3.4 K</td>
              <td>3D flip-chip bump bonds</td>
            </tr>{" "}
          </tbody>{" "}
        </table>{" "}
      </div>{" "}
  ...
  "synthesis-tutorial": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Synthesis Tutorial</p> <h2>Synthesis Tutorial</h2>{" "}
      <p>
        {" "}
        This tutorial walks through the full QCLang synthesis pipeline — from a natural-language
        prompt to a validated chip design — showing what happens at each stage and what data is
        produced.{" "}
      </p>{" "}
      <div className="code-card">
        {" "}
        <div className="code-title">
          Example: "Create a 4 qubit square chip for qiskit metal"
        </div>{" "}
        <pre>
          <code>{`Stage 1: Parse intent → num_qubits = 4 (digit "4" before "qubit") → topology = "square" (keyword found in prompt) → chip_name = "4_qubit_square_chip" Stage 2: Calculate positions (topology="square", spacing=1000 μm) → Q0: (0, 1000) Q1: (1000, 1000) → Q2: (0, 0) Q3: (1000, 0) Stage 3: Assign physics defaults → Q0: freq=5.0 GHz, anh=-330 MHz → Q1: freq=5.2 GHz, anh=-325 MHz → Q2: freq=5.0 GHz, anh=-320 MHz → Q3: freq=5.2 GHz, anh=-315 MHz → R0–R3: freq = qubit_freq + 2.0 GHz Stage 4: Build couplers (square topology) → C01: Q0↔Q1 C02: Q0↔Q2 → C13: Q1↔Q3 C23: Q2↔Q3 Stage 5: Pydantic validation → QLangOutputModel validates all fields → qubit count: 4 ✓ (within 1–5 limit) → frequencies: all within 1–10 GHz ✓ → anharmonicity: all negative ✓ Stage 6: Return validated JSON`}</code>
        </pre>{" "}
      </div>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          <strong>Position algorithm — square/ring</strong>
          <span>
            Places 4 qubits at corners: (0, 1000), (1000, 1000), (0, 0), (1000, 0). Any additional
            qubits beyond 4 are placed in a row below at y = −1000.
          </span>
        </article>{" "}
        <article>
          <strong>Position algorithm — star</strong>
          <span>
            Places Q0 at center (0, 0). Q1: (0, 1000) top. Q2: (1000, 0) right. Q3: (0, −1000)
            bottom. Q4: (−1000, 0) left. Additional qubits cascade diagonally.
          </span>
        </article>{" "}
        <article>
          <strong>Position algorithm — line</strong>
          <span>
            Places qubits in a 1D row: Q0 at (0, 0), Q1 at (1000, 0), Q2 at (2000, 0), etc. Each
            qubit separated by min_qubit_spacing_um = 1000 μm.
          </span>
        </article>{" "}
      </div>{" "}
    </>
  ),
  "fault-tolerant-quantum-computing": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Simulation Tutorials</p> <h2>Fault-Tolerant Quantum Computing</h2>{" "}
      <p className="section-lead">
        {" "}
        Fault tolerance ensures quantum computation continues correctly even when some qubits fail.
        It uses quantum error correction (QEC) techniques to detect and correct errors during
        computation, enabling large-scale quantum processors.{" "}
      </p>{" "}
      <p>
        {" "}
        The central engineering target is to make the logical error probability far smaller than the
        physical error probability: {" \\[P_L \\ll p\\]"}{" "}
      </p>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          <strong>Physical Qubits</strong>
          <span>
            Noisy, fragile, and sensitive to environmental disturbances. Limited reliability for
            long computations.
          </span>
        </article>{" "}
        <article>
          <strong>Logical Qubits</strong>
          <span>
            Stable and error-corrected. Built using multiple physical qubits under QEC protection.
          </span>
        </article>{" "}
        <article>
          <strong>QEC Threshold</strong>
          <span>
            The critical physical error rate {"\\(p_{\\mathrm{th}}\\)"} below which adding
            correction overhead reduces logical errors.
          </span>
        </article>{" "}
        <article>
          <strong>Surface Code</strong>
          <span>
            The most widely used topological QEC code today, compatible with current 2D planar
            architectures.
          </span>
        </article>{" "}
      </div>{" "}
      <div className="result-workbook grouped-results">
        {" "}
        <details className="result-sheet result-root" open>
          {" "}
          <summary>
            {" "}
            <span>Fault Tolerance Concepts and QEC strategies</span>{" "}
            <small>Interactive guide compiled from fault-tolerant slides</small>{" "}
          </summary>{" "}
          <div className="result-nested">
            {" "}
            <details className="result-category" id="fault-introduction">
              {" "}
              <summary>Introduction</summary>{" "}
              <p className="category-note">
                Basic hardware noise sources and the role of fault tolerance.
              </p>{" "}
              <div className="parameter-table">
                {" "}
                <article>
                  <strong>Noise</strong>
                  <span>
                    Unwanted interactions that scramble qubit states, caused by environment, control
                    imperfections, and crosstalk.
                  </span>
                </article>{" "}
                <article>
                  <strong>Decoherence</strong>
                  <span>
                    The process by which quantum information leaks into the surrounding environment
                    over time, destroying superposition.
                  </span>
                </article>{" "}
                <article>
                  <strong>Gate Errors</strong>
                  <span>
                    Imperfect operations that cause incorrect transformations, arising from
                    calibration drift, pulse shape errors, and leakage.
                  </span>
                </article>{" "}
                <article>
                  <strong>Measurement Errors</strong>
                  <span>
                    Readout mistakes that misreport a qubit&#x2019;s state, stemming from
                    insufficient dispersive shift, thermal photons, or amplifier noise.
                  </span>
                </article>{" "}
              </div>{" "}
              <p className="mt-4">
                {" "}
                Fault tolerance combines quantum error correction, redundancy, and error detection
                techniques to maintain reliable computation even in the presence of hardware
                imperfections.{" "}
              </p>{" "}
            </details>{" "}
            <details className="result-category" id="fault-physical-logical">
              {" "}
              <summary>Physical vs Logical Qubits</summary>{" "}
              <p className="category-note">
              ...
              <div className="parameter-table">
                ...
                <article>
                  ...
                  <span>
                    ...
                    states such as \(|0\rangle\), \(|1\rangle\), and \(|\psi\rangle\) directly, but
                    are highly noisy and error-prone.
                  </span>
                </article>{" "}
                <article>
                  <strong>Logical Qubits</strong>
                  <span>
                    ...
                    \(|\psi_L\rangle = \alpha|0_L\rangle + \beta|1_L\rangle\), making it
                    error-corrected and reliable.
                  </span>
                </article>{" "}
                <article>
                  <strong>Overhead Ratio</strong>
                  <span>
                    \(1\) logical qubit \(=\) \(10^2\) to \(10^3\) physical qubits in many practical
                    surface-code estimates. Many physical qubits work together to behave like a
                    stable logical qubit even when individual physical qubits fail.
                  </span>
                </article>{" "}
              </div>{" "}
            </details>{" "}
            <details className="result-category" id="fault-qec-basics">
              {" "}
              <summary>Quantum Error Correction (QEC)</summary>{" "}
              <p className="category-note">
                How QEC detects and corrects faults without collapsing quantum information.
              </p>{" "}
              <p className="mb-4">
                {" "}
                QEC uses auxiliary (ancilla) measurements to find faults and apply fixes, preserving
                the protected quantum state throughout the process.{" "}
              </p>{" "}
              <p className="mb-4">
                {" "}
                The protected information remains in a superposition such as \(|\psi\rangle =
                \alpha|0\rangle + \beta|1\rangle\); QEC extracts only error syndromes, not the
            ...
            <details className="result-category" id="fault-error-types">
              {" "}
              ...
              <div className="parameter-table">
                {" "}
                <article>
                  <strong>Bit Flip Error (\(X\) Error)</strong>
                  <span>
                    Changes a qubit according to \(X|0\rangle = |1\rangle\) and \(X|1\rangle =
                    |0\rangle\). Similar to a classical binary bit error, directly affecting the
                    qubit&#x2019;s state value.
                  </span>
                </article>{" "}
                <article>
                  <strong>Phase Flip Error (\(Z\) Error)</strong>
                  <span>
                    Changes the phase of a quantum state without changing the measured state value:
                    \(Z|0\rangle = |0\rangle\), \(Z|1\rangle = -|1\rangle\). It affects the relative
                    phase between quantum states.
                  </span>
                </article>{" "}
                <article>
                  <strong>Combined Error (\(Y\) Error)</strong>
                  <span>
                    Occurs when both bit-flip and phase-flip effects happen together, represented by
                    \(Y = iXZ\). It affects both the state and phase of a qubit, making it more
                    difficult to detect and correct.
                  </span>
                </article>{" "}
                <article>
                  <strong>Leakage Error</strong>
                  <span>
                    Population escapes outside the computational subspace, for example \(|1\rangle
                    \rightarrow |2\rangle\). Standard QEC assumes a two-level system; leakage
                    requires specialised detection and reset.
                  </span>
                </article>{" "}
                <article>
                  <strong>Erasure Error</strong>
                  <span>
            ...
            <details className="result-category" id="fault-metrics">
              {" "}
              <summary>Fault Tolerance Metrics</summary>{" "}
              <p className="category-note">
              ...
              <div className="parameter-table">
                {" "}
                <article>
                  <strong>Physical Error Rate (\(p\))</strong>
                  <span>
                ...
                <article>
                  <strong>Logical Error Rate (\(P_L\))</strong>
                  <span>
                ...
                <article>
                  <strong>QEC Threshold {"\\(p_{\\mathrm{th}}\\)"}</strong>
                  <span>
                    If {"\\(p < p_{\\mathrm{th}}\\)"}, QEC improves reliability; if{" "}
                    {"\\(p > p_{\\mathrm{th}}\\)"}, adding more overhead no longer helps. For the
                    surface code, {"\\(p_{\\mathrm{th}} \\approx 1\\%\\)"}.
                  </span>
                </article>{" "}
              </div>{" "}
              <p className="mt-4">
                ...
                which shows why increasing \(d\) helps only when \(p\) is below threshold.{" "}
              </p>{" "}
            </details>{" "}
            <details className="result-category" id="fault-code-strategies">
              {" "}
              <summary>QEC Code Strategies</summary>{" "}
              <p className="category-note">
              ...
              <div className="parameter-table">
                ...
                <article>
                  ...
                  <span>
                    ...
                    \(|\alpha\rangle \pm |-\alpha\rangle\). Protects against photon loss.
                  </span>
                </article>{" "}
                <article>
                  <strong>XZZX Surface Code</strong>
                  <span>
                ...
                <article>
                  <strong>Hypergraph Product (LDPC) Code</strong>
                  <span>
            ...
            <details className="result-category" id="fault-code-comparison">
              {" "}
            ...
            <details className="result-category" id="fault-industry-roadmap">
              {" "}
              <summary>Industry Roadmap</summary>{" "}
              <p className="category-note">
                How major industry leaders plan to scale toward fault tolerance.
              </p>{" "}
              <div className="parameter-table">
                {" "}
                <article>
                  <strong>Surface-Code Architectures</strong>
                  <span>
                    Surface code and surface-like architectures are central to scalable fault
                    tolerance. Heavy-hex-style lattice layouts can reduce unwanted ZZ crosstalk.
                  </span>
                </article>{" "}
                <article>
                  <strong>Topological Approaches</strong>
                  <span>
                    Topological approaches use lattice structure, repeated syndrome extraction, and
                    below-threshold operation to scale toward reliable logical qubits.
                  </span>
                </article>{" "}
                <article>
                  <strong>Hybrid Hardware Paths</strong>
                  <span>
                    Scalable fault-tolerant architectures can also use hybrid hardware pairings,
                    including semiconductor-superconductor systems designed to reduce overhead.
                  </span>
                </article>{" "}
              </div>{" "}
            </details>{" "}
            <details className="result-category" id="fault-key-takeaways">
              {" "}
              ...
              <div className="parameter-table">
                {" "}
                <article>
                  <strong>Qubits are noisy</strong>
                  <span>
                ...
                <article>
                  <strong>Logical encoding</strong>
                  <span>
                ...
                <article>
                  <strong>Surface Code dominance</strong>
                  <span>
                ...
                <article>
                  <strong>Threshold dependency</strong>
                  <span>
                ...
                <article>
                  <strong>Advanced alternatives</strong>
                  <span>
  ...
  "hfss-tutorial": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">HFSS Tutorial</p> <h2>HFSS Electromagnetic Simulation</h2>{" "}
      <p>
        {" "}
        HFSS is a full-wave 3D electromagnetic field solver used to test and analyze RF, microwave,
        antenna, and superconducting quantum circuit designs before manufacturing. In the QClang
        documentation, place this tutorial after chip synthesis because the synthesized chip
        geometry becomes the input for electromagnetic simulation.{" "}
      </p>{" "}
      <figure className="tutorial-figure">
        {" "}
        <img
          src="/docs/assets/tutorials/hfss-quantum-circuit.png"
          alt="HFSS superconducting quantum circuit analysis"
        />{" "}
        <figcaption>
          HFSS tutorial image: superconducting quantum circuit, transmon, resonator, field
          distribution, and fabrication layers.
        </figcaption>{" "}
      </figure>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          <strong>Why HFSS is needed</strong>
          <span>
      ...
      <div className="figure-grid">
        {" "}
        <figure>
          <img src="/docs/assets/tutorials/hfss-workflow.png" alt="HFSS workflow" />
          <figcaption>
            Workflow: geometry, materials, boundaries, mesh, simulation, results.
          </figcaption>
        </figure>{" "}
        <figure>
          <img src="/docs/assets/tutorials/hfss-field.png" alt="HFSS field visualization" />
          <figcaption>Field visualization used to inspect electromagnetic behavior.</figcaption>
        </figure>{" "}
      </div>{" "}
    </>
  ),
  "q3d-tutorial": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Q3D Analysis Tutorial</p> <h2>Q3D Extractor Analysis</h2>{" "}
      <p>
        {" "}
        Q3D analysis belongs after HFSS in the documentation because it explains how a quantum chip
        layout is converted into electrical interaction values. Q3D helps analyze capacitance,
        coupling, electric field strength, and unwanted interaction before fabrication.{" "}
      </p>{" "}
      <figure className="tutorial-figure">
        {" "}
        <img
          src="/docs/assets/tutorials/q3d-aedt-interface.png"
          alt="ANSYS AEDT Q3D interface"
        />{" "}
        <figcaption>
          Q3D tutorial image: AEDT interface showing geometry, fields, and extraction workflow.
        </figcaption>{" "}
      </figure>{" "}
      <ol className="learning-list">
        {" "}
        <li>
          <strong>Quantum chip layout:</strong> start from qubits, resonators, readout lines,
          control lines, and ground plane.
        </li>{" "}
        <li>
          <strong>Import into AEDT:</strong> bring the geometry into ANSYS Electronics Desktop.
        </li>{" "}
        <li>
          <strong>Open Q3D Extractor:</strong> analyze electrical interactions between physical
          structures.
        </li>{" "}
        <li>
          <strong>Assign materials:</strong> apply aluminum, silicon, sapphire, niobium, or
          project-specific materials.
        </li>{" "}
        <li>
          <strong>Generate mesh:</strong> divide the structure into small elements for calculation
          accuracy.
        </li>{" "}
        <li>
          <strong>Calculate fields:</strong> inspect electric field strength, direction, and energy
          concentration.
        </li>{" "}
        <li>
          <strong>Extract capacitance matrix:</strong> convert physical geometry into electrical
          information.
        </li>{" "}
      </ol>{" "}
      <div className="figure-grid">
        {" "}
        <figure>
          <img src="/docs/assets/tutorials/q3d-chip-layout.png" alt="Q3D quantum chip layout" />
          <figcaption>
            Input layout: qubits, readout lines, control lines, and ground plane.
          </figcaption>
        </figure>{" "}
        <figure>
          <img
            src="/docs/assets/tutorials/q3d-capacitance-matrix.png"
            alt="Q3D capacitance matrix"
          />
          <figcaption>
            Capacitance matrix: diagonal values are self-capacitance; off-diagonal values show
      ...
      <div className="info-box">
        ...
        <p>
          Red or yellow means strong electric field, green means medium field, and blue means weak
          field.
        </p>{" "}
      </div>{" "}
    </>
  ...
  "epr-tutorial": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        {" "}
        EPR means Energy Participation Ratio. It explains what percentage of total electromagnetic
        energy is stored in each circuit component. In QClang documentation, place EPR after HFSS
        and Q3D because EPR converts field simulation information into quantum parameters such as
        qubit frequency, anharmonicity, coupling strength, and Kerr effects.{" "}
      </p>{" "}
      <div className="figure-grid">
        {" "}
        <figure>
          <img src="/docs/assets/tutorials/epr-transmon.png" alt="Transmon qubit structure" />
          <figcaption>Transmon qubit: capacitor plus Josephson junction structure.</figcaption>
        </figure>{" "}
        <figure>
          <img src="/docs/assets/tutorials/epr-josephson.png" alt="Josephson junction diagram" />
          <figcaption>
            Josephson junction: two superconductors separated by a thin insulating layer.
          </figcaption>
        </figure>{" "}
        <figure>
          <img src="/docs/assets/tutorials/epr-field.png" alt="EPR field energy visualization" />
          <figcaption>Field-energy visualization used before participation analysis.</figcaption>
        </figure>{" "}
      </div>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          <strong>Why EPR is needed</strong>
          <span>
        ...
        <article>
          <strong>scQubits placement</strong>
          <span>
  ...
  "simulation-dashboard": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        ...
        model tree, material layers, object properties, field visualization, mesh settings, and
        progress status.{" "}
      </p>{" "}
      <div className="reference-grid">
        {" "}
        <article>
          <h3>HFSS Eigenmode Simulation</h3>
          <p>
            Document the 3D model view, setup tabs, logs, results, files, progress bar, and solver
            status.
          </p>
        </article>{" "}
        <article>
          <h3>Model Tree</h3>
          <p>
            Explain substrate, metal layers, qubits, couplers, readout resonators, flux lines,
            ports, boundaries, and excitations.
          </p>
        </article>{" "}
        <article>
          <h3>Field Visualization</h3>
          <p>
            Show E-field plots, color legends, frequency selection, vector display, cross section,
            and measurements.
          </p>
        </article>{" "}
        <article>
          ...
          <p>
            Document total simulations, running/completed/failed counts, filters, rows, side
  ...
  "results-reports": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        ...
        coupling maps, coherence summary, verification status, artifacts, and downloadable
        reports.{" "}
      </p>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          ...
          <span>
            Total qubits, average qubit frequency, anharmonicity, \(T_1\), T2, coherence, gates, and
            status.
          </span>
        </article>{" "}
        <article>
          <strong>Qubit table</strong>
          <span>
            Frequency, anharmonicity, \(T_1\), T2, coherence, participation ratio, and pass/fail
            status.
          </span>
        </article>{" "}
        <article>
          <strong>Physics plots</strong>
          <span>
            Frequency histogram, coupling map, energy levels, Hamiltonian summary, and performance
            estimates.
          </span>
        </article>{" "}
        <article>
          <strong>Verification summary</strong>
          <span>Design rule, frequency, coupling, coherence, fabrication, and custom checks.</span>
        </article>{" "}
        <article>
          <strong>Artifacts</strong>
          <span>
            HFSS results, scQubits results, capacitance matrix, Hamiltonian data, and PDF reports.
          </span>
        </article>{" "}
        <article>
          <strong>Reports</strong>
          <span>
            Generate and download complete analysis reports after final simulation completion.
          </span>
        </article>{" "}
      </div>{" "}
    </>
  ...
  "execution-part-1": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Execution Tutorial</p> <h2>Execution Tutorial - Part 1</h2>{" "}
      <p>
        {" "}
        This page explains the first execution stage for QClang documentation users. After a QClang
        file is written and checked by the compiler, the design should be exported into
        simulation-ready artifacts such as JSON IR, geometry data, or electromagnetic setup
        files.{" "}
      </p>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          <strong>Input</strong>
          <span>
            A validated <code>.qcl</code> chip description with qubits, resonators, couplers, ports,
            and constraints.
          </span>
        </article>{" "}
        <article>
          ...
          <span>
            Structured intermediate representation and design artifacts that simulation tools can
            consume.
          </span>
        </article>{" "}
        <article>
          <strong>Simulation handoff</strong>
          <span>Use this stage before HFSS, Q3D, and EPR analysis pages.</span>
        </article>{" "}
        <article>
          <strong>User goal</strong>
          <span>
            Confirm that the design intent is converted into a usable simulation workflow.
          </span>
        </article>{" "}
      </div>{" "}
    </>
  ...
  "execution-part-2": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Execution Tutorial</p> <h2>Execution Tutorial - Part 2</h2>{" "}
      <p>
        {" "}
        This page explains the second execution stage: reading simulation outputs and connecting
        them back to QClang design decisions. Users should compare HFSS, Q3D, and EPR/scQubits
        values against the result-analysis tables.{" "}
      </p>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          <strong>HFSS review</strong>
          <span>
            Check S-parameters, resonator response, field concentration, crosstalk, and convergence.
          </span>
        </article>{" "}
        <article>
          <strong>Q3D review</strong>
          <span>
            Check extracted capacitance, coupling, coherence-related thresholds, yield, and system
            quality.
          </span>
        </article>{" "}
        <article>
          <strong>EPR review</strong>
          <span>
            Check participation ratios, Hamiltonian parameters, loss channels, qubit metrics, and
            scQubits outputs.
          </span>
        </article>{" "}
        <article>
          ...
          <span>
            Use the analysis pages to decide whether the QClang design is ready, marginal, or needs
            redesign.
          </span>
        </article>{" "}
      </div>{" "}
  ...
  "hfss-results-analysis": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Results Analysis</p> <h2>HFSS Results Analysis</h2>{" "}
      <p className="section-lead">
        HFSS results explain how the QClang-generated chip behaves electromagnetically and are
        grouped so learners can study one simulation category at a time.
      </p>{" "}
      <div className="parameter-table">
        <article>
          <strong>Quantum Computing — SilicoFeller Format</strong>
          <span>52</span>
        </article>
        <article>
        ...
        <article>
          ...
          <span>Internal validation set</span>
        </article>
      </div>{" "}
      <div className="result-workbook grouped-results">
        {" "}
        <details className="result-sheet result-root">
          <summary>
            <span>HFSS Simulation Output Parameters</span>
            <small>52 parameters grouped into 7 categories</small>
          </summary>
          <div className="result-nested">
            {" "}
            <details className="result-category" id="hfss-s-parameters">
              <summary>S-Parameters &amp; RF Performance</summary>
              <p className="category-note">
                ...
                <table className="data-table">
                  <thead>
                    <tr>
                      ...
                      <th>Parameter</th>
                      <th>Severity</th>
                      <th>Design Rule / Constraint</th>
                      <th>Ideal / Optimal Value</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Return Loss</td>
                      <td>Critical</td>
                      <td>S11 ≤ −20 dB at operating frequency</td>
                      <td>&lt; −20 dB</td>
                      <td>−15 to −25 dB</td>
                      <td>
                        &lt; −20 dB: excellent impedance match; full power into resonator/qubit
                      </td>
                      <td>&gt; −10 dB: &gt;10% power reflected; readout chain SNR degraded</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>S21 ≥ −0.1 dB in passband</td>
                      <td>&lt; −0.1 dB</td>
                      <td>−0.1 to −1 dB</td>
                      <td>&lt; −0.1 dB: near-lossless transmission; signal integrity preserved</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>|S21| ≥ 0.95 (linear) in passband</td>
                      <td>≈ 1.0 (unity)</td>
                      <td>0.9 – 1.0</td>
                      <td>≥ 0.95: &gt;90% amplitude transmission; strong coupling confirmed</td>
                      <td>&lt; 0.5: &gt;50% amplitude loss; readout inefficient</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>Sij ≤ −30 dB between non-coupled ports</td>
                      <td>&lt; −30 dB</td>
                      <td>−20 to −40 dB</td>
                      <td>
                        &lt; −30 dB: crosstalk negligible; simultaneous multi-qubit readout viable
                      </td>
                      <td>&gt; −15 dB: strong port coupling; driven rotations on idle qubits</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>S12 ≤ −20 dB (Purcell filter context)</td>
                      <td>&lt; −20 dB</td>
                      <td>−15 to −30 dB</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Medium</td>
                      <td>Group delay deviation &lt; 1 ns across qubit bandwidth</td>
                      <td>Linear phase</td>
                      <td>&lt; 5° deviation</td>
                      <td>Linear phase: negligible pulse distortion; gate calibration stable</td>
                      <td>Non-linear phase: pulse distortion → systematic gate errors</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>1 MHz ≤ κ/2π ≤ 10 MHz (readout resonator)</td>
                      <td>1 – 5 MHz</td>
                      <td>0.5 – 20 MHz</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>VSWR</td>
                      <td>Medium</td>
                      <td>VSWR ≤ 1.1 : 1 at operating frequency</td>
                      <td>&lt; 1.1 : 1</td>
                      <td>1.1 – 1.5 : 1</td>
                      <td>&lt; 1.1:1: &gt;99% power transfer; standing waves negligible</td>
                      <td>&gt; 2.0:1: standing waves cause frequency-dependent errors</td>
                      <td>
            ...
            <details className="result-category" id="hfss-resonator-cavity">
              <summary>Resonator &amp; Cavity Parameters</summary>
              <p className="category-note">
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>4.0 GHz ≤ f₀ ≤ 8.0 GHz; detuned ≥ 300 MHz from qubit</td>
                      <td>5 – 7 GHz</td>
                      <td>4 – 8 GHz</td>
                      <td>5–7 GHz: low thermal photon occupancy; standard coax hardware</td>
                      <td>&lt; 1 GHz: thermal excitation; &gt; 15 GHz: lossy substrate</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Loaded Q (Q_L)</td>
                      <td>Critical</td>
                      <td>Q_L ~ 5,000–20,000 (readout); &gt; 10⁶ (memory)</td>
                      <td>5,000 – 20,000</td>
                      <td>1,000 – 50,000</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>Q_i ≥ 10⁵ (2D planar); ≥ 10⁷ (3D cavity)</td>
                      <td>&gt; 10⁶</td>
                      <td>10⁵ – 10⁷</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>Q_e ~ 2,000 – 50,000 (readout)</td>
                      <td>2,000 – 20,000</td>
                      <td>500 – 100,000</td>
                      <td>2k–20k: controllable readout rate; Purcell rate &lt; qubit decay rate</td>
                      <td>&lt; 100: over-coupled; Purcell T₁ &lt; 1 µs; &gt; 10⁶: under-coupled</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>50 MHz ≤ g / 2pi ≤ 200 MHz (strong coupling)</td>
                      <td>50 – 150 MHz</td>
                      <td>10 – 300 MHz</td>
                      <td>
                    ...
                    <tr>
                      <td>14</td>
                      <td>HFSS-R-006</td>
                      <td>Dispersive Shift chi</td>
                      <td>Critical</td>
                      <td>0.5 MHz ≤ |chi|/2π ≤ 10 MHz</td>
                      <td>1 – 5 MHz</td>
                      <td>0.1 – 20 MHz</td>
                      <td>1–5 MHz: large IQ-plane separation; high-fidelity single-shot readout</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>κ/2π = 1 – 5 MHz (readout resonator)</td>
                      <td>1 – 5 MHz</td>
                      <td>0.1 – 20 MHz</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Impedance Z_0</td>
                      <td>Medium</td>
                      <td>Z_0 = 50 Ω ± 2 Ω (matched to coax)</td>
                      <td>50 Ω</td>
                      <td>45 – 55 Ω</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Medium</td>
                      <td>Δf &lt; 1 MHz from design target</td>
                      <td>&lt; 0.5 MHz</td>
                      <td>&lt; 2 MHz</td>
                      <td>&lt; 0.5 MHz: resonator on-frequency; readout pulse pre-calibrated</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Low</td>
                      <td>0.01 ≤ α ≤ 0.3 for standard Al/Nb resonators</td>
                      <td>0.05 – 0.2</td>
                      <td>0.001 – 0.5</td>
                      <td>0.05–0.2: moderate nonlinearity; resonator frequency stable vs power</td>
                      <td>
            ...
            <details className="result-category" id="hfss-em-fields">
              <summary>Electromagnetic Field Outputs</summary>
              <p className="category-note">
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>High</td>
                      <td>|E|max &lt; 10⁶ V/m at junction (single photon)</td>
                      <td>&lt; 10⁵ V/m</td>
                      <td>&lt; 10⁷ V/m</td>
                      <td>
                        &lt; 10⁵ V/m: well below oxide breakdown; TLS excitation rate suppressed
                      </td>
                      <td>&gt; 10⁸ V/m: dielectric breakdown risk; TLS saturation</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Medium</td>
                      <td>|H| &lt; 10³ A/m at SC surface; spatially uniform</td>
                      <td>&lt; 500 A/m</td>
                      <td>&lt; 5,000 A/m</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>&gt; 10⁻¹: interface dominates all loss channels; T₁ &lt; 10 µs</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>p_MA (metal–air) &lt; 10⁻⁴</td>
                      <td>&lt; 10⁻⁴</td>
                      <td>10⁻⁴ – 10⁻³</td>
                      <td>
                        &lt; 10⁻⁴: native oxide TLS loss negligible; consistent with T₁ &gt; 500 µs
                      </td>
                      <td>&gt; 10⁻²: native oxide (AlOx) TLS dominates decay; T₁ &lt; 50 µs</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>p_bulk &lt; 10⁻² for Si/sapphire substrates</td>
                      <td>&lt; 5×10⁻³</td>
                      <td>10⁻² – 5×10⁻²</td>
                      <td>
                        &lt; 5×10⁻³: bulk dielectric loss &lt; 1 kHz; substrate does not limit T₁
                      </td>
                      <td>&gt; 0.1: bulk dominates; even ultra-pure Si limits T₁ &lt; 100 µs</td>
                      <td>
                    ...
                    <tr>
                      <td>24</td>
                      <td>HFSS-E-006</td>
                      <td>EPR (Junction EPR)</td>
                      <td>Critical</td>
                      <td>Junction EPR ≥ 0.9 for dominant mode</td>
                      <td>0.95 – 1.0</td>
                      <td>0.8 – 1.0</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>Q_rad ≥ 10⁶ for on-chip resonators (shielded)</td>
                      <td>&gt; 10⁶</td>
                      <td>&gt; 10⁵</td>
                      <td>
            ...
            <details className="result-category" id="hfss-qubit-performance">
              <summary>Qubit Performance Metrics</summary>
              <p className="category-note">
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>4.0 GHz ≤ f_q ≤ 6.0 GHz (transmon sweet spot)</td>
                      <td>4 – 6 GHz</td>
                      <td>3 – 8 GHz</td>
                      <td>4–6 GHz: kT/hf &lt; 0.001 at 20 mK; standard microwave hardware</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>10 GHz ≤ E_J/h ≤ 40 GHz; E_J/E_C ≥ 50</td>
                      <td>15 – 30 GHz</td>
                      <td>5 – 60 GHz</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>γ_P/2π &lt; 1 kHz (without filter); &lt; 100 Hz (with)</td>
                      <td>&lt; 500 Hz</td>
                      <td>&lt; 10 kHz</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Predicted T₁</td>
                      <td>Critical</td>
                      <td>T₁ &gt; 100 µs (planar 2D); &gt; 1 ms (3D cavity)</td>
                      <td>&gt; 500 µs (3D) / &gt; 100 µs (2D)</td>
                      <td>50 – 500 µs</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Predicted T₂</td>
                      <td>Critical</td>
                      <td>T₂ &gt; 50 µs; ideally T₂ ≈ 2T₁ (pure dephasing limited)</td>
                      <td>&gt; 100 µs</td>
                      <td>20 – 300 µs</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>F₁Q ≥ 99.9% (randomised benchmarking)</td>
                      <td>&gt; 99.9 %</td>
                      <td>99 – 99.99 %</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>F₂Q ≥ 99.5% (CZ or iSWAP gate)</td>
                      <td>&gt; 99.5 %</td>
                      <td>98 – 99.9 %</td>
                      <td>
            ...
            <details className="result-category" id="hfss-crosstalk-isolation">
              <summary>Crosstalk &amp; Isolation</summary>
              <p className="category-note">
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>ζ_ZZ/2π &lt; 10 kHz between non-coupled pairs (idle)</td>
                      <td>&lt; 1 kHz</td>
                      <td>1 – 100 kHz</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>S_ij (nearest neighbour) ≤ −40 dB</td>
                      <td>&lt; −40 dB</td>
                      <td>−30 to −50 dB</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>Δf_spur ≥ 1 GHz from nearest spurious EM mode</td>
                      <td>&gt; 1 GHz gap</td>
                      <td>0.5 – 2 GHz gap</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Medium</td>
                      <td>&lt; 1 spurious package mode per GHz near qubit band</td>
                      <td>&lt; 0.5 modes/GHz</td>
                      <td>&lt; 5 modes/GHz</td>
                      <td>
            ...
            <details className="result-category" id="hfss-thermal-loss">
              <summary>Thermal &amp; Loss Parameters</summary>
              <p className="category-note">
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>tan δ &lt; 10⁻⁶ (bulk substrate, Si or Al₂O₃)</td>
                      <td>&lt; 10⁻⁶</td>
                      <td>10⁻⁷ – 10⁻⁵</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>Rs &lt; 0.01 mΩ/□ at 10 mK for Al/Nb films</td>
                      <td>&lt; 0.005 mΩ/□</td>
                      <td>0.001 – 0.1 mΩ/□</td>
                      <td>
                        &lt; 0.005 mΩ/□: residual resistance ratio high; vortex-free film; Q_i &gt;
                        10⁶
                      </td>
                      <td>
                        &gt; 1 mΩ/□: residual normal-metal loss or vortex contribution; Q_i &lt; 10⁴
                      </td>
                      <td>
                        Microwave surface resistance of superconducting film. Residual Rs from
                        vortices, normal-metal inclusions, or granularity limits Q_i.
                      </td>
                    </tr>
                    <tr>
                      <td>43</td>
                      ...
                      <td>High</td>
                      <td>P_sub &lt; 1 pW per qubit at design drive level</td>
                      <td>&lt; 0.1 pW</td>
                      <td>0.1 – 100 pW</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Thermal NEP</td>
                      <td>Medium</td>
                      <td>NEP &lt; 10⁻²⁰ W/√Hz at qubit frequency (20 mK)</td>
                      <td>&lt; 10⁻²⁰ W/√Hz</td>
                      <td>10⁻²⁰ – 10⁻¹⁸</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>1/T₁_TLS &lt; 1 kHz (TLS contribution to decay)</td>
                      <td>&lt; 0.5 kHz</td>
                      <td>0.5 – 10 kHz</td>
                      <td>
                        &lt; 0.5 kHz: TLS loss gives T₁_TLS &gt; 2 ms; not limiting coherence budget
                      </td>
                      <td>&gt; 100 kHz: TLS dominates all other T₁ channels; requires redesign</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Medium</td>
                      <td>α_c &lt; 0.001 dB/m in SC resonator lines</td>
                      <td>&lt; 0.0001 dB/m</td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>1/Q_rad &lt; 10⁻⁷ (shielded package)</td>
                      <td>&lt; 10⁻⁷</td>
                      <td>10⁻⁷ – 10⁻⁵</td>
                      <td>
            ...
            <details className="result-category" id="hfss-convergence">
              <summary>Simulation Convergence Metrics</summary>
              <p className="category-note">
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Critical</td>
                      <td>ΔS &lt; 0.002 (max |S-matrix change| between passes)</td>
                      <td>&lt; 0.001</td>
                      <td>0.001 – 0.005</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Medium</td>
                      <td>Converge within 6 – 15 adaptive passes</td>
                      <td>6 – 12 passes</td>
                      <td>6 – 25 passes</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Medium</td>
                      <td>10,000 – 500,000 tetrahedra for typical qubit geometry</td>
                      <td>20k – 100k</td>
                      <td>10k – 500k</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>High</td>
                      <td>Energy error &lt; 0.5% (relative stored energy error)</td>
                      <td>&lt; 0.2 %</td>
                      <td>0.2 – 1 %</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Low</td>
                      <td>Peak RAM &lt; 64 GB for standard qubit simulation</td>
                      <td>&lt; 16 GB</td>
                      <td>16 – 64 GB</td>
                      <td>
            ...
            <details className="result-category" id="hfss-summary">
              <summary>HFSS Summary</summary>{" "}
              <p className="category-note">
              ...
              <div className="parameter-table">
                ...
                <article>
                  <strong>S-Parameters {"&"} RF Performance</strong>
                  <span>8 params · 3 critical</span>
                </article>
                <article>
                  <strong>Resonator {"&"} Cavity Parameters</strong>
                  <span>10 params · 5 critical</span>
                </article>
                <article>
                  <strong>Electromagnetic Field Outputs</strong>
                  <span>7 params · 3 critical</span>
                </article>
                <article>
                  <strong>Qubit Performance Metrics</strong>
                  <span>9 params · 9 critical</span>
                </article>
                <article>
                  <strong>Crosstalk {"&"} Isolation</strong>
                  <span>6 params · 2 critical</span>
                </article>
                <article>
                  <strong>Thermal {"&"} Loss Parameters</strong>
                  <span>7 params · 2 critical</span>
                </article>
                <article>
                  <strong>Simulation Convergence Metrics</strong>
                  <span>5 params · 1 critical</span>
                </article>
              </div>{" "}
            </details>{" "}
          </div>
  ...
  "q3d-results-analysis": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Results Analysis</p> <h2>Q3D Results Analysis</h2>{" "}
      <p className="section-lead">
        Q3D results explain the RLGC matrices, parasitic extraction values, and derived qubit
        metrics used after QClang creates superconducting chip geometry.
      </p>{" "}
      <div className="parameter-table">
        <article>
          <strong>58 parameters</strong>
          <span>Q3D output parameters are grouped for analysis.</span>
        </article>
        <article>
          <strong>11 categories</strong>
          <span>
            Each category is kept as a left-sidebar subtopic and a readable documentation table.
          </span>
        </article>
        <article>
          <strong>Matrix foundation</strong>
          <span>
            Resistance, inductance, conductance, and capacitance matrices are the base Q3D outputs.
          </span>
        </article>
        <article>
          <strong>Design loop</strong>
          <span>
            Use Q3D matrices to derive Ec, Ej, g, chi, ζ, and Purcell-rate checks for QClang
            layouts.
          </span>
        </article>
      </div>{" "}
      <div className="result-workbook grouped-results">
        ...
        <details className="result-sheet result-root">
          <summary>
            <span>Q3D Corrected Parameters</span>
            <small>58 corrected parameters grouped into 11 categories</small>
          </summary>
          <div className="result-nested">
            {" "}
            <details className="result-category" id="q3d-resistance-matrix">
              <summary>Resistance Matrix (R)</summary>
              <p className="category-note">
                Resistance outputs describe DC and AC conductor losses. For superconducting layouts,
                use these values as fabrication and normal-state quality checks before
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>R_ii / mΩ</td>
                      <td>DC sweep; sheet-resistance extraction</td>
                      <td>0.5 – 5 mΩ</td>
                      <td>{"<"} 1 mΩ</td>
                      <td>0.5 – 5 mΩ</td>
                      <td>{">"} 50 mΩ</td>
                      <td>
                        Ohmic loss in qubit loop raises thermal noise floor and damps resonator Q
                        factor
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>2</td>
                      <td>AC Self-Resistance at 5–6 GHz</td>
                      <td>R_ac / mΩ</td>
                      <td>HFSS/Q3D surface impedance model</td>
                      <td>2 – 20 mΩ</td>
                      <td>{"<"} 5 mΩ (superconducting at 4K)</td>
                      <td>5 – 20 mΩ</td>
                      <td>{">"} 100 mΩ</td>
                      <td>
                        Values shown apply to normal-metal (room-temp) modeling; at cryogenic temp
                        Al is superconducting (R→0). For non-SC segments or pre-cooldown checks,
                        normal-metal losses degrade quality factor Q.
                      </td>
                      <td>
                        Skin effect sets frequency dependence: R_ac ∝ √f for bulk, ≈ R_dc for thin
                        film {"<"} δ_s. These ranges are room-temperature values; at mK, SC Al gives
                        R_ac → 0.
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>R_ij / μΩ</td>
                      <td>Full R matrix extraction in Q3D</td>
                      <td>{"<"} 10 μΩ</td>
                      <td>≈ 0 (no shared current path)</td>
                      <td>{"<"} 50 μΩ</td>
                      <td>{">"} 500 μΩ</td>
                      <td>
                      ...
                      <td>
                        Non-zero R_ij reveals overlapping ground return paths; fix by isolating
                        ground planes
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>R_via / mΩ</td>
                      <td>TDR or DC 4-probe; Q3D via model</td>
                      <td>{"<"} 2 mΩ per via</td>
                      <td>{"<"} 1 mΩ (superconducting through-Si)</td>
                      <td>1 – 5 mΩ</td>
                      <td>{">"} 20 mΩ</td>
                      <td>
                        Resistance at layer transitions limits Q in 3D integration and flip-chip
                        assemblies
                      </td>
                      <td>
                        Critical for multi-chip modules; oxidation or poor metal contact is the main
                        failure mode
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>R_sh / mΩ/sq</td>
                      <td>4-probe measurement; Q3D bulk conductivity input</td>
                      <td>{"<"} 0.1 mΩ/sq (Al at 4K)</td>
                      <td>{"<"} 0.1 mΩ/sq</td>
                      <td>0.1 – 0.5 mΩ/sq</td>
                      <td>{">"} 5 mΩ/sq</td>
                      <td>
                        High R_sh creates inductive ground return paths and shifts mode frequencies
                        across the chip
                      </td>
                      <td>
                        Perforated ground planes for vortex pinning add ~5–10 pH/sq inductance per
                        square
                      </td>
                    </tr>
                  </tbody>
            ...
            <details className="result-category" id="q3d-inductance-matrix">
              <summary>Inductance Matrix (L)</summary>
              <p className="category-note">
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>L_ii / nH</td>
                      <td>Q3D magnetoquasistatic solver; pyEPR energy participation</td>
                      <td>0.5 – 5 nH</td>
                      <td>1 – 3 nH (target Ej/Ec ~ 50–80)</td>
                      <td>0.5 – 5 nH</td>
                      <td>
                        {"<"} 0.1 or {">"} 20 nH
                      </td>
                      <td>
                        Sets Josephson energy Ej = Φ₀²/2L; directly determines qubit frequency f ≈
                        √(8EjEc)/h
                      </td>
                      <td>
                        L = L_geometric + L_kinetic; kinetic inductance is material-dependent (Al:
                        ~0.1–1 pH/sq)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>M_ij / pH</td>
                      <td>Q3D off-diagonal L matrix extraction</td>
                      <td>1 – 50 pH</td>
                      <td>{"<"} 5 pH (idle qubits)</td>
                      <td>5 – 50 pH</td>
                      <td>{">"} 500 pH</td>
                      <td>
                        Magnetically coupled flux between loops drives parasitic ZZ interaction and
                        inductive crosstalk
                      </td>
                      <td>
                        Intentional M_ij used in flux-tunable couplers; unintentional M_ij sets
                        residual ZZ floor
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>L_geo / pH/μm</td>
                      <td>Q3D partial inductance extraction (PEEC)</td>
                      <td>0.3 – 0.8 pH/μm</td>
                      <td>{"<"} 0.5 pH/μm (wide ground traces)</td>
                      <td>0.5 – 1 pH/μm</td>
                      <td>{">"} 2 pH/μm</td>
                      <td>
                        Inductance from current path geometry adds to kinetic inductance to set
                        total L and mode freq
                      </td>
                      <td>
                        Slot cuts in ground plane drastically increase L_geo; continuous ground
                        plane is preferred
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>L_k / pH/sq</td>
                      <td>Microwave resonator fitting; L_k = ℏ²/(π Δ e² n_s t)</td>
                      <td>1–2 pH/sq (Al, 100–200 nm); 30–200 pH/sq (NbTiN)</td>
                      <td>{"<"} 2 pH/sq (standard Al transmon, 100–200 nm film)</td>
                      <td>1 – 10 pH/sq</td>
                      <td>{">"} 100 pH/sq (non-KI devices)</td>
                      <td>
                        Inertia of Cooper pairs; provides non-linearity in KI qubits; adds to
                        geometric L in CPW
                      </td>
                      <td>
                        High-L_k materials (NbTiN, TiN, NbN) used deliberately for kinetic
                    ...
                    <tr>
                      ...
                      <td>L_J / nH</td>
                      <td>Derived: L_J = Φ₀/(2π I_c) = Φ₀²/(2Ej); I_c from RₙA measurement</td>
                      <td>5 – 15 nH</td>
                      <td>8 – 12 nH (Ej/Ec ~ 50–80)</td>
                      <td>5 – 20 nH</td>
                      <td>
                        {"<"} 1 or {">"} 50 nH
                      </td>
                      <td>
                        Non-linear inductance of JJ; L_J(φ) = L_J0/cos(φ) provides essential quantum
                        non-linearity
                      </td>
                      <td>
                        L_J is the ONLY non-linear element; its ratio to shunting capacitance sets
                        anharmonicity α
                      </td>
                    </tr>
                  </tbody>
            ...
            <details className="result-category" id="q3d-conductance-matrix">
              <summary>Conductance Matrix (G)</summary>
              <p className="category-note">
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>G_ii / nS</td>
                      <td>Q3D DC conductance solve</td>
                      <td>{"<"} 0.1 nS</td>
                      <td>{"<"} 0.1 nS (high-R substrate)</td>
                      <td>0.1 – 1 nS</td>
                      <td>{">"} 10 nS</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>G_bulk / nS</td>
                      <td>Resistivity measurement + Q3D G matrix</td>
                      <td>{"<"} 0.01 nS</td>
                      <td>
                      ...
                      <td>
                        ...
                        {">"}100× when cooled to 4K (carrier freeze-out; magnitude is strongly
                        doping-dependent)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>G_surf / nS/μm</td>
                      <td>Surface participation ratio + loss tangent fitting</td>
                      <td>{"<"} 0.001 nS/μm</td>
                      <td>{"<"} 0.001 nS/μm (clean passivated)</td>
                    ...
                    <tr>
                      ...
                      <td>G_ij / pS</td>
                      <td>Q3D off-diagonal G matrix extraction</td>
                      <td>{"<"} 1 pS</td>
                      <td>{"<"} 1 pS (isolated conductors)</td>
                      <td>1 – 50 pS</td>
                      <td>{">"} 500 pS</td>
                      <td>
            ...
            <details className="result-category" id="q3d-capacitance-matrix">
              <summary>Capacitance Matrix (C)</summary>
              <p className="category-note">
              ...
              <div className="result-table-wrap">
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      <td>15</td>
                      <td>Qubit Self-Capacitance (C_Sigma)</td>
                      <td>C_Sigma / fF</td>
                      <td>Q3D electrostatic solve; Maxwell capacitance matrix</td>
                      <td>60 – 100 fF</td>
                      <td>60 – 100 fF (transmon shunting)</td>
                      <td>40 – 200 fF</td>
                      <td>
                        {"<"} 10 fF or {">"} 500 fF
                      </td>
                    ...
                    <tr>
                      <td>16</td>
                      <td>Readout Resonator Capacitance (C_r)</td>
                      <td>C_r / fF</td>
                      <td>Q3D capacitance matrix + HFSS eigenmode simulation</td>
                      <td>200 – 500 fF</td>
                      <td>200 – 500 fF (λ/4 CPW)</td>
                      <td>100 – 600 fF</td>
                      <td>
                        {"<"} 50 or {">"} 1 pF
                      </td>
                    ...
                    <tr>
                      <td>18</td>
                      <td>Qubit–Qubit Coupling Cap (C_J)</td>
                      <td>C_J / fF</td>
                      <td>Q3D full capacitance matrix between qubit islands</td>
                      <td>0.5 – 5 fF</td>
                      <td>0.5 – 5 fF (tunable coupler)</td>
                      <td>0.2 – 10 fF</td>
                      <td>
                        {"<"} 0.05 or {">"} 30 fF
                      </td>
                    ...
                    <tr>
                      ...
                      <td>C_pad / fF</td>
                      <td>Q3D with ground plane mesh</td>
                      <td>{"<"} 5 fF per pad</td>
                      <td>{"<"} 5 fF (small footprint)</td>
                      <td>1 – 20 fF</td>
                      <td>{">"} 50 fF</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>C_ij / fF</td>
                      <td>Q3D electrostatic solve off-diagonal extraction</td>
                      <td>{"<"} 1 fF (separated lines)</td>
                      <td>{"<"} 1 fF</td>
                      <td>1 – 5 fF</td>
                      <td>{">"} 20 fF</td>
                      <td>
            ...
            <details className="result-category" id="q3d-parasitic-resistance">
              <summary>Parasitic Resistance</summary>
              <p className="category-note">
              ...
              <div className="result-table-wrap">
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      <td>21</td>
                      <td>Series JJ Parasitic Resistance</td>
                      <td>R_ser / Ω</td>
                      <td>RF impedance spectroscopy; Q3D lead model</td>
                      <td>{"<"} 0.01 Ω</td>
                      <td>{"<"} 0.01 Ω (clean superconducting)</td>
                      <td>0.01 – 0.1 Ω</td>
                      <td>{">"} 1 Ω</td>
                      <td>
                    ...
                    <tr>
                      <td>22</td>
                      <td>Shunt Parasitic Resistance (R_p)</td>
                      <td>R_p / kΩ</td>
                      <td>Q3D G matrix → R_p = 1/G_ii</td>
                      <td>{">"} 1 MΩ</td>
                      <td>{">"} 1 MΩ (effectively open)</td>
                      <td>100 kΩ – 1 MΩ</td>
                      <td>{"<"} 10 kΩ</td>
                      <td>
                    ...
                    <tr>
                      <td>23</td>
                      <td>Wirebond / Bump Resistance</td>
                      <td>R_wb / mΩ</td>
                      <td>4-probe TDR; Q3D bond-wire cylinder model</td>
                      <td>{"<"} 5 mΩ per bond</td>
                      <td>{"<"} 5 mΩ</td>
                      <td>2 – 20 mΩ</td>
                      <td>{">"} 100 mΩ</td>
                    ...
                    <tr>
                      <td>24</td>
                      <td>Metal Interface Contact Resistance</td>
                      <td>R_c / mΩ</td>
                      <td>TLM structure measurement; Q3D metal stack</td>
                      <td>{"<"} 1 mΩ (clean Al–Al)</td>
                      <td>{"<"} 1 mΩ</td>
                      <td>1 – 10 mΩ</td>
                      <td>{">"} 50 mΩ</td>
                      <td>
            ...
            <details className="result-category" id="q3d-parasitic-inductance">
              <summary>Parasitic Inductance</summary>
              <p className="category-note">
              ...
              <div className="result-table-wrap">
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      <td>25</td>
                      <td>Wirebond / Bump Inductance</td>
                      <td>L_wb / nH</td>
                      <td>Q3D wire cylinder model; HFSS S-parameter fitting</td>
                      <td>0.5 – 2 nH per bond</td>
                      <td>{"<"} 1 nH</td>
                      <td>0.3 – 3 nH</td>
                      <td>{">"} 5 nH</td>
                      <td>
                        Series inductance in signal path creates impedance discontinuity; resonates
                        near operating freq
                      </td>
                      <td>
                        Flip-chip indium bumps reduce L_wb to ~0.1 nH vs 1–2 nH for wirebonds; key
                        for 3D scaling
                      </td>
                    </tr>
                    <tr>
                      <td>26</td>
                      <td>Control Line Lead Inductance</td>
                      <td>L_lead / pH</td>
                      <td>Q3D PEEC; partial inductance extraction</td>
                      <td>{"<"} 100 pH</td>
                      <td>{"<"} 100 pH (short on-chip)</td>
                      <td>50 – 500 pH</td>
                      <td>{">"} 2 nH</td>
                      <td>
                        Lead inductance in flux/charge bias lines causes AC flux errors and qubit
                        frequency shifts
                      </td>
                      <td>
                        Long coax from room-temperature electronics adds 1–10 nH; de-embed by
                        careful calibration
                      </td>
                    </tr>
                    <tr>
                      <td>27</td>
                      <td>Ground Plane Slot Inductance</td>
                      <td>L_slot / pH/sq</td>
                      <td>Q3D mesh simulation of ground plane geometry</td>
                      <td>{"<"} 1 pH/sq</td>
                      <td>{"<"} 1 pH/sq (continuous ground)</td>
                      <td>1 – 5 pH/sq</td>
                      <td>{">"} 20 pH/sq</td>
                      <td>
                        Inductance from ground return path gaps distorts mode frequencies across the
                        chip
                      </td>
                      <td>
                        Vortex-pinning holes (diameter ~ 1 μm, pitch ~ 2 μm) add ~5–10 pH/sq but are
                        necessary at B {">"} 0
                      </td>
                    </tr>
                    <tr>
                      <td>28</td>
                      <td>Package / Board Parasitic Inductance</td>
                      <td>L_pkg / nH</td>
                      <td>HFSS full package model + Q3D trace extraction</td>
                      <td>{"<"} 0.5 nH (SMA launch)</td>
                      <td>{"<"} 0.5 nH</td>
                      <td>0.5 – 2 nH</td>
                      <td>{">"} 5 nH</td>
                      <td>
                        Package inductance shifts resonator input impedance; must be de-embedded
                        from measurement
                      </td>
                      <td>
                        Surface-mount SMP connectors ({"<"} 0.3 nH) preferred over SMA (~0.5–1 nH)
                        for cryo packages
                      </td>
                    </tr>
                  </tbody>
            ...
            <details className="result-category" id="q3d-parasitic-capacitance">
              <summary>Parasitic Capacitance</summary>
              <p className="category-note">
              ...
              <div className="result-table-wrap">
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      <td>29</td>
                      <td>Trace-to-Ground Parasitic Cap</td>
                      <td>C_trace / fF/μm</td>
                      <td>Q3D electrostatic solve per-unit-length</td>
                      <td>0.1 – 0.4 fF/μm</td>
                      <td>0.1 – 0.4 fF/μm (50 Ω CPW)</td>
                      <td>0.1 – 1 fF/μm</td>
                      <td>{">"} 3 fF/μm</td>
                      <td>
                    ...
                    <tr>
                      <td>30</td>
                      <td>Pad-to-Substrate Parasitic Cap</td>
                      <td>C_sub / fF</td>
                      <td>Q3D C matrix with substrate dielectric stack</td>
                      <td>{"<"} 10 fF</td>
                      <td>{"<"} 10 fF (small contact pads)</td>
                      <td>5 – 30 fF</td>
                      <td>{">"} 100 fF</td>
                      <td>
                    ...
                    <tr>
                      <td>31</td>
                      <td>Inter-Layer Cap (3D integration)</td>
                      <td>C_layer / fF</td>
                      <td>Q3D 3D stack model; bump height geometry sweep</td>
                      <td>{"<"} 5 fF per crossing</td>
                      <td>{"<"} 5 fF (flip-chip bump)</td>
                      <td>1 – 20 fF</td>
                      <td>{">"} 50 fF</td>
                      <td>
                    ...
                    <tr>
                      <td>32</td>
                      <td>Fringe Capacitance (gap edges)</td>
                      <td>C_fringe / fF/μm</td>
                      <td>Q3D conformal mesh at conductor edges</td>
                      <td>0.02 – 0.1 fF/μm</td>
                      <td>0.02 – 0.1 fF/μm (5–20 μm gap)</td>
            ...
            <details className="result-category" id="q3d-electromagnetic-coupling">
              <summary>Electromagnetic Coupling</summary>
              <p className="category-note">
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Q_ext</td>
                      <td>HFSS eigenmode + Q3D coupling capacitance extraction</td>
                      <td>10³ – 10⁵</td>
                      <td>5×10³ – 2×10⁴ (dispersive readout)</td>
                      <td>10³ – 10⁵</td>
                      <td>
                        {"<"} 500 or {">"} 10⁶
                      </td>
                    ...
                    <tr>
                      ...
                      <td>Q_int</td>
                      <td>VNA transmission measurement; HFSS loss tangent input</td>
                      <td>{">"} 10⁶ (planar Al at 4K)</td>
                      <td>{">"} 10⁶</td>
                      <td>10⁵ – 10⁶</td>
                      <td>{"<"} 10⁴</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>Q_L</td>
                      <td>1/Q_L = 1/Q_int + 1/Q_ext; VNA S21 Lorentzian fit</td>
                      <td>10³ – 10⁴</td>
                      <td>10³ – 10⁴ (balanced readout)</td>
                      <td>500 – 2×10⁴</td>
                      <td>
                        {"<"} 200 or {">"} 10⁵
                      </td>
                    ...
                    <tr>
                      <td>37</td>
                      <td>CPW Characteristic Impedance (Z_0)</td>
                      <td>Z_0 / Ω</td>
                      <td>Q3D RLGC → Z_0 = √(L'/C'); verified by HFSS S11 calibration</td>
                      <td>50 Ω ± 1 Ω</td>
                      <td>50 Ω ± 1 Ω</td>
                      <td>45 – 55 Ω</td>
                      <td>
                    ...
                    <tr>
                      <td>38</td>
                      <td>Effective Permittivity (varepsilon_eff)</td>
                      <td>varepsilon_eff</td>
                      <td>Q3D electrostatic fill factor calculation; HFSS eigenmode</td>
                      <td>6.0 – 6.5 (CPW on Si)</td>
                      <td>6.0 – 6.5</td>
                      <td>5.5 – 7.0</td>
                      <td>
                        {"<"} 4 or {">"} 9
                    ...
                    <tr>
                      <td>39</td>
                      <td>Coupling Coefficient k^2</td>
                      <td>k^2 / ×10⁻³</td>
                      <td>Q3D capacitance ratio k^2 = C_g² / (C_1 × C_2)</td>
                      <td>1 – 10 ×10⁻³</td>
                      <td>1 – 10 ×10⁻³</td>
                      <td>0.5 – 20 ×10⁻³</td>
                      <td>
            ...
            <details className="result-category" id="q3d-substrate-dielectric-loss">
              <summary>Substrate {"&"} Dielectric Loss</summary>
              <p className="category-note">
              ...
              <div className="result-table-wrap">
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      <td>40</td>
                      <td>Substrate Bulk Loss Tangent</td>
                      <td>tan delta_bulk</td>
                      <td>Q3D dielectric loss tangent input; resonator Q fitting vs power</td>
                      <td>{"<"} 10⁻⁶ (HR-Si, 4K)</td>
                      <td>{"<"} 10⁻⁶</td>
                      <td>10⁻⁶ – 10⁻⁵</td>
                      <td>{">"} 10⁻⁴</td>
                    ...
                    <tr>
                      <td>41</td>
                      <td>Metal-Air Interface Loss (tan delta_MA)</td>
                      <td>tan delta_MA</td>
                      <td>
                        Surface participation ratio (SPR) from Q3D E-field + measured Q factor
                      </td>
                      <td>~10⁻³</td>
                      <td>{"<"} 10⁻³ (passivated Al₂O₃)</td>
                      <td>10⁻³ – 5×10⁻³</td>
                      <td>{">"} 10⁻²</td>
                      <td>
                    ...
                    <tr>
                      <td>42</td>
                      <td>Substrate-Air Interface Loss (tan delta_SA)</td>
                      <td>tan delta_SA</td>
                      <td>SPR analysis from Q3D E-field distribution</td>
                      <td>~5×10⁻⁴</td>
                      <td>{"<"} 5×10⁻⁴ (HF-etched Si)</td>
                      <td>5×10⁻⁴ – 5×10⁻³</td>
                      <td>{">"} 10⁻²</td>
                      <td>
                    ...
                    <tr>
                      <td>43</td>
                      <td>Metal-Substrate Interface Loss (tan delta_MS)</td>
                      <td>tan delta_MS</td>
                      <td>EELS/TEM interface composition + Q3D SPR calculation</td>
                      <td>~5×10⁻³</td>
                      <td>{"<"} 5×10⁻³</td>
                      <td>5×10⁻³ – 10⁻²</td>
                      <td>{">"} 5×10⁻²</td>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        no sharp corners. For planar transmons, p_MA can reach 100–1000 ppm without
                        geometry optimisation.
                      </td>
                      <td>
                        1/Q_TLS = Σ p_i × tan δ_i; SPR is the design lever; tan δ is the material
                        lever. {"<"}5 ppm ideal is achievable in optimised 3D cavity or large-gap
                        planar designs; planar CPW without optimisation may be 100–1000 ppm.
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <details className="result-category" id="q3d-skin-effect-frequency">
              <summary>Skin Effect {"&"} Frequency-Dependent</summary>
              <p className="category-note">
              ...
              <div className="result-table-wrap">
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      <td>45</td>
                      <td>Skin Depth at 5 GHz</td>
                      <td>delta_s / μm</td>
                      <td>delta_s = √(2ρ/ωμ); Q3D skin-effect mode at frequency</td>
                      <td>0.9 μm (Al at RT)</td>
                      <td>0.5 – 2 μm</td>
                      <td>0.5 – 3 μm</td>
                      <td>
                        {">"} 5 μm (film {"<"} δ_s)
                      ...
                      <td>
                        ...
                        penetration depth λ_L: bulk Al ~16–55 nm; thin-film Al (50–200 nm film)
                        typically 60–163 nm — increases as film thickness decreases
                      </td>
                    </tr>
                    <tr>
                      <td>46</td>
                      ...
                      <td>R_ac/R_dc</td>
                      <td>Q3D frequency sweep; skin-effect solver comparison at DC vs 5 GHz</td>
                      <td>1.0 – 1.05 (thin film)</td>
                      <td>≈ 1.0 (thin film {"<"} δ_s)</td>
                      <td>1.0 – 2.0</td>
                      <td>{">"} 5</td>
                      <td>
                    ...
                    <tr>
                      <td>47</td>
                      <td>Propagation Constant (gamma)</td>
                      <td>α / dB/m, β / rad/m</td>
                      <td>Q3D RLGC → gamma = √((R+jωL)(G+jωC))</td>
                      <td>α {"<"} 0.1 dB/m (SC CPW)</td>
                      <td>α {"<"} 0.1 dB/m; β = ω√(L'C')</td>
                      <td>α 0.1 – 1 dB/m</td>
                      <td>α {">"} 10 dB/m</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>v_ph / ×10⁸ m/s</td>
                      <td>Q3D RLGC → v_ph = ω/β = 1/√(L\'C')</td>
                      <td>1.2 – 1.4 ×10⁸ m/s</td>
                      <td>1.2 – 1.4 ×10⁸ m/s (CPW on Si)</td>
                    ...
                    <tr>
                      <td>49</td>
                      <td>Per-Unit-Length Resistance (R')</td>
                      <td>R' / mΩ/mm</td>
                      <td>Q3D frequency-dependent R matrix; RLGC R' vs frequency</td>
                      <td>{"<"} 0.1 mΩ/mm (SC Al)</td>
                      <td>{"<"} 0.1 mΩ/mm</td>
                      <td>0.1 – 2 mΩ/mm</td>
                      <td>{">"} 10 mΩ/mm</td>
                      <td>
                    ...
                    <tr>
                      <td>50</td>
                      <td>Per-Unit-Length Inductance (L')</td>
                      <td>L' / nH/mm</td>
                      <td>Q3D RLGC magnetostatic solve</td>
                      <td>0.3 – 0.5 nH/mm</td>
                      <td>0.3 – 0.5 nH/mm (50 Ω CPW on Si)</td>
                      <td>0.2 – 0.8 nH/mm</td>
                      <td>
                        {"<"} 0.1 or {">"} 2 nH/mm
                      </td>
                    ...
                    <tr>
                      <td>51</td>
                      <td>Per-Unit-Length Capacitance (C')</td>
                      <td>C' / pF/mm</td>
                      <td>Q3D RLGC electrostatic solve</td>
                      <td>0.1 – 0.2 pF/mm</td>
                      <td>0.1 – 0.2 pF/mm (50 Ω CPW on Si)</td>
            ...
            <details className="result-category" id="q3d-post-processing-derived">
              <summary>Post-Processing Derived Outputs</summary>
              <p className="category-note">
              ...
              <div className="result-table-wrap">
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      <td>52</td>
                      <td>Charging Energy (Ec/h)</td>
                      <td>Ec / h·MHz</td>
                      <td>Ec = e²/(2C_Σ); C_Sigma from Q3D Maxwell matrix</td>
                      <td>200 – 350 MHz</td>
                      <td>200 – 350 MHz (transmon optimum)</td>
                      <td>150 – 400 MHz</td>
                      <td>
                        {"<"} 50 or {">"} 1 GHz
                      </td>
                    ...
                    <tr>
                      <td>53</td>
                      <td>Josephson Energy (Ej/h)</td>
                      <td>Ej / h·GHz</td>
                      <td>Ej = Φ₀²/(2L_J) = Φ₀ I_c / 2π</td>
                      <td>10 – 30 GHz</td>
                      <td>10 – 30 GHz (Ej/Ec ~ 50–80)</td>
                      <td>5 – 50 GHz</td>
                      <td>
                        {"<"} 2 or {">"} 100 GHz
                      </td>
                    ...
                    <tr>
                      <td>54</td>
                      <td>Qubit–Resonator Coupling (g / 2pi)</td>
                      <td>g / 2π / MHz</td>
                      <td>g = C_g/(C_Sigma) × √(ω_q ω_r)/2; C_g from Q3D off-diagonal</td>
                      <td>50 – 150 MHz</td>
                      <td>50 – 150 MHz (dispersive regime)</td>
                      <td>20 – 300 MHz</td>
                      <td>
                        {"<"} 5 or {">"} 500 MHz
                      </td>
                    ...
                    <tr>
                      <td>55</td>
                      <td>Dispersive Shift (chi/2π)</td>
                      <td>chi / 2π / MHz</td>
                      <td>chi = g²/Δ × α/(Δ+α); Δ = ω_q − ω_r; all from Q3D + junction params</td>
                      <td>1 – 5 MHz</td>
                      <td>1 – 5 MHz</td>
                      <td>0.5 – 10 MHz</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>ζ / 2π / kHz</td>
                      <td>ζ = 2g²χ²/(Δ·α·(Δ+α)); derived from Q3D coupling capacitances</td>
                      <td>10 – 100 kHz</td>
                      <td>{"<"} 10 kHz</td>
                      <td>10 – 50 kHz</td>
                      <td>{">"} 200 kHz</td>
                    ...
                    <tr>
                      ...
                      <td>Γ_P / 2π / kHz</td>
                      <td>Γ_P = (g/Δ)² × κ; κ = ω_r/Q_ext from Q3D; g from coupling cap</td>
                      <td>1 – 10 kHz</td>
                      <td>{"<"} 1 kHz (with Purcell filter)</td>
                      <td>1 – 10 kHz</td>
                      <td>{">"} 100 kHz</td>
                      <td>
            ...
            <details className="result-category" id="q3d-key-takeaways">
              <summary>Key Takeaways</summary>{" "}
              <p className="category-note">
              ...
              <div className="parameter-table">
                <article>
                  <strong>RLGC Matrices</strong>
                  <span>
                    R, L, G, C matrices from Q3D are the primary inputs to circuit Hamiltonian
                    models. Even small parasitic entries shift qubit frequencies by 10–100 MHz.
                  </span>
                </article>
                <article>
                  <strong>Superconducting Regime</strong>
                  <span>
                    At 4K, Al and Nb become superconducting → R→0, \(L_k\) dominates. Normal-metal
                    values from Q3D need T-dependent correction.
                  </span>
                </article>
                <article>
                  <strong>Surface Participation</strong>
                  <span>
                    SPR × tan δ controls T₁. Design rule: minimise p_MA below 5 ppm via thick metal,
                    wider CPW gaps, and clean interfaces.
                  </span>
                </article>
                <article>
                  <strong>Derived Outputs</strong>
                  <span>
                    Ec, Ej, g, chi, ζ, Γ_P are all computed from Q3D matrices. Iterating Q3D →
                    Hamiltonian → optimise is the standard qubit design loop.
                  </span>
                </article>
              </div>{" "}
            </details>{" "}
  ...
  "epr-results-analysis": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Results Analysis</p> <h2>EPR / scQubits Analysis</h2>{" "}
      <p className="section-lead">
        EPR and scQubits results connect electromagnetic field energy to quantum-circuit behavior.
        Each workbook table is kept as a subcolumn under the main EPR analysis page.
      </p>{" "}
      <div className="parameter-table">
        <article>
          <strong>Core EPR</strong>
          <span>Participation ratios, zero-point fluctuations, and Hamiltonian extraction.</span>
        </article>
        <article>
          <strong>Performance</strong>
          <span>Qubit coherence, gate fidelity, resonator coupling, and loss channels.</span>
        </article>
        <article>
          <strong>Simulation quality</strong>
          <span>Convergence and accuracy checks that make EPR extraction reliable.</span>
        </article>
        <article>
          <strong>Summary table</strong>
          <span>A complete parameter summary for learners and future QClang result mapping.</span>
        </article>
      </div>{" "}
      <div className="result-workbook grouped-results">
        {" "}
        <details className="result-sheet result-root">
          <summary>
            <span>EPR / scQubits Result Tables</span>
            <small>Workbook sheets as learning subcolumns</small>
          </summary>
          <div className="result-nested">
            {" "}
            <details className="result-category" id="epr-overview-table">
              ...
              <div className="result-table-wrap">
                <table className="data-table">
                  <tbody>
                    <tr>
                      <td>
                        Energy Participation Ratio (EPR) Analysis — Quantum Computing Output
                        Parameters
                      </td>
                    </tr>
                    <tr>
                      <td>
                        Comprehensive summary of EPR output parameters, optimal values, and
                    ...
                    <tr>
                      <td>Overview</td>
                      <td>This sheet — legend, color guide, and sheet index</td>
                    </tr>
                    <tr>
                      <td>Core EPR Parameters</td>
                      <td>
                        Primary outputs: energy participation ratios, loss rates, coupling strengths
                      </td>
                    </tr>
                    <tr>
                      <td>Qubit Performance</td>
                      <td>
                        Qubit quality metrics derived from EPR: T_1, T2, anharmonicity, charge
                        dispersion
                      </td>
                    </tr>
                    <tr>
                      <td>Resonator {"&"} Coupling</td>
                      <td>Resonator frequency, Purcell decay, cross-Kerr, dispersive shift</td>
                    </tr>
                    <tr>
                      <td>Loss {"&"} Dissipation</td>
                      <td>
                        Dielectric loss, TLS loss, radiation loss, seam loss, surface participation
                      </td>
                    </tr>
                    <tr>
                      <td>Junction Parameters</td>
                      <td>Josephson junction inductance, participation ratio, ZPF voltage</td>
                    </tr>
                    <tr>
                      <td>Simulation Convergence</td>
                      <td>Mesh convergence, eigenmode accuracy, simulation quality indicators</td>
                    </tr>
                    <tr>
                      <td>Summary Table</td>
                      <td>Single consolidated master table across all categories</td>
                    </tr>
                    <tr>
                      <td>Color Legend</td>
                    </tr>
                    <tr>
                      <td>GOOD / OPTIMAL</td>
                      <td>
                        Parameter is within the best-practice range for high-coherence devices
                      </td>
                    </tr>
                    <tr>
                      <td>ACCEPTABLE</td>
                      <td>Parameter is functional but leaves room for improvement</td>
                    </tr>
                    <tr>
                      <td>POOR / WORST</td>
                      <td>Parameter degrades device performance; redesign recommended</td>
                    </tr>
                    <tr>
                      <td>HEADER / CATEGORY</td>
                      <td>Section or column header</td>
                    </tr>
                    <tr>
                      <td>DATA ROW</td>
                      <td>Standard data entry row</td>
                    </tr>
                  </tbody>
                </table>
              </div>{" "}
            </details>{" "}
            <details className="result-category" id="epr-core-parameters">
              <summary>Core EPR Parameters</summary>{" "}
              <p className="category-note">
              ...
              <div className="result-nested inner">
                {" "}
                <details className="result-subcategory">
                  <summary>A. Junction Energy Participation Ratios</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                          ...
                          <th>Unit</th>
                          <th>Description</th>
                          <th>Optimal / Best Value</th>
                          <th>Good Range</th>
                          <th>Acceptable Range</th>
                          <th>Poor / Worst Value</th>
                          <th>Physical Significance</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td>Junction Participation Ratio (transmon)</td>
                          <td>p_J</td>
                          <td>dimensionless</td>
                          <td>
                        ...
                        <tr>
                          <td>Junction Participation Ratio (readout mode)</td>
                          <td>p_J^res</td>
                          <td>dimensionless</td>
                          <td>
                        ...
                        <tr>
                          <td>Total Junction Participation (all modes)</td>
                          <td>sum p_J</td>
                          <td>dimensionless</td>
                          <td>
                        ...
                        <tr>
                          <td>Participation Ratio Asymmetry</td>
                          <td>Delta p_J</td>
                          <td>dimensionless</td>
                          <td>
                ...
                <details className="result-subcategory">
                  <summary>B. Zero-Point Fluctuation (ZPF) Quantities</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td>ZPF Voltage across Junction</td>
                          <td>V_zpf</td>
                          <td>µV</td>
                          <td>
                        ...
                        <tr>
                          <td>ZPF Current through Junction</td>
                          <td>I_zpf</td>
                          <td>nA</td>
                          <td>
                        ...
                        <tr>
                          <td>ZPF Phase across Junction</td>
                          <td>varphi_zpf</td>
                          <td>rad</td>
                          <td>
                ...
                <details className="result-subcategory">
                  <summary>C. Hamiltonian Parameters Extracted via EPR</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td>Qubit Frequency (extracted)</td>
                          <td>omega_q / 2pi</td>
                          <td>GHz</td>
                          <td>
                        ...
                        <tr>
                          <td>Anharmonicity (EPR-derived)</td>
                          <td>alpha / 2pi</td>
                          <td>MHz</td>
                          <td>
            ...
            <details className="result-category" id="epr-qubit-performance">
              <summary>Qubit Performance</summary>{" "}
              <p className="category-note">
              ...
              <div className="result-nested inner">
                {" "}
                <details className="result-subcategory">
                  <summary>A. Coherence Times</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td>Energy Relaxation Time T_1</td>
                          <td>T_1</td>
                          <td>µs</td>
                          <td>
                        ...
                        <tr>
                          <td>Coherence Time T2 (Ramsey)</td>
                          <td>T2*</td>
                          <td>µs</td>
                          <td>Total dephasing time including low-frequency noise; T2* = 2T1.</td>
                          <td>{">"} 300 µs</td>
                          <td>100 – 300 µs</td>
                          <td>20 – 99 µs</td>
                          <td>{"<"} 10 µs</td>
                ...
                <details className="result-subcategory">
                  <summary>B. Gate Performance</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>F_RO</td>
                          <td>%</td>
                          <td>Assignment fidelity for single-shot qubit state discrimination.</td>
                          <td>{">"} 99%</td>
                          <td>97 – 99%</td>
                          <td>90 – 96%</td>
                          <td>{"<"} 85%</td>
                ...
                <details className="result-subcategory">
                  <summary>C. Spectral Properties</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Flux Sensitivity (tunable qubits)</td>
                          <td>domega / dPhi</td>
                          <td>GHz/F0</td>
                          <td>
                          ...
                          <td>{"<"} 0.1 GHz/F0 at sweet spot</td>
                          <td>{"<"} 0.5 GHz/F0</td>
                          <td>0.5 – 2 GHz/F0</td>
                          <td>{">"} 5 GHz/F0</td>
                          <td>
                        ...
                        <tr>
                          <td>Frequency Spread (fabrication)</td>
                          <td>sigma_omega / 2pi</td>
                          <td>MHz</td>
                          <td>
            ...
            <details className="result-category" id="epr-resonator-coupling">
              <summary>Resonator {"&"} Coupling</summary>{" "}
              <p className="category-note">
              ...
              <div className="result-nested inner">
                {" "}
                <details className="result-subcategory">
                  <summary>A. Resonator Properties</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Resonator–Qubit Detuning |Δ|</td>
                          <td>|Δ|/2π</td>
                          <td>GHz</td>
                          <td>
                ...
                <details className="result-subcategory">
                  <summary>B. Coupling Strengths</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td>Transverse Coupling g / 2pi</td>
                          <td>g / 2pi</td>
                          <td>MHz</td>
                          <td>
                        ...
                        <tr>
                          <td>Stray Coupling (nearest-neighbor)</td>
                          <td>J_stray / 2pi</td>
                          <td>kHz</td>
                          <td>
            ...
            <details className="result-category" id="epr-loss-dissipation">
              <summary>Loss {"&"} Dissipation</summary>{" "}
              <p className="category-note">
              ...
              <div className="result-nested inner">
                {" "}
                <details className="result-subcategory">
                  <summary>A. Dielectric Loss (Bulk {"&"} Surface)</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td>Bulk Substrate Loss Tangent</td>
                          <td>tan delta_bulk</td>
                          <td>dimensionless</td>
                          <td>
                        ...
                        <tr>
                          <td>Metal-Substrate Interface Loss</td>
                          <td>tan delta_MS</td>
                          <td>dimensionless</td>
                          <td>
                        ...
                        <tr>
                          <td>Substrate-Air Interface Loss</td>
                          <td>tan delta_SA</td>
                          <td>dimensionless</td>
                          <td>
                        ...
                        <tr>
                          <td>Metal-Air Interface Loss</td>
                          <td>tan delta_MA</td>
                          <td>dimensionless</td>
                          <td>
                        ...
                        <tr>
                          <td>Surface Participation Ratio (MS)</td>
                          <td>p_MS</td>
                          <td>dimensionless</td>
                          <td>
                        ...
                        <tr>
                          <td>TLS-Limited Quality Factor (1/f)</td>
                          <td>Q_TLS</td>
                          <td>dimensionless</td>
                          <td>
                ...
                <details className="result-subcategory">
                  <summary>B. Radiation {"&"} Geometry Loss</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Seam Loss (3D cavities)</td>
                          <td>gamma_seam / 2pi</td>
                          <td>kHz</td>
                          <td>
                        ...
                        <tr>
                          <td>Vortex Loss (in-field operation)</td>
                          <td>gamma_vortex / 2pi</td>
                          <td>kHz</td>
                          <td>
            ...
            <details className="result-category" id="epr-junction-parameters">
              <summary>Junction Parameters</summary>{" "}
              <p className="category-note">
              ...
              <div className="result-nested inner">
                {" "}
                <details className="result-subcategory">
                  <summary>A. Junction Electrical Parameters</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Josephson Energy</td>
                          <td>E_J / h</td>
                          <td>GHz</td>
                          <td>Josephson energy EJ = I_c·Φ₀ / (2π); governs tunneling energy.</td>
                          <td>10 – 50 GHz</td>
                          <td>5 – 100 GHz</td>
                          <td>100 – 500 GHz</td>
                          <td>{">"} 1 THz</td>
                ...
                <details className="result-subcategory">
                  <summary>B. Junction Loss {"&"} Quality</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Junction Subgap Resistance</td>
                          <td>R_sg</td>
                          <td>GΩ</td>
                          <td>
                        ...
                        <tr>
                          <td>Flux Noise Spectral Density</td>
                          <td>S_Φ(1Hz)</td>
                          <td>µΦ₀²/Hz</td>
                          <td>
                        ...
                        <tr>
                          <td>Charge Noise Spectral Density</td>
                          <td>S_q(1Hz)</td>
                          <td>e²/Hz</td>
                          <td>
            ...
            <details className="result-category" id="epr-simulation-convergence">
              <summary>Simulation Convergence</summary>{" "}
              <p className="category-note">
              ...
              <div className="result-nested inner">
                {" "}
                <details className="result-subcategory">
                  <summary>A. Eigenmode Solver Convergence</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td>Eigenfrequency Convergence ΔFreq</td>
                          <td>Delta f / f</td>
                          <td>ppm</td>
                          <td>
                        ...
                        <tr>
                          <td>Energy Error (Maxwell equations)</td>
                          <td>Delta U / U</td>
                          <td>%</td>
                          <td>
                        ...
                        <tr>
                          <td>Number of Eigenmode Passes</td>
                          <td>N_passes</td>
                          <td>integer</td>
                          <td>Adaptive refinement passes until convergence criterion is met.</td>
                          <td>10 – 20 passes</td>
                          <td>7 – 10 passes</td>
                          <td>4 – 6 passes</td>
                          <td>{"<"} 3 passes</td>
                        ...
                        <tr>
                          <td>Mode Participation Sum Check</td>
                          <td>sum p</td>
                          <td>dimensionless</td>
                          <td>
                        ...
                        <tr>
                          <td>Participation Ratio Repeatability</td>
                          <td>sigma_p / p</td>
                          <td>%</td>
                          <td>
                ...
                <details className="result-subcategory">
                  <summary>B. Loss Analysis Simulation Quality</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td>Surface Participation Error</td>
                          <td>Delta p_surf</td>
                          <td>%</td>
                          <td>
                        ...
                        <tr>
                          <td>Junction Volume Definition Accuracy</td>
                          <td>Delta V_J / V_J</td>
                          <td>%</td>
                          <td>
                        ...
                        <tr>
                          <td>Number of Loss Regions Modelled</td>
                          <td>N_regions</td>
                          <td>integer</td>
                          <td>
                        ...
                        <tr>
                          <td>Frequency Band of Validity</td>
                          <td>BW_valid</td>
                          <td>GHz</td>
                          <td>
                          ...
                          <td>0 – 15 GHz (no spurious)</td>
                          <td>0 – 10 GHz</td>
                          <td>5 – 10 GHz only</td>
                          <td>Spurious modes present</td>
                          <td>
            ...
            <details className="result-category" id="epr-summary-table">
              ...
              <div className="result-nested inner">
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td>Core EPR</td>
                          <td>Junction Participation Ratio</td>
                          <td>p_J</td>
                          <td>—</td>
                          <td>0.90–0.99</td>
                          <td>0.80–0.99</td>
                          <td>0.50–0.79</td>
                          <td>{"<"} 0.30</td>
                          <td>Sets anharmonicity {"&"} qubit nonlinearity</td>
                          <td>Increase pad size, reduce gap to substrate</td>
                        </tr>
                        <tr>
                          <td>2</td>
                          <td>Core EPR</td>
                          <td>Resonator Junction Participation</td>
                          <td>p_J^res</td>
                          <td>—</td>
                          <td>{"<"} 1×10⁻³</td>
                          <td>{"<"} 1×10⁻²</td>
                          <td>1×10⁻²–5×10⁻²</td>
                          <td>{">"} 0.10</td>
                          <td>Determines Purcell T_1 limit</td>
                          <td>Increase qubit-resonator detuning</td>
                        </tr>
                        <tr>
                          <td>3</td>
                          <td>Core EPR</td>
                          ...
                          <td>1–200 µV</td>
                          <td>{"<"} 0.5 µV</td>
                          <td>Governs qubit-photon coupling</td>
                          <td>Optimise mode volume and pad geometry</td>
                        </tr>
                        <tr>
                          <td>4</td>
                          <td>Core EPR</td>
                          ...
                          <td>0.6–0.9 rad</td>
                          <td>{">"} 1.0 rad</td>
                          <td>Validity of dispersive approximation</td>
                          <td>Reduce anharmonicity target or redesign</td>
                        </tr>
                        <tr>
                          <td>5</td>
                          <td>Core EPR</td>
                          <td>Anharmonicity (EPR)</td>
                          <td>alpha / 2pi</td>
                          <td>MHz</td>
                          <td>150–350 MHz</td>
                          <td>100–400 MHz</td>
                          <td>50–99 MHz</td>
                          <td>{"<"} 30 MHz</td>
                          <td>Gate speed and leakage limit</td>
                          <td>Lower E_J / E_C ratio; smaller junction</td>
                        </tr>
                        <tr>
                          <td>6</td>
                          <td>Core EPR</td>
                          ...
                          <td>0.01–0.09 MHz</td>
                          <td>{"<"} 0.01 MHz</td>
                          <td>Readout contrast</td>
                          <td>Adjust g/|Δ| ratio via geometry</td>
                        </tr>
                        <tr>
                          <td>7</td>
                          <td>Core EPR</td>
                          ...
                          <td>0.10–0.50 MHz</td>
                          <td>{">"} 1.0 MHz</td>
                          <td>Always-on 2Q gate error</td>
                          <td>Tunable coupler; echo sequences</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>10–99 µs</td>
                          <td>{"<"} 1 µs</td>
                          <td>Hard limit on gate fidelity</td>
                          <td>Reduce dominant loss channel from EPR</td>
                        </tr>
                        <tr>
                          <td>9</td>
                          <td>Qubit Performance</td>
                          ...
                          <td>20–99 µs</td>
                          <td>{"<"} 10 µs</td>
                          <td>Practical dephasing limit</td>
                          <td>Reduce flux/charge noise; surface cleaning</td>
                        </tr>
                        <tr>
                          <td>10</td>
                          <td>Qubit Performance</td>
                          <td>Qubit Quality Factor</td>
                          <td>Q_q</td>
                          <td>—</td>
                          <td>{">"} 10⁷</td>
                          <td>10⁶–10⁷</td>
                          <td>10⁵–10⁶</td>
                          <td>{"<"} 10⁴</td>
                          <td>Universal figure of merit</td>
                          <td>Reduce all participation-weighted losses</td>
                        </tr>
                        <tr>
                          <td>11</td>
                          <td>Qubit Performance</td>
                          ...
                          <td>99.0–99.4%</td>
                          <td>{"<"} 98%</td>
                          <td>Surface-code threshold</td>
                          <td>Increase T_1/T2; optimise DRAG pulses</td>
                        </tr>
                        <tr>
                          <td>12</td>
                          <td>Qubit Performance</td>
                          ...
                          <td>97.0–98.9%</td>
                          <td>{"<"} 95%</td>
                          <td>2Q error correction threshold</td>
                          <td>Reduce ZZ via tunable coupler design</td>
                        </tr>
                        <tr>
                          <td>13</td>
                          <td>Qubit Performance</td>
                          ...
                          <td>20–39</td>
                          <td>{"<"} 10</td>
                          <td>Charge noise protection</td>
                          <td>Increase shunt capacitance C_S</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>3–5 GHz</td>
                          <td>{"<"} 2 GHz</td>
                          <td>Dispersive regime requirement</td>
                          <td>Adjust resonator length/capacitance</td>
                        </tr>
                        <tr>
                          <td>15</td>
                          <td>Resonator & Coupling</td>
                          ...
                          <td>10³–10⁴</td>
                          <td>{"<"} 500</td>
                          <td>Readout SNR and back-action</td>
                          <td>Improve substrate and metal quality</td>
                        </tr>
                        <tr>
                          <td>16</td>
                          <td>Resonator & Coupling</td>
                          <td>Coupling Strength g / 2pi</td>
                          <td>g / 2pi</td>
                          <td>MHz</td>
                          <td>50–150 MHz</td>
                          <td>20–200 MHz</td>
                          <td>5–19 MHz</td>
                          <td>{"<"} 2 MHz</td>
                          <td>Sets chi and readout bandwidth</td>
                          <td>Adjust coupling capacitor geometry</td>
                        </tr>
                        <tr>
                          <td>17</td>
                          <td>Resonator & Coupling</td>
                          ...
                          <td>10–100 kHz</td>
                          <td>{">"} 500 kHz</td>
                          <td>T_1 limit via resonator</td>
                          <td>Add Purcell filter; increase detuning</td>
                        </tr>
                        <tr>
                          <td>18</td>
                          <td>Resonator & Coupling</td>
                          ...
                          <td>100–500 kHz</td>
                          <td>{">"} 1 MHz</td>
                          <td>Conditional phase error</td>
                          <td>Tunable coupler; frequency detuning</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>1×10⁻⁶–1×10⁻⁵</td>
                          <td>{">"} 1×10⁻⁴</td>
                          <td>Bulk energy dissipation</td>
                          <td>Use float-zone Si or sapphire</td>
                        </tr>
                        <tr>
                          <td>20</td>
                          <td>Loss & Dissipation</td>
                          ...
                          <td>3×10⁻³–1×10⁻²</td>
                          <td>{">"} 5×10⁻²</td>
                          <td>Dominant TLS loss channel</td>
                          <td>Ion mill before deposition; clean surfaces</td>
                        </tr>
                        <tr>
                          <td>21</td>
                          <td>Loss & Dissipation</td>
                          <td>Surface Participation (MS)</td>
                          <td>p_MS</td>
                          <td>—</td>
                          <td>{"<"} 5×10⁻⁴</td>
                          <td>{"<"} 2×10⁻³</td>
                          <td>2×10⁻³–1×10⁻²</td>
                          <td>{">"} 5×10⁻²</td>
                          <td>Weights MS interface loss to T_1</td>
                          <td>Wider gaps; ground plane design</td>
                        </tr>
                        <tr>
                          <td>22</td>
                          <td>Loss & Dissipation</td>
                          ...
                          <td>10⁵–10⁶</td>
                          <td>{"<"} 10⁴</td>
                          <td>TLS bath limitation</td>
                          <td>Surface treatment; new barrier materials</td>
                        </tr>
                        <tr>
                          <td>23</td>
                          <td>Loss & Dissipation</td>
                          <td>Seam Loss Rate (3D)</td>
                          <td>gamma_seam / 2pi</td>
                          <td>kHz</td>
                          <td>{"<"} 1 kHz</td>
                          <td>{"<"} 5 kHz</td>
                          <td>5–50 kHz</td>
                          <td>{">"} 200 kHz</td>
                          <td>3D cavity assembly limit</td>
                          <td>Indium sealing; tighter tolerances</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>50–200 nH</td>
                          <td>{">"} 500 nH</td>
                          <td>Sets qubit frequency</td>
                          <td>Junction area and J_c control</td>
                        </tr>
                        <tr>
                          <td>25</td>
                          <td>Junction Parameters</td>
                          ...
                          <td>100–500 GHz</td>
                          <td>{">"} 1 THz</td>
                          <td>Qubit spectrum with EC</td>
                          <td>Barrier thickness and area</td>
                        </tr>
                        <tr>
                          <td>26</td>
                          <td>Junction Parameters</td>
                          ...
                          <td>500–1000 MHz</td>
                          <td>{">"} 2 GHz</td>
                          <td>Anharmonicity and charge sensitivity</td>
                          <td>Shunt capacitor area tuning</td>
                        </tr>
                        <tr>
                          <td>27</td>
                          <td>Junction Parameters</td>
                          ...
                          <td>1×10⁻⁵–1×10⁻⁴</td>
                          <td>{">"} 1×10⁻³</td>
                          <td>Intrinsic junction T_1 limit</td>
                          <td>ALD AlOx; crystalline barriers</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          <td>28</td>
                          <td>Simulation</td>
                          <td>Eigenfrequency Convergence</td>
                          <td>Delta f / f</td>
                          <td>ppm</td>
                          <td>{"<"} 5 ppm</td>
                          <td>{"<"} 50 ppm</td>
                          <td>50–500 ppm</td>
                          <td>{">"} 1000 ppm</td>
                          <td>Accuracy of all extracted parameters</td>
                          <td>More refinement passes; finer mesh</td>
                        </tr>
                        <tr>
                          <td>29</td>
                          <td>Simulation</td>
                          ...
                          <td>0.5–2%</td>
                          <td>{">"} 5%</td>
                          <td>Bounds participation ratio error</td>
                          <td>Increase mesh density at interfaces</td>
                        </tr>
                        <tr>
                          <td>30</td>
                          <td>Simulation</td>
                          <td>Participation Sum Check</td>
                          <td>sum p</td>
                          <td>—</td>
                          <td>0.99–1.01</td>
                          <td>0.97–1.03</td>
                          ...
                          <td>Simulation completeness check</td>
                          <td>Include all eigenmodes up to 20 GHz</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <details className="result-subcategory">
                  <summary>Total Parameters: 30</summary>
                  <div className="result-table-wrap">
                    <table className="data-table">
                      <thead>
                        <tr>
  ...
  "api-reference": ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">API Reference</p> <h2>API Reference</h2>{" "}
      <p>
        {" "}
        The API reference should document the endpoints that connect QClang to the backend. Keep
        endpoint descriptions simple until final request and response schemas are ready.{" "}
      </p>{" "}
      <table>
        {" "}
        <thead>
        ...
        <tbody>
          ...
          <tr>
            <td>GET</td>
            <td>
              <code>/api/qclang/status</code>
            </td>
            <td>Check available dialects and compiler support.</td>
          </tr>{" "}
          <tr>
            <td>GET</td>
            <td>
              <code>/api/qclang/examples</code>
            </td>
            <td>Load built-in QClang examples.</td>
          </tr>{" "}
          <tr>
            <td>POST</td>
            <td>
              <code>/api/qclang/parse</code>
            </td>
            <td>Parse source into an AST-style result.</td>
          </tr>{" "}
          <tr>
            <td>POST</td>
            <td>
              <code>/api/qclang/compile</code>
            </td>
            <td>Compile source into the selected target output.</td>
          </tr>{" "}
        </tbody>{" "}
      </table>{" "}
    </>
  ...
  integration: ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Integration</p> <h2>Integration</h2>{" "}
      <p>
        {" "}
        Integration documentation should explain how QClang connects the editor, backend compiler,
        design graph, routing, DRC, and exports. For now, this page gives only the intended
        integration parameters.{" "}
      </p>{" "}
      <div className="parameter-table">
        {" "}
        <article>
          <strong>Frontend editor</strong>
          <span>Writes and submits QClang source text.</span>
        </article>{" "}
        <article>
          <strong>Backend router</strong>
          <span>Receives parse and compile API requests.</span>
        </article>{" "}
        <article>
          <strong>Compiler service</strong>
          <span>Parses, validates, and compiles source.</span>
        </article>{" "}
        <article>
          <strong>Design pipeline</strong>
          <span>Uses compiler output for graph, routing, checks, and exports.</span>
        </article>{" "}
      </div>{" "}
    </>
  ),
  support: ({ activeHash, onNavigate }) => (
    <>
      {" "}
      <p className="eyebrow">Support</p> <h2>Support</h2>{" "}
      <p>
        {" "}
      ...
      <ul className="learning-list">
        {" "}
        <li>
          Review the comprehensive <strong>Getting Started</strong> guide.
        </li>{" "}
        <li>
          Consult the <strong>Language Blocks Reference</strong> for syntax definitions.
        </li>{" "}
        <li>
          Explore the <strong>Compiler Pipeline Reference</strong> for optimization flags.
        </li>{" "}
...
export const SEARCH_ITEMS = [
  ...
  },
  {
    ...
    text: "Fault-Tolerant Quantum Computing Physical vs Logical Qubits Physical Qubit Real qubit in quantum hardware. Stores quantum states |0>, |1>, and |psi> directly. Highly sensitive to noise and environmental disturbances. Suffers from decoherence and operational errors. Logical Qubit Created using multiple physical qubits. Protected by Quantum Error Correction QEC. Encoded state psi_L = alpha|0_L> + beta|1_L>. Can detect and correct errors automatically. Much more stable and reliable. Suitable for large-scale quantum algorithms. 1 logical qubit = 10^2 to 10^3 physical qubits in practical estimates. Many noisy physical qubits work together to form one highly reliable logical qubit.",
  },
  {
    id: "fault-qec-basics",
    title: "Quantum Error Correction (QEC)",
    text: "Fault-Tolerant Quantum Computing Quantum Error Correction QEC detects and corrects errors without measuring and collapsing the protected quantum information. It preserves states such as |psi> = alpha|0> + beta|1>. It uses ancillary measurements to find faults and apply fixes. How QEC Works: Encode one logical qubit into many physical qubits. Measure auxiliary qubits ancilla qubits. Detect the error location. Correct the error without destroying quantum information.",
  },
  {
    id: "fault-error-types",
    title: "Common Error Types",
    text: "Fault-Tolerant Quantum Computing Common Error Types Bit Flip Error X Error X|0> = |1> and X|1> = |0>. Similar to classical binary bit error. Phase Flip Error Z Error Z|0> = |0> and Z|1> = -|1>. Affects relative phase between quantum states. Combined Error Y Error Y = iXZ combines bit-flip and phase-flip effects. Leakage Error Population escapes to non-computational states, for example |1> -> |2>.",
  },
  {
    id: "fault-metrics",
    title: "Fault Tolerance Metrics",
    text: "Fault-Tolerant Quantum Computing Fault Tolerance Metrics Physical Error Rate p Probability that a physical qubit experiences an error. Smaller values indicate better hardware quality. Logical Error Rate P_L Probability that a logical qubit fails after error correction. Must satisfy P_L << p. Code Distance d Minimum number of physical qubit errors needed to corrupt a logical qubit. Larger code distance provides stronger protection. Threshold p_th Critical physical error rate below which QEC improves reliability. If p < p_th, QEC improves reliability. Surface code threshold p_th approximately 1 percent. Scaling model P_L(d) approximately A(p/p_th)^((d+1)/2).",
  },
  {
    id: "fault-code-strategies",
    title: "QEC Code Strategies",
    text: "Fault-Tolerant Quantum Computing QEC Code Strategies Shor Code First quantum error correction code. Protects against both bit-flip and phase-flip errors. 1 logical qubit = 9 physical qubits. Steane Code More efficient than Shor Code. 1 logical qubit = 7 physical qubits. Toric Code First topological quantum error correction code. Stores quantum information across a lattice structure. Surface Code Practical topological QEC. Most widely used code today. Compatible with current hardware. 1 logical qubit approximately 10^2 to 10^3+ physical qubits. Color Code Topological code. Supports more transversal logical gates than Surface Codes. Bacon-Shor Code Subsystem code. Requires fewer stabilizer measurements. GKP Code Quantum error correction for continuous-variable systems. 1 logical qubit = 1 oscillator mode. Cat Code Bosonic code using superpositions |alpha> +/- |-alpha>. XZZX Surface Code Advanced Surface Code variant for biased noise using X and Z stabilizers. Hypergraph Product LDPC Code Quantum LDPC code. Lower qubit overhead than Surface Codes.",
  },
  {
    id: "fault-code-comparison",
    title: "Code Comparison",
    text: "Fault-Tolerant Quantum Computing Code Comparison Surface Code approximately 10^2 to 10^3+ physical qubits per logical qubit. Error threshold p_th approximately 1 percent. 2D nearest-neighbor connectivity. Most hardware-compatible. Color Code Similar threshold to surface code. More transversal gates. More complex connectivity. Bacon-Shor Code Lower measurement overhead. Simpler to implement on some architectures. LDPC Codes Lower qubit overhead than surface codes. Requires non-local connectivity. GKP Code 1 oscillator mode can encode 1 logical qubit. Most hardware-efficient when bosonic mode available.",
  },
  {
    id: "fault-industry-roadmap",
    title: "Industry Roadmap",
    text: "Fault-Tolerant Quantum Computing Industry Roadmap Surface-code architectures use surface-like layouts and heavy-hex-style connectivity to reduce ZZ crosstalk. Topological approaches use lattice structure, syndrome extraction, and below-threshold operation. Hybrid hardware paths can pair semiconductor and superconductor systems to reduce overhead.",
  },
  {
    id: "fault-key-takeaways",
    title: "Key Takeaways",
    text: "Fault-Tolerant Quantum Computing Key Takeaways Quantum devices are noisy. QEC builds logical qubits from many physical qubits, often approximately 10^2 to 10^3. Surface Code is the current leader with high threshold p_th approximately 1 percent and 2D nearest-neighbor connectivity. GKP XZZX and LDPC codes are prime candidates to improve efficiency and enable large-scale fault tolerance. The journey from noisy physical qubits to reliable logical qubits is the foundation of practical quantum computing. Threshold is the critical number: if p < p_th, increasing code distance d reduces logical error rate P_L. Decoder choice matters: MWPM Union Find Belief Propagation and Neural decoders each make different trade-offs between error rate and classical computation speed.",
  },
  {
    id: "api-reference",
    title: "API Reference",
