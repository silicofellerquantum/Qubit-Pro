...
export const SECTIONS_DATA: Record<string, React.FC<SectionProps>> = {
  ...
  "getting-started": ({ activeHash, onNavigate }) => (
    <>
      ...
      <ol className="learning-list">
        <li>
          <strong>Foundational:</strong> learn chip, qubit, coupler, readout, and design rule
          parameters.
        </li>

        <li>
          <strong>Intermediate:</strong> learn parse, validate, compile, and export stages.
        </li>

        <li>
          <strong>Advanced:</strong> connect QClang with backend APIs, design graph, routing, DRC,
          and exports.
        </li>
      </ol>
    </>
  ...
  "hello-world": ({ activeHash, onNavigate }) => (
    <>
      ...
      <div className="code-card">
        ...
        <pre>
          <code>
            chip HelloChip variable substrate = "silicon" variable metal = "aluminum" qubit Q1
            type=transmon frequency=5.0 readout RO_Q1 connect(Q1) end
          </code>
        </pre>
      </div>
  ...
  installation: ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        ...
        This guide outlines setting up the environment, compiling packages, and verifying paths for
      ...
      <div className="parameter-table">
        <article>
          ...
          <span>Project backend folder where QClang services run.</span>
        </article>

        <article>
          <strong>Compiler package</strong>
          <span>QClang lexer, parser, validator, compiler, and full dialect modules.</span>
        </article>

        <article>
          <strong>Examples folder</strong>
          <span>Place for sample .qc and .qcl files used by new users.</span>
        </article>
      </div>
    </>
  ),
  ...
  "using-python": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        Python is used to expose QClang compiler functions through backend services. This section
        should explain the normal developer flow: load source text, parse it, validate it, compile
        it, and return a structured response.
      </p>
      ...
      <div className="code-card">
        ...
        <pre>
          <code>
            source = read_qclang_file("design.qc") ast = parse(source) validation = validate(ast)
            result = compile(ast, target="json_ir")
          </code>
        </pre>
      </div>
    </>
  ...
  "user-guide": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        The user guide should teach how QClang fits into the full quantum chip design workflow. It
        should stay practical: what users write, what the compiler reads, and what the backend
        returns.
      </p>
      ...
      <div className="pipeline">
        <article>
          <span>1</span>
          <h3>Write</h3>
          <p>Create QClang source with chip, qubit, coupler, and readout declarations.</p>
        </article>

        <article>
          <span>2</span>
          <h3>Validate</h3>
          <p>Check structure, references, units, and design constraints.</p>
        </article>

        <article>
          <span>3</span>
          <h3>Compile</h3>
          <p>Generate design output for JSON inspection or chip design tooling.</p>
        </article>
      </div>
    </>
  ),
  ...
  "qclang-overview": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        QClang is a small domain language for quantum chip design. It should describe a design in a
        readable way, then let the compiler convert that design into structured outputs.
      </p>

      <ul className="learning-list">
        <li>
          <strong>Source language:</strong> the user-facing chip description.
        </li>

        <li>
          <strong>AST:</strong> the internal parsed representation.
        </li>

        <li>
          <strong>Design graph:</strong> the shared structure used by routing, DRC, and exports.
        </li>

        <li>
          <strong>Generated output:</strong> the result returned to the frontend or saved as
          artifacts.
        </li>
      </ul>
    </>
    ...
    <>
      ...
      <div className="two-column">
        ...
        <article>
          <h3>Properties</h3>
          <p>
            Use properties for frequency, material, topology, chip size, spacing, and routing
            options.
          </p>
        </article>
      </div>
  ...
  "syntax-part-2": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        Advanced QClang syntax definitions allow specifying target layouts, physical design rule
        constraints, and compilation targets for hardware compilation.
      </p>

      <div className="parameter-table">
        <article>
          <strong>Topology</strong>
          <span>grid, heavy-hex, chain, or project-specific topology names.</span>
        </article>

        <article>
          <strong>Rules</strong>
          <span>Spacing, frequency, fabrication, and connectivity constraints.</span>
        </article>

        <article>
          <strong>Targets</strong>
          <span>qiskit_metal, json_ir, spice, qclang export, and design reports.</span>
        </article>
      </div>
    </>
  ),
  ...
  "language-reference": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        ...
        QClang language specification. Each block maps directly to physical layout and synthesis
        parameters.
      </p>
      ...
      <div className="reference-grid">
        ...
        <article>
          <h3>qubit</h3>
          <p>
            Defines a quantum device node, usually with type, frequency, placement, and group
            parameters.
          </p>
        </article>
        ...
        <article>
          <h3>coupler</h3>
          <p>Defines a connection between two qubits and optional coupling strength.</p>
        </article>

        <article>
          <h3>readout</h3>
          <p>Defines readout resonator objects connected to target qubits.</p>
        </article>

        <article>
          <h3>feedline</h3>
          <p>Defines the shared microwave route that connects readout components.</p>
        </article>

        <article>
          <h3>launchpad</h3>
          <p>Defines chip input/output access points for routing and exports.</p>
        </article>
      </div>
    </>
  ),
    ...
    <>
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>Lexer</td>
            <td>Reads source characters and creates tokens.</td>
            <td>Token stream</td>
          </tr>

          <tr>
            <td>Parser</td>
            <td>Builds the abstract syntax tree from tokens.</td>
            <td>AST</td>
          </tr>

          <tr>
            <td>Validator</td>
            <td>Checks structure, references, and required fields.</td>
            <td>Validation report</td>
          </tr>

          <tr>
            <td>Compiler</td>
            <td>Converts the parsed design into backend-ready output.</td>
            <td>Generated result</td>
          </tr>

          <tr>
            <td>Full dialect</td>
            <td>Supports extended .qcl features such as braces, arrays, and export targets.</td>
            <td>JSON IR, SPICE, or Metal code</td>
          </tr>
        </tbody>
      </table>
    </>
  ...
  "design-rules": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        QClang documentation should include design rule parameters so users understand what the
        compiler or design pipeline may check later.
      </p>

      <div className="reference-grid">
        <article>
          <h3>Geometry rules</h3>
          <p>Spacing, overlap, off-chip placement, and route collision checks.</p>
        </article>

        <article>
          <h3>Frequency rules</h3>
          <p>Qubit frequency spacing, readout separation, and collision avoidance.</p>
        </article>

        <article>
          <h3>Fabrication rules</h3>
          <p>Minimum widths, clearances, material assumptions, and process constraints.</p>
        </article>

        <article>
          <h3>Connectivity rules</h3>
          <p>Qubit-coupler-readout consistency and missing connection checks.</p>
        </article>
      </div>
    </>
  ),
  ...
  targets: ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        Targets describe where QClang output should go. In the final documentation, each target can
        include exact request/response examples and screenshots.
      </p>

      <div className="target-list">
        <article>
          <h3>json_ir</h3>
          <p>Structured intermediate representation for debugging and frontend inspection.</p>
        </article>

        <article>
          <h3>qiskit_metal</h3>
          <p>Python code intended for quantum chip component generation workflows.</p>
        </article>

        <article>
          <h3>spice</h3>
          <p>SPICE-style text for circuit-level representation.</p>
        </article>

        <article>
          <h3>exports</h3>
          <p>Project exports such as QClang source, JSON, SVG, GDS, DXF, and reports.</p>
        </article>
      </div>
    </>
  ),
  ...
  "chip-synthesis": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        Chip synthesis documentation should explain how QClang source becomes a design graph, then
        goes through placement, frequency planning, routing, DRC, and export generation.
      </p>
      ...
      <div className="pipeline">
        <article>
          <span>1</span>
          <h3>Constraints</h3>
          <p>Collect chip size, substrate, topology, metal, and qubit count.</p>
        </article>

        <article>
          <span>2</span>
          <h3>Graph</h3>
          <p>Create a design graph with qubits, couplers, readouts, feedlines, and launchpads.</p>
        </article>

        <article>
          <span>3</span>
          <h3>Export</h3>
          <p>Return generated artifacts for the user interface and downstream tooling.</p>
        </article>
      </div>
    </>
  ),
  ...
  "superconducting-materials": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p className="section-lead">
        This page summarizes <strong>CDAC_Superconducting_Materials.pptx</strong> for QClang
        documentation. Use it to understand the material families that a superconducting
        quantum-chip design flow must describe before layout, fabrication, HFSS simulation, Q3D
        extraction, and EPR/scQubits analysis.
      </p>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <p>
            ...
            CMOS-compatible deposition make it the most widely used qubit material worldwide,
            adopted by IBM, Google, IQM and in C-DAC's reference facility.
          </p>
        </div>
        <div className="material-detail">
          ...
          <ul>
            ...
            <li>Used by IBM, Google, IQM {"&"} adopted in C-DAC reference facility</li>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <p>
            ...
            Sputter-deposited as thin films, it enables scalable multi-layer chip architectures
            essential for 50–100 qubit systems like those in C-DAC's program.
          </p>
        </div>
        <div className="material-detail">
          <strong>Key facts</strong>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <p>
            ...
            electron-beam and optical lithography at scale. C-DAC's reference facility uses silicon
            wafers for double-sided qubit chip fabrication.
          </p>
        </div>
        <div className="material-detail">
          <strong>Key facts</strong>
          <ul>
            ...
            <li>Used in double-sided 3-inch wafer fabrication at C-DAC partner labs</li>
          </ul>
        </div>
      </article>
    </>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <p>
            ...
            longer qubit coherence times (T1, T2). It is used in state-of-the-art processors where
            maximising coherence is critical. Google's Sycamore processor uses sapphire substrates.
          </p>
        </div>
        <div className="material-detail">
          <strong>Key facts</strong>
          <ul>
            ...
            <li>Used in Google's Sycamore and many research-grade qubits globally</li>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <ul>
            ...
            <li>Used in microwave kinetic inductance detectors (MKIDs)</li>
            <li>Studied at C-DAC partner labs for next-generation qubit designs</li>
          </ul>
        </div>
      </article>
    </>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <ul>
            ...
            <li>Adopted in European quantum platforms (QuTech, IQM) and C-DAC partners</li>
          </ul>
        </div>
      </article>
    </>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <ul>
            ...
            <li>Active C-DAC research: cleaner barriers to extend T1 coherence times</li>
          </ul>
        </div>
      </article>
    </>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <ul>
            ...
            <li>Explored for Majorana-based topological qubit research (Microsoft)</li>
            <li>Under evaluation at leading quantum labs and C-DAC ecosystem partners</li>
          </ul>
        </div>
      </article>
    </>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          ...
          <p>
            ...
            multiple quantum chips in a 3D flip-chip stack. This technique, pioneered by Google and
            IBM, enables qubit chips and control chips to be connected with low-loss superconducting
            contacts, crucial for scaling beyond 100 qubits.
          </p>
        </div>
        <div className="material-detail">
          <strong>Key facts</strong>
          <ul>
            ...
            <li>Evaluated for C-DAC reference facility 50–100 qubit multi-chip modules</li>
          </ul>
        </div>
      </article>
    </>
  ...
  "materials-summary": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p className="section-lead">
        Quick comparison table from <strong>CDAC_Superconducting_Materials.pptx</strong>.
      </p>
  ...
  "synthesis-tutorial": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        This tutorial outlines the high-level quantum chip synthesis pipeline, including source
        input parsing, design constraint extraction, graph generation, component routing, and layout
        export.
      </p>
      ...
      <div className="info-box">
        ...
        <p>
          By default, the compiler performs dead-code elimination on unused qubits and optimizes
          routing paths.
        </p>
      </div>
    </>
    ...
    <>
      ...
      <div className="parameter-table">
        <article>
          ...
          <span>
            Total qubits, average qubit frequency, anharmonicity, T1, T2, coherence, gates, and
            status.
          </span>
        </article>
        ...
        <article>
          ...
          <span>
            Frequency, anharmonicity, T1, T2, coherence, participation ratio, and pass/fail status.
          </span>
        </article>
  ...
  "execution-part-1": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p>
        ...
        simulation-ready artifacts such as JSON IR, geometry data, or electromagnetic setup files.
      </p>
  ...
  "hfss-results-analysis": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p className="section-lead">
        HFSS results explain how the QClang-generated chip behaves electromagnetically. This page
        has been updated from <strong>HFSS_Quantum_Parameters (1).pptx</strong> and grouped so
        learners can study one simulation category at a time.
      </p>
      <div className="parameter-table">
        <article>
        ...
        <article>
          ...
          <span>Sources: IEEE / APS Research Papers {"&"} Doctoral Theses (2004–2024)</span>
        </article>
      </div>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>−15 to −30 dB</td>
                      <td>
                        {"<"} −20 dB: amplifier backaction blocked; qubit protected from output
                        noise
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>0.5 – 20 MHz</td>
                      <td>
                        1–5 MHz: fast readout ({"<"} 1 µs) with Purcell rate {"<"} 1 kHz; near
                        quantum limit
                      </td>
                      <td>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        {">"} 10⁶: resonator loss {"<"}
                        {"<"} Purcell loss; qubit T₁ not resonator-limited
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        External Q sets coupling to transmission line. With Q_i {">"}
                        {">"} Q_e (over-coupled), resonator is readout-limited not loss-limited.
                      </td>
                    </tr>
                    <tr>
                      <td>13</td>
                      ...
                      <td>Critical</td>
                      <td>50 MHz ≤ g/2π ≤ 200 MHz (strong coupling)</td>
                      <td>50 – 150 MHz</td>
                      <td>10 – 300 MHz</td>
                      <td>
                      ...
                      <td>
                        Qubit–resonator coupling. Strong coupling (g {">"}
                        {">"} κ, γ) is fundamental requirement for circuit QED dispersive readout.
                      </td>
                    </tr>
                    <tr>
                      <td>14</td>
                      ...
                      <td>
                        State-dependent resonator frequency shift enables QND readout. χ = g²/Δ sets
                    ...
                    <tr>
                      ...
                      <td>Impedance Z₀</td>
                      <td>Medium</td>
                      <td>Z₀ = 50 Ω ± 2 Ω (matched to coax)</td>
                      <td>50 Ω</td>
                      <td>45 – 55 Ω</td>
                      <td>
                      ...
                      <td>
                        {"<"} 25 Ω or {">"} 100 Ω: VSWR {">"} 2; large reflections; effective κ
                        shifts from design
                      </td>
                      <td>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>10⁻⁴ – 10⁻³</td>
                      <td>
                        {"<"} 10⁻⁴: native oxide TLS loss negligible; consistent with T₁ {">"} 500
                        µs
                      </td>
                      <td>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        {"<"} 50 MHz: near-harmonic oscillator; {">"} 1000 MHz: Cooper-pair box
                        regime
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>50 – 500 µs</td>
                      <td>
                        {">"} 100 µs: supports {">"} 1000 gate depth within coherence envelope (10
                        ns gates)
                      </td>
                      <td>
                        {"<"} 10 µs: {"<"} 100 gates within T₁; fault-tolerant computation
                        infeasible
                      </td>
                      <td>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>0.01 – 0.1 %</td>
                      <td>
                        {"<"} 0.01%: seepage outside qubit subspace negligible; DRAG pulse
                        sufficient
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        {">"} 10/GHz: dense mode spectrum; unavoidable hybridisation; package must
                        be redesigned
                      </td>
                      <td>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        {">"} 1 mΩ/□: residual normal-metal loss or vortex contribution; Q_i {"<"}{" "}
                        10⁴
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        {">"} 1 nW: significant quasiparticle poisoning; T₁ collapses in µs
                        timescale
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>0.5 – 10 kHz</td>
                      <td>
                        {"<"} 0.5 kHz: TLS loss gives T₁_TLS {">"} 2 ms; not limiting coherence
                        budget
                      </td>
                    ...
                    <tr>
                      ...
                      <td>10⁻⁷ – 10⁻⁵</td>
                      <td>
                        {"<"} 10⁻⁷: radiation Q {">"} 10⁷; package does not limit resonator or qubit
                        Q
                      </td>
                      <td>
                        {">"} 10⁻⁴: radiation loss comparable to TLS loss; package seams/vias must
                        be redesigned
                      </td>
                      <td>
  ...
  "q3d-results-analysis": ({ activeHash, onNavigate }) => (
    <>
      ...
      <p className="section-lead">
        ...
        metrics used after QClang creates superconducting chip geometry. This page has been updated
        from <strong>Q3D_Parameters_Corrected.pptx</strong>.
      </p>

      <div className="parameter-table">
        <article>
          <strong>58 parameters</strong>
          <span>The corrected PPT covers 58 Q3D output parameters.</span>
        </article>
        <article>
        ...
        <article>
          ...
          <span>
            Use Q3D matrices to derive Ec, Ej, g, χ, ζ, and Purcell-rate checks for QClang layouts.
          </span>
        </article>
      </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        film {"<"} δ_s. These ranges are room-temperature references; at mK, SC Al
                        gives R_ac → 0.
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        Sets charging energy Ec = e²/2C_Σ; large C_Σ → transmon regime →
                        exponentially reduced charge noise
                      </td>
                      <td>
                        C_Σ = Σ|C_ij| from Maxwell matrix; target Ej/Ec = 50–80 for optimal transmon
                        performance
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        g/2π target 50–150 MHz; too large → strong coupling regime; Purcell decay ∝
                        (g/Δ)² × κ
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>{">"} 3 fF/μm</td>
                      <td>
                        Distributed capacitance sets CPW characteristic impedance Z₀ = √(L/C);
                        target 50 Ω
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        Thinning substrate from 500 μm to 200 μm reduces C_sub by ~2.5×; used in IBM
                        3D chip stacks
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Z₀ / Ω</td>
                      <td>Q3D RLGC → Z₀ = √(L'/C'); verified by HFSS S11 calibration</td>
                      <td>50 Ω ± 1 Ω</td>
                      <td>50 Ω ± 1 Ω</td>
                      <td>45 – 55 Ω</td>
                      <td>
                      ...
                      <td>
                        Impedance mismatch causes reflections degrading signal integrity; Z₀
                        controlled by trace/gap ratio
                      </td>
                      <td>
                        On 500 μm Si: 10 μm trace / 6 μm gap → Z₀ ≈ 50 Ω; wider trace → lower Z₀
                      </td>
                    </tr>
                    <tr>
                      <td>38</td>
                      ...
                      <td>
                        Sets propagation velocity v_ph = c/√ε_eff and resonator physical length for
                        target frequency
                      </td>
                      <td>
                        ε_eff depends on substrate filling fraction; ε_eff ≈ (1 + εr)/2 for CPW in
                        air on substrate
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>k² / ×10⁻³</td>
                      <td>Q3D capacitance ratio k² = C_g² / (C_1 × C_2)</td>
                      <td>1 – 10 ×10⁻³</td>
                      <td>1 – 10 ×10⁻³</td>
                      <td>0.5 – 20 ×10⁻³</td>
                      <td>
                      ...
                      <td>
                        k² ∝ gap width at coupling capacitor; etch depth variation of 0.1 μm →
                        δk²/k² ~ 5%
                      </td>
                    </tr>
                  </tbody>
              ...
              <div className="result-table-wrap">
                <table className="data-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>41</td>
                      <td>Metal-Air Interface Loss (tan δ_MA)</td>
                      <td>tan δ_MA</td>
                      <td>
                      ...
                      <td>
                        Etching native oxide before Al deposition reduces tan δ_MA by up to 10×; HF
                        vapor clean
                      </td>
                    </tr>
                    <tr>
                      <td>42</td>
                      <td>Substrate-Air Interface Loss (tan δ_SA)</td>
                      <td>tan δ_SA</td>
                      ...
                      <td>
                        Hydrogen-passivated Si surface (HF dip) shows 5× lower tan δ_SA vs untreated
                        Si
                      </td>
                    </tr>
                    <tr>
                      <td>43</td>
                      <td>Metal-Substrate Interface Loss (tan δ_MS)</td>
                      <td>tan δ_MS</td>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>δ_s / μm</td>
                      <td>δ_s = √(2ρ/ωμ); Q3D skin-effect mode at frequency</td>
                      ...
                      <td>
                        Al at 4K is superconducting so δ_s concept replaced by London penetration
                        depth λ_L: bulk Al ~16–55 nm; thin-film Al (50–200 nm film) typically 60–163
                        nm — increases as film thickness decreases
                      </td>
                    </tr>
                    <tr>
                      <td>46</td>
                    ...
                    <tr>
                      ...
                      <td>
                        v_ph = c/√ε_eff; on Si ε_eff ≈ 6.3 → v_ph ≈ 1.19×10⁸ m/s; λ/4 at 7 GHz ≈
                        4.25 mm
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        Distributed inductance per mm; with C' sets Z₀ = √(L'/C') and v_ph =
                        1/√(L'C')
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        Distributed capacitance per mm; with L' sets Z₀ and ε_eff; narrow gap
                        increases C' (lowers Z₀)
                      </td>
                      <td>
                        Check: Z₀ = √(L'/C') ≈ 50 Ω; v_ph = 1/√(L'×C') ≈ 1.2×10⁸ m/s; these are
                        consistency checks
                      </td>
                    </tr>
                  </tbody>
                ...
                <table className="data-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Ec / h·MHz</td>
                      <td>Ec = e²/(2C_Σ); C_Σ from Q3D Maxwell matrix</td>
                      <td>200 – 350 MHz</td>
                      ...
                      <td>
                        Ec/h = 200 MHz → C_Σ = 91 fF; exact C_Σ from Q3D is the critical input to
                        Hamiltonian model
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>g / 2π / MHz</td>
                      <td>g = C_g/(C_Σ) × √(ω_q ω_r)/2; C_g from Q3D off-diagonal</td>
                      <td>50 – 150 MHz</td>
                    ...
                    <tr>
                      ...
                      <td>χ / 2π / MHz</td>
                      <td>χ = g²/Δ × α/(Δ+α); Δ = ω_q − ω_r; all from Q3D + junction params</td>
                      <td>1 – 5 MHz</td>
                      <td>1 – 5 MHz</td>
                      <td>0.5 – 10 MHz</td>
                      <td>
                      ...
                      <td>
                        Qubit-state-dependent resonator shift; single-shot readout SNR ∝ χ/κ; larger
                        χ → better fidelity
                      </td>
                      <td>
                        χ and Purcell rate trade off via g; Purcell filter allows larger g without
                        excess Purcell loss
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>α / 2π / MHz</td>
                      <td>
                        α = −Ec/h; Ec from Q3D C_Σ; or directly measured by two-tone spectroscopy
                      </td>
                      <td>−200 to −300 MHz</td>
            ...
            <details className="result-category" id="q3d-key-takeaways">
              ...
              <div className="parameter-table">
                ...
                <article>
                  ...
                  <span>
                    Ec, Ej, g, χ, ζ, Γ_P are all computed from Q3D matrices. Iterating Q3D →
    ...
    <>
      ...
      <div className="parameter-table">
        ...
        <article>
          ...
          <span>A complete parameter reference for learners and future QClang result mapping.</span>
        </article>
      </div>
        ...
        <details className="result-sheet result-root">
          ...
          <div className="result-nested">
              ...
              <div className="result-table-wrap">
                <table className="data-table">
                  <tbody>
                    ...
                    <tr>
                      <td>
                        Comprehensive reference of all EPR output parameters, optimal values,
                        good/worst thresholds — compiled from research literature {"&"} theses
                      </td>
                    </tr>
                    <tr>
                      <td>?? Sheet Guide</td>
                    ...
                    <tr>
                      ...
                      <td>
                        Qubit quality metrics derived from EPR: T1, T2, anharmonicity, charge
                        dispersion
                      </td>
                    </tr>
                    <tr>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Minev et al., Nature 2021; Solgun et al., PRApplied 2019</td>
                        </tr>
                        <tr>
                          ...
                          <td>{">"} 0.10</td>
                          <td>
                            Large p_J^res couples resonator decay channel to qubit, reducing T1 via
                            Purcell effect.
                          </td>
                          <td>Reed et al., PRL 2010; Houck et al., PRL 2008</td>
                        </tr>
                        <tr>
                          ...
                          <td>Minev, PhD Thesis Yale 2018; Nigg et al., PRL 2012</td>
                        </tr>
                        <tr>
                          ...
                          <td>Koch et al., PRA 2007; Krantz et al., APR 2019</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Minev et al., Nature 2021; Blais et al., RMP 2021</td>
                        </tr>
                        <tr>
                          ...
                          <td>Orlando et al., PRB 1999; Mooij et al., Science 1999</td>
                        </tr>
                        <tr>
                          ...
                          <td>rad</td>
                          <td>
                            RMS zero-point phase fluctuation f_zpf = v(2eV_zpf/??_q). Governs
                          ...
                          <td>{">"} 1.0 rad</td>
                          <td>
                            Values {">"}1 rad invalidate the perturbative (dispersive) approximation
                            used in EPR.
                          </td>
                          <td>Minev Thesis 2018; Koch et al., PRA 2007</td>
                        </tr>
                        <tr>
                          ...
                          <td>Solgun et al., PRApplied 2019; Blais et al., PRA 2004</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Krantz et al., APR 2019; Arute et al., Nature 2019</td>
                        </tr>
                        <tr>
                          ...
                          <td>MHz</td>
                          <td>
                            Qubit anharmonicity = ?_12 - ?_01; extracted via second-order EPR
                            perturbation theory.
                          </td>
                          <td>150 – 350 MHz</td>
                          <td>100 – 400 MHz</td>
                          ...
                          <td>Koch et al., PRA 2007; Barends et al., PRL 2013</td>
                        </tr>
                        <tr>
                          ...
                          <td>Gambetta et al., PRA 2011; Motzoi et al., PRL 2009</td>
                        </tr>
                        <tr>
                          <td>Dispersive Shift ?/2p</td>
                          <td>?/2p</td>
                          <td>MHz</td>
                          <td>
                          ...
                          <td>Blais et al., PRA 2004; Gambetta et al., PRA 2006</td>
                        </tr>
                        <tr>
                          ...
                          <td>Kandala et al., Nature 2021; Ku et al., PRL 2020</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
            ...
            <details className="result-category" id="epr-qubit-performance">
              ...
              <p className="category-note">
                Qubit Performance Metrics ? Coherence times, gate fidelities, and spectral
                properties derived from EPR loss analysis
              </p>
                ...
                <details className="result-subcategory">
                  ...
                  <div className="result-table-wrap">
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          <td>Energy Relaxation Time T1</td>
                          <td>T1</td>
                          <td>µs</td>
                          <td>
                          ...
                          <td>{"<"} 1 µs</td>
                          <td>
                            T1 is the hard ceiling on gate fidelity; EPR identifies dominant loss
                            channel for improvement.
                          </td>
                          <td>Wang et al., PRApplied 2022; Place et al., NC 2021</td>
                        </tr>
                        <tr>
                          ...
                          <td>Ithier et al., PRB 2005; Bylander et al., Nature Phys 2011</td>
                        </tr>
                        <tr>
                          ...
                          <td>Krantz et al., APR 2019; Jurcevic et al., Quantum Sci. Tech. 2021</td>
                        </tr>
                        <tr>
                          ...
                          <td>µs</td>
                          <td>
                            Echo coherence time; removes low-frequency noise contributions; T2E =
                            2T1.
                          </td>
                          <td>{">"} 500 µs</td>
                          <td>200 – 500 µs</td>
                          ...
                          <td>{"<"} 20 µs</td>
                          <td>
                            Ratio T2E/T2* quantifies 1/f noise power; EPR participations guide
                            substrate/surface optimization.
                          </td>
                          <td>
                            Muhonen et al., Nature Nano 2014; Yurtalan et al., Commun. Phys. 2020
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>dimensionless</td>
                          <td>
                            Qubit quality factor Q = ?_q·T1; dimensionless figure of merit across
                            frequencies.
                          </td>
                          <td>{">"} 107</td>
                          <td>106 – 107</td>
                          ...
                          <td>{"<"} 104</td>
                          <td>
                            Universal metric independent of frequency; Q {">"} 107 represents
                            state-of-the-art performance.
                          </td>
                          <td>Kosen et al., npj QI 2022; Ganjam et al., Nature Commun. 2023</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>%</td>
                          <td>
                            Average fidelity of single-qubit Clifford gates; limited by T1, T2,
                          ...
                          <td>Barends et al., Nature 2014; Jurcevic et al., QST 2021</td>
                        </tr>
                        <tr>
                          ...
                          <td>Arute et al., Nature 2019; Sung et al., PRX 2021</td>
                        </tr>
                        <tr>
                          <td>Leakage Rate</td>
                          <td>L1</td>
                          ...
                          <td>Motzoi et al., PRL 2009; Wood {"&"} Gambetta, PRA 2018</td>
                        </tr>
                        <tr>
                          ...
                          <td>{"<"} 85%</td>
                          <td>
                            Limited by ? (must be large), T1 during readout, photon number. ?
                            extracted directly via EPR.
                          </td>
                          <td>Walter et al., PRApplied 2017; Krantz et al., APR 2019</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Koch et al., PRA 2007; Schreier et al., PRB 2008</td>
                        </tr>
                        <tr>
                          <td>EJ/EC Ratio</td>
                          <td>EJ/EC</td>
                        ...
                        <tr>
                          ...
                          <td>Hutchings et al., PRApplied 2017; Yan et al., Nature Commun. 2016</td>
                        </tr>
                        <tr>
                          ...
                          <td>Kreikebaum et al., npj QI 2020; Osman et al., npj QI 2023</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Blais et al., PRA 2004; Wallraff et al., Nature 2004</td>
                        </tr>
                        <tr>
                          ...
                          <td>Megrant et al., APL 2012; Calusine et al., APL 2018</td>
                        </tr>
                        <tr>
                          ...
                          <td>Reed et al., APL 2010; Houck et al., PRL 2008</td>
                        </tr>
                        <tr>
                          <td>Resonator–Qubit Detuning |?|</td>
                          <td>|?|/2p</td>
                          <td>GHz</td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>kHz</td>
                          <td>
                            Qubit decay rate via resonator Purcell channel; ? × (g/?)². Must be{" "}
                            {"<"}
                            {"<"} 1/T1_target.
                          </td>
                          <td>{"<"} 1 kHz</td>
                          ...
                          <td>{">"} 500 kHz</td>
                          <td>
                            Dominant T1 limit in many designs without Purcell filter; directly
                            predicted by EPR p_J^res.
                          </td>
                          <td>Houck et al., PRL 2008; Reed et al., APL 2010</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"<"} 2 MHz</td>
                          <td>
                            Sets ? and readout speed; g/|?| {"<"} 0.1 required for dispersive
                            regime.
                          </td>
                          <td>Wallraff et al., Nature 2004; Krantz et al., APR 2019</td>
                        </tr>
                        <tr>
                          <td>Dispersive Coupling g/? ratio</td>
                          <td>g/|?|</td>
                          <td>dimensionless</td>
                          <td>
                          ...
                          <td>Gambetta et al., PRA 2006; Boissonneault et al., PRA 2009</td>
                        </tr>
                        <tr>
                          ...
                          <td>Majer et al., Nature 2007; Chen et al., PRL 2014</td>
                        </tr>
                        <tr>
                          ...
                          <td>Ku et al., PRL 2020; Kandala et al., Nature 2021</td>
                        </tr>
                        <tr>
                          ...
                          <td>Arute et al., Nature 2019; Hertzberg et al., npj QI 2021</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
            ...
            <details className="result-category" id="epr-loss-dissipation">
              ...
              <p className="category-note">
                Loss {"&"} Dissipation Parameters ? Dielectric, surface, radiation, and junction
                loss channels identified and weighted by EPR participations
              </p>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"<"} 1×10?7 (Si, sapphire)</td>
                          <td>{"<"} 1×10?6</td>
                          <td>1×10?6 – 1×10?5</td>
                          <td>{">"} 1×10?4</td>
                          <td>
                            Silicon and sapphire are preferred substrates; amorphous SiO2 has tan d
                            ~ 10?³ (very poor).
                          </td>
                          <td>Martinis et al., PRL 2005; Calusine et al., APL 2018</td>
                        </tr>
                        <tr>
                          ...
                          <td>Wang et al., APL 2015; Niepce et al., PRApplied 2019</td>
                        </tr>
                        <tr>
                          ...
                          <td>Wenner et al., APL 2011; Quintana et al., APL 2014</td>
                        </tr>
                        <tr>
                          ...
                          <td>Sandberg et al., APL 2012; Nersisyan et al., Quantum 2019</td>
                        </tr>
                        <tr>
                          ...
                          <td>Wenner et al., APL 2011; Gambetta et al., npj QI 2017</td>
                        </tr>
                        <tr>
                          ...
                          <td>Martinis et al., PRL 2005; Müller et al., PRB 2019</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Houck et al., PRL 2008; Solgun et al., PRApplied 2019</td>
                        </tr>
                        <tr>
                          ...
                          <td>Reagor et al., PRB 2016; Brecht et al., npj QI 2016</td>
                        </tr>
                        <tr>
                          ...
                          <td>Catelani et al., PRL 2011; Serniak et al., PRL 2018</td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            Stan et al., IEEE Trans. 2004; Chiaro et al., Supercond. Sci. Tech. 2016
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>Göppl et al., JAP 2008; Barends et al., APL 2010</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
            ...
            <details className="result-category" id="epr-junction-parameters">
              ...
              <p className="category-note">
                Josephson Junction Parameters ? Junction electrical and physical parameters
                extracted from or used as inputs to EPR analysis
              </p>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>nH</td>
                          <td>
                            Linear (small-signal) inductance of Josephson junction; L_J =
                            F0/(2pI_c). Central EPR input.
                          </td>
                          <td>5 – 20 nH</td>
                          <td>2 – 50 nH</td>
                          <td>50 – 200 nH</td>
                          <td>{">"} 500 nH</td>
                          <td>
                            Sets qubit frequency via ?_q = 1/v(L_J·C_S); too large ? very low
                        ...
                        <tr>
                          ...
                          <td>µA</td>
                          <td>
                            Maximum supercurrent through junction; I_c = F0/(2pL_J). Sets EJ =
                            I_c·F0/(2p).
                          </td>
                          ...
                          <td>
                            Dolan 1977 (shadow evaporation); Ambegaokar {"&"} Baratoff, PRL 1963
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            ...
                            analysis relates Jc to ?_q.
                          </td>
                          <td>Pop et al., Nature 2014; Osman et al., npj QI 2023</td>
                        </tr>
                        <tr>
                          ...
                          <td>Koch et al., PRA 2007; Yan et al., PRApplied 2016</td>
                        </tr>
                        <tr>
                          <td>Junction Area</td>
                          <td>A_J</td>
                          ...
                          <td>Kreikebaum et al., npj QI 2020; Hertzberg et al., npj QI 2021</td>
                        </tr>
                        <tr>
                          <td>Josephson Energy</td>
                          <td>EJ/h</td>
                          <td>GHz</td>
                          <td>Josephson energy EJ = I_c·F0/(2p); governs tunneling energy.</td>
                          <td>10 – 50 GHz</td>
                          <td>5 – 100 GHz</td>
                          <td>100 – 500 GHz</td>
                          <td>{">"} 1 THz</td>
                          ...
                          <td>Koch et al., PRA 2007; Nakamura et al., Nature 1999</td>
                        </tr>
                        <tr>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{">"} 1×10?³</td>
                          <td>
                            TLS in AlOx barrier is historically the primary T1 limit; improved by
                        ...
                        <tr>
                          ...
                          <td>{"<"} 100 MO</td>
                          <td>
                            Low R_sg indicates excess quasiparticle density; limits T1 via
                            quasiparticle poisoning.
                          </td>
                          <td>
                            Aumentado et al., PRL 2004; Aumentado et al., J. Low Temp. Phys. 2011
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>Yoshihara et al., PRL 2006; Bialczak et al., PRL 2007</td>
                        </tr>
                        <tr>
                          ...
                          <td>{"<"} 10?7 e²/Hz</td>
                          <td>{"<"} 10?6 e²/Hz</td>
                          <td>10?6 – 10?5 e²/Hz</td>
                          <td>{">"} 10?4 e²/Hz</td>
                          <td>
                            Exponentially suppressed in transmon regime; relevant for qubits with
                            EJ/EC {"<"} 20.
                          </td>
                          <td>Ithier et al., PRB 2005; Paladino et al., RMP 2014</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
            ...
            <details className="result-category" id="epr-simulation-convergence">
              ...
              <p className="category-note">
                Simulation Convergence {"&"} Accuracy Metrics ? HFSS / pyEPR / Ansys eigenmode
                simulation quality indicators for reliable EPR extraction
              </p>
                ...
                <details className="result-subcategory">
                  ...
                  <div className="result-table-wrap">
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          <td>Eigenfrequency Convergence ?Freq</td>
                          <td>?f/f</td>
                          <td>ppm</td>
                          <td>
                          ...
                          <td>Minev Thesis Yale 2018; Ansys HFSS Documentation 2023</td>
                        </tr>
                        <tr>
                          ...
                          <td>Minev Thesis Yale 2018; Jin, FEM for Electromagnetics, 1993</td>
                        </tr>
                        <tr>
                          ...
                          <td>Minev Thesis Yale 2018; Solgun et al., PRApplied 2019</td>
                        </tr>
                        <tr>
                          ...
                          <td>pyEPR documentation; Minev GitHub 2018</td>
                        </tr>
                        <tr>
                          ...
                          <td>Minev et al., Nature 2021; Nigg et al., PRL 2012</td>
                        </tr>
                        <tr>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Wenner et al., APL 2011; Wang et al., APL 2015</td>
                        </tr>
                        <tr>
                          ...
                          <td>Minev Thesis 2018; Reagor et al., PRB 2016</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>1×10?²–5×10?²</td>
                          <td>{">"} 0.10</td>
                          <td>Determines Purcell T1 limit</td>
                          <td>Increase qubit-resonator detuning</td>
                          <td>Reed et al., PRL 2010</td>
                        </tr>
                        <tr>
                          <td>3</td>
                          <td>Core EPR</td>
                        ...
                        <tr>
                          ...
                          <td>Lower EJ/EC ratio; smaller junction</td>
                          <td>Koch et al., PRA 2007</td>
                        </tr>
                        <tr>
                          <td>6</td>
                          <td>Core EPR</td>
                          <td>Dispersive Shift ?</td>
                          <td>?/2p</td>
                          <td>MHz</td>
                          <td>0.5–3 MHz</td>
                          <td>0.1–5 MHz</td>
                          ...
                          <td>Adjust g/|?| ratio via geometry</td>
                          <td>Blais et al., PRA 2004</td>
                        </tr>
                        <tr>
                          <td>7</td>
                          <td>Core EPR</td>
                          ...
                          <td>Kandala et al., Nature 2021</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Wang et al., PRApplied 2022</td>
                        </tr>
                        <tr>
                          <td>9</td>
                          <td>Qubit Performance</td>
                        ...
                        <tr>
                          ...
                          <td>Increase T1/T2; optimise DRAG pulses</td>
                          <td>Barends et al., Nature 2014</td>
                        </tr>
                        <tr>
                          <td>12</td>
                          <td>Qubit Performance</td>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Megrant et al., APL 2012</td>
                        </tr>
                        <tr>
                          <td>16</td>
                          <td>Resonator {"&"} Coupling</td>
                          <td>Coupling Strength g/2p</td>
                          <td>g/2p</td>
                          <td>MHz</td>
                          <td>50–150 MHz</td>
                          <td>20–200 MHz</td>
                          <td>5–19 MHz</td>
                          <td>{"<"} 2 MHz</td>
                          <td>Sets ? and readout bandwidth</td>
                          <td>Adjust coupling capacitor geometry</td>
                          <td>Wallraff et al., Nature 2004</td>
                        </tr>
                        <tr>
                          <td>17</td>
                          <td>Resonator {"&"} Coupling</td>
                          ...
                          <td>10–100 kHz</td>
                          <td>{">"} 500 kHz</td>
                          <td>T1 limit via resonator</td>
                          <td>Add Purcell filter; increase detuning</td>
                          <td>Houck et al., PRL 2008</td>
                        </tr>
                        <tr>
                          <td>18</td>
                          <td>Resonator {"&"} Coupling</td>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>2×10?³–1×10?²</td>
                          <td>{">"} 5×10?²</td>
                          <td>Weights MS interface loss to T1</td>
                          <td>Wider gaps; ground plane design</td>
                          <td>Wenner et al., APL 2011</td>
                        </tr>
                        <tr>
                          <td>22</td>
                          <td>Loss {"&"} Dissipation</td>
                    ...
                    <table className="data-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Nakamura et al., Nature 1999</td>
                        </tr>
                        <tr>
                          <td>26</td>
                          <td>Junction Parameters</td>
                        ...
                        <tr>
                          ...
                          <td>1×10?5–1×10?4</td>
                          <td>{">"} 1×10?³</td>
                          <td>Intrinsic junction T1 limit</td>
