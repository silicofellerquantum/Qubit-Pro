  ...
  "material-sapphire-al2o3-substrate": ({ activeHash, onNavigate }) => (
    <>
      ...
      <article className="material-card material-card-page">
        ...
        <div className="material-detail">
          <strong>Why it matters</strong>
          <p>Sapphire offers extremely low dielectric loss and a very clean surface, resulting in longer qubit coherence times (\(T_1\), T2). It is used in state-of-the-art processors where maximising coherence is critical. Google's Sycamore processor uses sapphire substrates.</p>
        </div>
        <div className="material-detail">
          <strong>Key facts</strong>
...
Stage 6: Return validated JSON`}</code></pre>
  ...
  "fault-tolerant-quantum-computing": ({ activeHash, onNavigate }) => (
    <>
      <p className="eyebrow">Simulation Tutorials</p>
      <h2>Fault-Tolerant Quantum Computing</h2>
      <p className="section-lead">
        Fault tolerance ensures quantum computation continues correctly even when some qubits fail. It uses quantum error correction (QEC) techniques to detect and correct errors during computation, enabling large-scale quantum processors.
      </p>
      <p>
        The central engineering target is to make the logical error probability far smaller than the physical error probability:
        {" \\[P_L \\ll p\\]"}
      </p>
      <div className="parameter-table">
        <article><strong>Physical Qubits</strong><span>Noisy, fragile, and sensitive to environmental disturbances. Limited reliability for long computations.</span></article>
        <article><strong>Logical Qubits</strong><span>Stable and error-corrected. Built using multiple physical qubits under QEC protection.</span></article>
        <article><strong>QEC Threshold</strong><span>The critical physical error rate {"\\(p_{\\mathrm{th}}\\)"} below which adding correction overhead reduces logical errors.</span></article>
        <article><strong>Surface Code</strong><span>The most widely used topological QEC code today, compatible with current 2D planar architectures.</span></article>
      </div>
        ...
        <details className="result-sheet result-root" open>
          ...
          <div className="result-nested">
            <details className="result-category" id="fault-introduction">
              ...
              <p className="category-note">Basic hardware noise sources and the role of fault tolerance.</p>
              <div className="parameter-table">
                <article><strong>Noise</strong><span>Unwanted interactions that scramble qubit states, caused by environment, control imperfections, and crosstalk.</span></article>
                <article><strong>Decoherence</strong><span>The process by which quantum information leaks into the surrounding environment over time, destroying superposition.</span></article>
                <article><strong>Gate Errors</strong><span>Imperfect operations that cause incorrect transformations, arising from calibration drift, pulse shape errors, and leakage.</span></article>
              ...
              <p className="mt-4">
                Fault tolerance combines quantum error correction, redundancy, and error detection techniques to maintain reliable computation even in the presence of hardware imperfections.
              </p>
            </details>

            <details className="result-category" id="fault-physical-logical">
              <summary>Physical vs Logical Qubits</summary>
              <p className="category-note">The key distinction and overhead cost of quantum error correction.</p>
              <div className="parameter-table">
                <article><strong>Physical Qubits</strong><span>Real qubits present in quantum hardware (e.g. transmons, fluxoniums). They store states such as \(|0\rangle\), \(|1\rangle\), and \(|\psi\rangle\) directly, but are highly noisy and error-prone.</span></article>
                <article><strong>Logical Qubits</strong><span>Created using multiple physical qubits. QEC protects the encoded state \(|\psi_L\rangle = \alpha|0_L\rangle + \beta|1_L\rangle\), making it error-corrected and reliable.</span></article>
                <article><strong>Overhead Ratio</strong><span>\(1\) logical qubit \(=\) \(10^2\) to \(10^3\) physical qubits in many practical surface-code estimates. Many physical qubits work together to behave like a stable logical qubit even when individual physical qubits fail.</span></article>
              </div>
            </details>

            <details className="result-category" id="fault-qec-basics">
              <summary>Quantum Error Correction (QEC)</summary>
              <p className="category-note">How QEC detects and corrects faults without collapsing quantum information.</p>
              <p className="mb-4">
              ...
              <p className="mb-4">
                The protected information remains in a superposition such as \(|\psi\rangle = \alpha|0\rangle + \beta|1\rangle\); QEC extracts only error syndromes, not the amplitudes \(\alpha\) and \(\beta\).
              </p>
              <div className="pipeline">
                <article><span>1</span><h3>Encode</h3><p>Encode one logical qubit into many physical qubits. The logical state is distributed non-locally so no single physical qubit holds the full information.</p></article>
                <article><span>2</span><h3>Syndrome Measurement</h3><p>Measure auxiliary qubits (ancilla qubits) to detect the error location without measuring and collapsing the protected quantum information.</p></article>
                <article><span>3</span><h3>Decode</h3><p>Use a classical decoder to interpret the syndrome measurements and determine the error location.</p></article>
                <article><span>4</span><h3>Correct</h3><p>Correct the error without destroying quantum information, restoring the logical state.</p></article>
              </div>
            </details>

            <details className="result-category" id="fault-error-types">
              <summary>Common Error Types</summary>
              <p className="category-note">The three fundamental quantum error classes and hardware-specific additions.</p>
              <div className="parameter-table">
                <article><strong>Bit Flip Error (\(X\) Error)</strong><span>Changes a qubit according to \(X|0\rangle = |1\rangle\) and \(X|1\rangle = |0\rangle\). Similar to a classical binary bit error, directly affecting the qubit&#x2019;s state value.</span></article>
                <article><strong>Phase Flip Error (\(Z\) Error)</strong><span>Changes the phase of a quantum state without changing the measured state value: \(Z|0\rangle = |0\rangle\), \(Z|1\rangle = -|1\rangle\). It affects the relative phase between quantum states.</span></article>
                <article><strong>Combined Error (\(Y\) Error)</strong><span>Occurs when both bit-flip and phase-flip effects happen together, represented by \(Y = iXZ\). It affects both the state and phase of a qubit, making it more difficult to detect and correct.</span></article>
                <article><strong>Leakage Error</strong><span>Population escapes outside the computational subspace, for example \(|1\rangle \rightarrow |2\rangle\). Standard QEC assumes a two-level system; leakage requires specialised detection and reset.</span></article>
                <article><strong>Erasure Error</strong><span>An error whose location is known (e.g., a qubit loss is flagged). Erasure errors are easier to correct than unknown Pauli errors.</span></article>
              </div>
            </details>

            <details className="result-category" id="fault-metrics">
              <summary>Fault Tolerance Metrics</summary>
              <p className="category-note">Key parameters used to measure the reliability, accuracy, and error-correction performance.</p>
              <div className="parameter-table">
                <article><strong>Physical Error Rate (\(p\))</strong><span>Probability that a physical qubit experiences an error. Smaller values indicate better hardware quality.</span></article>
                <article><strong>Logical Error Rate (\(P_L\))</strong><span>Probability that a logical qubit fails after error correction. Fault-tolerant operation requires \(P_L \ll p\).</span></article>
                <article><strong>Code Distance (\(d\))</strong><span>Minimum number of physical qubit errors needed to corrupt a logical qubit. Larger code distance provides stronger protection.</span></article>
                <article><strong>QEC Threshold {"\\(p_{\\mathrm{th}}\\)"}</strong><span>If {"\\(p < p_{\\mathrm{th}}\\)"}, QEC improves reliability; if {"\\(p > p_{\\mathrm{th}}\\)"}, adding more overhead no longer helps. For the surface code, {"\\(p_{\\mathrm{th}} \\approx 1\\%\\)"}.</span></article>
              </div>
              <p className="mt-4">
                A common scaling model is {"\\[P_L(d) \\approx A\\left(\\frac{p}{p_{\\mathrm{th}}}\\right)^{(d+1)/2}\\]"} which shows why increasing \(d\) helps only when \(p\) is below threshold.
              </p>
            </details>

            <details className="result-category" id="fault-code-strategies">
              <summary>QEC Code Strategies</summary>
              <p className="category-note">The landscape of quantum error correction code architectures.</p>
              <div className="parameter-table">
                <article><strong>Shor Code</strong><span>First quantum error correction code. Protects against both bit-flip and phase-flip errors. Proved that quantum errors can be corrected. \(1\) logical qubit \(= 9\) physical qubits.</span></article>
                <article><strong>Steane Code</strong><span>More efficient than the Shor Code. Uses fewer qubits, making some logical operations easier. Inspired many modern quantum codes. \(1\) logical qubit \(= 7\) physical qubits.</span></article>
                <article><strong>Toric Code</strong><span>First topological quantum error correction code. Stores quantum information across a lattice structure using topological properties. \(1\) logical qubit is encoded across a 2D lattice.</span></article>
                <article><strong>Surface Code</strong><span>Practical implementation of topological QEC. Most widely used QEC code today, compatible with current 2D grids, and forms the foundation of IBM and Google roadmaps. \(1\) logical qubit {"\\(\\sim 10^2\\text{--}10^3+\\)"} physical qubits.</span></article>
                <article><strong>Color Code</strong><span>Topological QEC code using a colored lattice. Supports more transversal logical gates than Surface Codes, simplifying certain fault-tolerant operations. \(1\) logical qubit {"\\(\\sim 10^2\\text{--}10^3+\\)"} physical qubits.</span></article>
                <article><strong>Bacon-Shor Code</strong><span>Subsystem QEC code. Combines features of Shor Code and surface-like structures. Requires fewer stabilizer measurements, simplifying error detection. \(1\) logical qubit is encoded using a grid of physical qubits.</span></article>
                <article><strong>GKP Code</strong><span>Continuous-variable QEC code. Encodes a logical qubit in the states of a quantum oscillator. Corrects small displacement errors. Highly efficient for bosonic hardware: \(1\) logical qubit \(= 1\) oscillator mode.</span></article>
                <article><strong>Cat Code</strong><span>Bosonic QEC code. Encodes information using superpositions of coherent states \(|\alpha\rangle \pm |-\alpha\rangle\). Protects against photon loss.</span></article>
                <article><strong>XZZX Surface Code</strong><span>Advanced version of the Surface Code using a different arrangement of \(X\) and \(Z\) stabilizers. Performs better under biased noise. \(1\) logical qubit {"\\(\\sim 10^2\\text{--}10^3+\\)"} physical qubits.</span></article>
                <article><strong>Hypergraph Product (LDPC) Code</strong><span>Quantum Low-Density Parity-Check (LDPC) code. Reduces the number of physical qubits required for error correction, enabling more efficient encoding. \(1\) logical qubit has lower qubit overhead than Surface Codes.</span></article>
              </div>
            </details>

            <details className="result-category" id="fault-code-comparison">
              <summary>Code Comparison</summary>
              <p className="category-note">Engineering trade-offs between the leading QEC codes for superconducting qubits.</p>
              <div className="parameter-table">
                <article><strong>Surface Code</strong><span>{"\\(\\sim 10^2\\text{--}10^3+\\)"} physical qubits per logical qubit. High threshold {"\\(p_{\\mathrm{th}} \\approx 1\\%\\)"}. Compatible with 2D nearest-neighbor planar layouts. Most widely adopted.</span></article>
                <article><strong>Color Code</strong><span>{"\\(\\sim 10^2\\text{--}10^3+\\)"} physical qubits per logical qubit. Supports more transversal logical gates but requires more complex routing and connectivity.</span></article>
                <article><strong>Bacon-Shor Code</strong><span>Grid of physical qubits per logical qubit. Requires fewer stabilizer measurements, reducing overhead and making implementation easier.</span></article>
                <article><strong>LDPC Codes</strong><span>Lower qubit overhead than surface codes. Requires non-local connectivity, which is harder for current planar chip architectures.</span></article>
                <article><strong>GKP / Cat Codes</strong><span>\(1\) oscillator mode can encode \(1\) logical qubit. Highly hardware-efficient but sensitive to energy decay and photon loss in bosonic cavities.</span></article>
              </div>
            </details>

            <details className="result-category" id="fault-industry-roadmap">
              <summary>Industry Roadmap</summary>
              <p className="category-note">How major industry leaders plan to scale toward fault tolerance.</p>
              <div className="parameter-table">
                <article><strong>IBM</strong><span>Surface code and surface-like architectures are central to their roadmap. IBM targets fault-tolerant logical qubits using the heavy-hex lattice layout, which minimizes ZZ crosstalk.</span></article>
                <article><strong>Google</strong><span>Surface and topological approaches are central. Google has demonstrated error rates below threshold in surface code lattices and is scaling toward commercial fault tolerance.</span></article>
                <article><strong>Microsoft</strong><span>Focuses on scalable fault-tolerant architectures and novel hardware pairings, including topological qubits based on Majorana zero modes in semiconductor-superconductor systems to reduce overhead.</span></article>
              </div>
            </details>

            <details className="result-category" id="fault-key-takeaways">
              <summary>Key Takeaways</summary>
              <p className="category-note">Core insights on the transition from physical to logical quantum processing.</p>
              <div className="parameter-table">
                <article><strong>Qubits are noisy</strong><span>Every physical qubit suffers from noise, decoherence, and gate/readout errors. QEC is a fundamental requirement for scaling.</span></article>
                <article><strong>Logical encoding</strong><span>Logical qubits are built from many noisy physical qubits, often {"\\(\\sim 10^2\\text{--}10^3\\)"}, to create stable, error-corrected units.</span></article>
                <article><strong>Surface Code dominance</strong><span>The Surface Code is the current leader due to its high threshold {"\\(p_{\\mathrm{th}} \\approx 1\\%\\)"} and compatibility with 2D planar layouts.</span></article>
                <article><strong>Threshold dependency</strong><span>If {"\\(p < p_{\\mathrm{th}}\\)"}, scaling up the code distance \(d\) improves reliability and drives \(P_L\) down. Above threshold, increasing \(d\) cannot rescue the computation.</span></article>
                <article><strong>Advanced alternatives</strong><span>GKP, XZZX, and quantum LDPC codes are prime candidates to reduce the physical qubit overhead for future processors.</span></article>
              </div>
            </details>
          </div>
        </details>
  ...
  "results-reports": ({ activeHash, onNavigate }) => (
    <>
      ...
      <div className="parameter-table">
        ...
        <article><strong>Summary metrics</strong><span>Total qubits, average qubit frequency, anharmonicity, \(T_1\), T2, coherence, gates, and status.</span></article>



        <article><strong>Qubit table</strong><span>Frequency, anharmonicity, \(T_1\), T2, coherence, participation ratio, and pass/fail status.</span></article>
  ...
  "q3d-results-analysis": ({ activeHash, onNavigate }) => (
    <>
      ...
      <div className="parameter-table"><article><strong>58 parameters</strong><span>Q3D output parameters are grouped for analysis.</span></article><article><strong>11 categories</strong><span>Each category is kept as a left-sidebar subtopic and a readable documentation table.</span></article><article><strong>Matrix foundation</strong><span>Resistance, inductance, conductance, and capacitance matrices are the base Q3D outputs.</span></article><article><strong>Design loop</strong><span>Use Q3D matrices to derive Ec, Ej, g, chi, ζ, and Purcell-rate checks for QClang layouts.</span></article></div>
      ...
      <div className="result-workbook grouped-results">
        ...
        <details className="result-sheet result-root"><summary><span>Q3D Corrected Parameters</span><small>58 corrected parameters grouped into 11 categories</small></summary><div className="result-nested">
          ...
          <details className="result-category" id="q3d-key-takeaways"><summary>Key Takeaways</summary>
            ...
            <div className="parameter-table"><article><strong>RLGC Matrices</strong><span>R, L, G, C matrices from Q3D are the primary inputs to circuit Hamiltonian models. Even small parasitic entries shift qubit frequencies by 10–100 MHz.</span></article><article><strong>Superconducting Regime</strong><span>At 4K, Al and Nb become superconducting → R→0, \(L_k\) dominates. Normal-metal values from Q3D need T-dependent correction.</span></article><article><strong>Surface Participation</strong><span>SPR × tan δ controls T₁. Design rule: minimise p_MA below 5 ppm via thick metal, wider CPW gaps, and clean interfaces.</span></article><article><strong>Derived Outputs</strong><span>Ec, Ej, g, chi, ζ, Γ_P are all computed from Q3D matrices. Iterating Q3D → Hamiltonian → optimise is the standard qubit design loop.</span></article></div>
        ...
        <details className="result-sheet result-root"><summary><span>EPR / scQubits Result Tables</span><small>Workbook sheets as learning subcolumns</small></summary><div className="result-nested">
          ...
          <details className="result-category" id="epr-resonator-coupling"><summary>Resonator {"&"} Coupling</summary>
            ...
            <div className="result-nested inner">
              ...
              <details className="result-subcategory"><summary>A. Resonator Properties</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Description</th><th>Optimal / Best Value</th><th>Good Range</th><th>Acceptable Range</th><th>Poor / Worst Value</th><th>Physical Significance</th><th>Key References</th></tr></thead><tbody><tr><td>Resonator Frequency</td><td>omega_r / 2pi</td><td>GHz</td><td>Bare resonator frequency; should be detuned from qubit to remain in dispersive regime.</td><td>6.5 – 8.5 GHz</td><td>5 – 10 GHz</td><td>3 – 5 GHz</td><td>{"<"} 2 GHz</td><td>Must satisfy |Δ| = |ω_q - ω_r| {">"}{">"} g for dispersive approximation; EPR gives bare frequency.</td><td>Blais et al., PRA 2004; Wallraff et al., Nature 2004</td></tr><tr><td>Resonator Internal Q</td><td>Q_int</td><td>dimensionless</td><td>Internal (material-limited) quality factor of the readout resonator.</td><td>{">"} 10⁵</td><td>10⁴ – 10⁵</td><td>10³ – 10⁴</td><td>{"<"} 500</td><td>Low Q_int adds photon loss increasing measurement back-action and reducing readout SNR.</td><td>Megrant et al., APL 2012; Calusine et al., APL 2018</td></tr><tr><td>Resonator External Q</td><td>Q_ext</td><td>dimensionless</td><td>External quality factor set by coupling to transmission line; determines measurement bandwidth.</td><td>10³ – 10⁴ (fast readout)</td><td>500 – 2×10⁴</td><td>50 – 499</td><td>{"<"} 50</td><td>Too high → slow readout; too low → Purcell-enhanced qubit decay. Optimized with Purcell filter.</td><td>Reed et al., APL 2010; Houck et al., PRL 2008</td></tr><tr><td>Resonator–Qubit Detuning |Δ|</td><td>|Δ|/2π</td><td>GHz</td><td>Frequency detuning between qubit and resonator; must be large compared to coupling g.</td><td>1.0 – 3.0 GHz</td><td>0.5 – 4.0 GHz</td><td>0.1 – 0.5 GHz</td><td>{"<"} 0.05 GHz</td><td>Small detuning violates dispersive approximation; EPR hybridization factor chi tracks this.</td><td>Blais et al., PRA 2004; Gambetta et al., PRA 2006</td></tr><tr><td>Purcell Decay Rate</td><td>γ_P/2π</td><td>kHz</td><td>Qubit decay rate via resonator Purcell channel; κ * (g/Δ)². Must be {"<"}{"<"} 1/T1_target.</td><td>{"<"} 1 kHz</td><td>1 – 10 kHz</td><td>10 – 100 kHz</td><td>{">"} 500 kHz</td><td>Dominant T_1 limit in many designs without Purcell filter; directly predicted by EPR p_J^res.</td><td>Houck et al., PRL 2008; Reed et al., APL 2010</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>B. Coupling Strengths</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Description</th><th>Optimal / Best Value</th><th>Good Range</th><th>Acceptable Range</th><th>Poor / Worst Value</th><th>Physical Significance</th><th>Key References</th></tr></thead><tbody><tr><td>Transverse Coupling g / 2pi</td><td>g / 2pi</td><td>MHz</td><td>Qubit-resonator coupling strength (Jaynes-Cummings); extracted from EPR as g = √(p_J^res * ω_r * ω_q / 2).</td><td>50 – 150 MHz</td><td>20 – 200 MHz</td><td>5 – 19 MHz</td><td>{"<"} 2 MHz</td><td>Sets χ and readout speed; g/|Δ| {"<"} 0.1 required for dispersive regime.</td><td>Wallraff et al., Nature 2004; Krantz et al., APR 2019</td></tr><tr><td>Dispersive Coupling g/Δ ratio</td><td>g/|Δ|</td><td>dimensionless</td><td>Dimensionless ratio quantifying proximity to strong-coupling limit; must be {"<"}{"<"} 1 for dispersive readout.</td><td>0.01 – 0.05</td><td>0.005 – 0.09</td><td>0.09 – 0.15</td><td>{">"} 0.20</td><td>Ratio {">"} 0.1 causes photon-number-dependent qubit dephasing and higher-order dispersive corrections.</td><td>Gambetta et al., PRA 2006; Boissonneault et al., PRA 2009</td></tr><tr><td>Bus Coupler Coupling (2Q)</td><td>J / 2pi</td><td>MHz</td><td>Exchange coupling between two qubits via bus resonator or direct capacitance.</td><td>5 – 20 MHz</td><td>2 – 30 MHz</td><td>0.5 – 1.9 MHz</td><td>{"<"} 0.1 MHz</td><td>Too weak → slow two-qubit gates; too strong → residual ZZ. EPR predicts J from geometry.</td><td>Majer et al., Nature 2007; Chen et al., PRL 2014</td></tr><tr><td>Residual ZZ (static)</td><td>zeta_ZZ / 2pi</td><td>kHz</td><td>Always-on longitudinal (ZZ) qubit–qubit interaction; source of conditional phase errors.</td><td>{"<"} 10 kHz</td><td>{"<"} 100 kHz</td><td>100 – 500 kHz</td><td>{">"} 1 MHz</td><td>Limits two-qubit gate fidelity via conditional phase accumulation; minimized by tunable couplers.</td><td>Ku et al., PRL 2020; Kandala et al., Nature 2021</td></tr><tr><td>Stray Coupling (nearest-neighbor)</td><td>J_stray / 2pi</td><td>kHz</td><td>Unintended coupling between non-adjacent qubits; extracted from full-chip EPR simulation.</td><td>{"<"} 10 kHz</td><td>{"<"} 50 kHz</td><td>50 – 200 kHz</td><td>{">"} 500 kHz</td><td>Degrades multi-qubit gate fidelity; EPR full-chip simulation essential to identify stray modes.</td><td>Arute et al., Nature 2019; Hertzberg et al., npj QI 2021</td></tr></tbody></table></div></details>
          ...
          <details className="result-category" id="epr-loss-dissipation"><summary>Loss {"&"} Dissipation</summary>
            ...
            <div className="result-nested inner">
              ...
              <details className="result-subcategory"><summary>A. Dielectric Loss (Bulk {"&"} Surface)</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Description</th><th>Optimal / Best Value</th><th>Good Range</th><th>Acceptable Range</th><th>Poor / Worst Value</th><th>Physical Significance</th><th>Key References</th></tr></thead><tbody><tr><td>Bulk Substrate Loss Tangent</td><td>tan delta_bulk</td><td>dimensionless</td><td>Intrinsic dielectric loss of the substrate material (Si, sapphire, SiO2); weighted by bulk EPR participation.</td><td>{"<"} 1×10⁻⁷ (Si, sapphire)</td><td>{"<"} 1×10⁻⁶</td><td>1×10⁻⁶ – 1×10⁻⁵</td><td>{">"} 1×10⁻⁴</td><td>Silicon and sapphire are preferred substrates; amorphous SiO2 has tan δ ~ 10⁻³ (very poor).</td><td>Martinis et al., PRL 2005; Calusine et al., APL 2018</td></tr><tr><td>Metal-Substrate Interface Loss</td><td>tan delta_MS</td><td>dimensionless</td><td>Effective loss tangent of metal–substrate (MS) two-level system (TLS) interface layer.</td><td>{"<"} 1×10⁻³</td><td>{"<"} 3×10⁻³</td><td>3×10⁻³ – 1×10⁻²</td><td>{">"} 5×10⁻²</td><td>MS interface is typically 2–5 nm thick oxide layer; dominant loss in many planar qubits.</td><td>Wang et al., APL 2015; Niepce et al., PRApplied 2019</td></tr><tr><td>Substrate-Air Interface Loss</td><td>tan delta_SA</td><td>dimensionless</td><td>Effective loss tangent of substrate–air (SA) interface; due to adsorbed surface oxides and organics.</td><td>{"<"} 3×10⁻³</td><td>{"<"} 1×10⁻²</td><td>1×10⁻² – 5×10⁻²</td><td>{">"} 0.1</td><td>Cleaning and surface passivation reduce SA loss; participation ratio from EPR isolates this channel.</td><td>Wenner et al., APL 2011; Quintana et al., APL 2014</td></tr><tr><td>Metal-Air Interface Loss</td><td>tan delta_MA</td><td>dimensionless</td><td>Effective loss tangent of metal–air (MA) interface; native oxide on superconducting film top surface.</td><td>{"<"} 3×10⁻³</td><td>{"<"} 1×10⁻²</td><td>1×10⁻² – 5×10⁻²</td><td>{">"} 0.1</td><td>Nb and Al form native oxides; replacing top surface with clean metal reduces MA loss.</td><td>Sandberg et al., APL 2012; Nersisyan et al., Quantum 2019</td></tr><tr><td>Surface Participation Ratio (MS)</td><td>p_MS</td><td>dimensionless</td><td>Fraction of electric field energy in metal-substrate interface region; computed from EPR E-field.</td><td>{"<"} 5×10⁻⁴</td><td>{"<"} 2×10⁻³</td><td>2×10⁻³ – 1×10⁻²</td><td>{">"} 5×10⁻²</td><td>Thinner gaps increase p_MS; EPR identifies geometry changes to reduce interface participation.</td><td>Wenner et al., APL 2011; Gambetta et al., npj QI 2017</td></tr><tr><td>TLS-Limited Quality Factor (1/f)</td><td>Q_TLS</td><td>dimensionless</td><td>Quality factor limited by two-level system (TLS) bath; power- and temperature-dependent.</td><td>{">"} 3×10⁶</td><td>10⁶ – 3×10⁶</td><td>10⁵ – 10⁶</td><td>{"<"} 10⁴</td><td>Q_TLS improves with high drive power (TLS saturation); EPR participations give TLS contribution breakdown.</td><td>Martinis et al., PRL 2005; Müller et al., PRB 2019</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>B. Radiation {"&"} Geometry Loss</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Description</th><th>Optimal / Best Value</th><th>Good Range</th><th>Acceptable Range</th><th>Poor / Worst Value</th><th>Physical Significance</th><th>Key References</th></tr></thead><tbody><tr><td>Radiation Loss Rate</td><td>gamma_rad / 2pi</td><td>kHz</td><td>Energy loss due to electromagnetic radiation from non-closed geometry; computed by EPR from far-field.</td><td>{"<"} 1 kHz</td><td>{"<"} 10 kHz</td><td>10 – 100 kHz</td><td>{">"} 500 kHz</td><td>Open transmission line stubs or poorly designed ground planes lead to radiation loss.</td><td>Houck et al., PRL 2008; Solgun et al., PRApplied 2019</td></tr><tr><td>Seam Loss (3D cavities)</td><td>gamma_seam / 2pi</td><td>kHz</td><td>Loss at mechanical seam between cavity halves; critical for 3D transmon and fluxonium devices.</td><td>{"<"} 1 kHz</td><td>{"<"} 5 kHz</td><td>5 – 50 kHz</td><td>{">"} 200 kHz</td><td>EPR current participation at seam predicts seam loss; improved by indium bonding or tight tolerances.</td><td>Reagor et al., PRB 2016; Brecht et al., npj QI 2016</td></tr><tr><td>Quasiparticle Loss Rate</td><td>gamma_qp / 2pi</td><td>kHz</td><td>Qubit decay due to nonequilibrium quasiparticles tunneling across junction.</td><td>{"<"} 2 kHz</td><td>{"<"} 20 kHz</td><td>20 – 100 kHz</td><td>{">"} 500 kHz</td><td>Quasiparticle poisoning is stochastic; mitigated by gap engineering and quasiparticle traps.</td><td>Catelani et al., PRL 2011; Serniak et al., PRL 2018</td></tr><tr><td>Vortex Loss (in-field operation)</td><td>gamma_vortex / 2pi</td><td>kHz</td><td>Loss from magnetic vortices in superconducting film when operated in residual magnetic field.</td><td>{"<"} 1 kHz ({"<"} 1 µT shield)</td><td>{"<"} 10 kHz</td><td>10 – 100 kHz</td><td>{">"} 500 kHz</td><td>Mitigated by magnetic shielding and moat structures; EPR current maps identify vortex-sensitive areas.</td><td>Stan et al., IEEE Trans. 2004; Chiaro et al., Supercond. Sci. Tech. 2016</td></tr><tr><td>Conductor (Ohmic) Loss</td><td>gamma_ohm / 2pi</td><td>kHz</td><td>Residual ohmic loss from non-superconducting regions or above Tc contributions; usually negligible in Al.</td><td>{"<"} 0.1 kHz</td><td>{"<"} 1 kHz</td><td>1 – 10 kHz</td><td>{">"} 100 kHz</td><td>Typically negligible at mK temperatures; relevant for normal-metal contacts or resistive wirebonds.</td><td>Göppl et al., JAP 2008; Barends et al., APL 2010</td></tr></tbody></table></div></details>
          ...
          <details className="result-category" id="epr-junction-parameters"><summary>Junction Parameters</summary>
            ...
            <div className="result-nested inner">
              ...
              <details className="result-subcategory"><summary>A. Junction Electrical Parameters</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Description</th><th>Optimal / Best Value</th><th>Good Range</th><th>Acceptable Range</th><th>Poor / Worst Value</th><th>Physical Significance</th><th>Key References</th></tr></thead><tbody><tr><td>Josephson Inductance</td><td>L_J</td><td>nH</td><td>Linear (small-signal) inductance of Josephson junction; L_J = Φ₀ / (2π I_c). Central EPR input.</td><td>5 – 20 nH</td><td>2 – 50 nH</td><td>50 – 200 nH</td><td>{">"} 500 nH</td><td>Sets qubit frequency via ω_q = 1 / √(L_J * C_S); too large → very low frequency, thermally excited.</td><td>Koch et al., PRA 2007; Krantz et al., APR 2019</td></tr><tr><td>Critical Current</td><td>I_c</td><td>µA</td><td>Maximum supercurrent through junction; I_c = Φ₀ / (2π L_J). Sets EJ = I_c·Φ₀ / (2π).</td><td>20 – 80 nA (transmon)</td><td>5 – 200 nA</td><td>200 nA – 2 µA</td><td>{">"} 10 µA</td><td>Too high → small L_J → high frequency; too low → large L_J, strong flux noise sensitivity.</td><td>Dolan 1977 (shadow evaporation); Ambegaokar {"&"} Baratoff, PRL 1963</td></tr><tr><td>Critical Current Density</td><td>J_c</td><td>A/m²</td><td>Critical current per junction area; set by AlOx barrier thickness during deposition.</td><td>100 – 500 A/m²</td><td>50 – 1000 A/m²</td><td>1000 – 5000 A/m²</td><td>{">"} 10⁴ A/m²</td><td>Reproducibility of J_c determines frequency spread; EPR sensitivity analysis relates Jc to ω_q.</td><td>Pop et al., Nature 2014; Osman et al., npj QI 2023</td></tr><tr><td>Junction Capacitance</td><td>C_J</td><td>fF</td><td>Self-capacitance of the junction; contributes to total qubit capacitance C_S.</td><td>2 – 10 fF</td><td>1 – 20 fF</td><td>20 – 100 fF</td><td>{">"} 200 fF</td><td>Large C_J reduces charging energy EC, lowering anharmonicity; EPR partitions C_J from shunt.</td><td>Koch et al., PRA 2007; Yan et al., PRApplied 2016</td></tr><tr><td>Junction Area</td><td>A_J</td><td>µm²</td><td>Physical overlap area of the junction; A_J = I_c/J_c. Fabrication controlled.</td><td>0.01 – 0.1 µm²</td><td>0.005 – 0.5 µm²</td><td>0.5 – 2 µm²</td><td>{">"} 5 µm²</td><td>Larger area → larger C_J and lower EC; smaller area → harder fabrication, larger variation.</td><td>Kreikebaum et al., npj QI 2020; Hertzberg et al., npj QI 2021</td></tr><tr><td>Josephson Energy</td><td>E_J / h</td><td>GHz</td><td>Josephson energy EJ = I_c·Φ₀ / (2π); governs tunneling energy.</td><td>10 – 50 GHz</td><td>5 – 100 GHz</td><td>100 – 500 GHz</td><td>{">"} 1 THz</td><td>With EC, determines qubit spectrum; EJ/EC {">"} 50 for transmon regime.</td><td>Koch et al., PRA 2007; Nakamura et al., Nature 1999</td></tr><tr><td>Charging Energy</td><td>E_C / h</td><td>MHz</td><td>Charging energy EC = e²/(2C_S); determines anharmonicity and charge sensitivity.</td><td>150 – 350 MHz</td><td>100 – 500 MHz</td><td>500 MHz – 1 GHz</td><td>{">"} 2 GHz</td><td>EC ~ anharmonicity for transmon; high EC → charge qubit regime, high noise sensitivity.</td><td>Koch et al., PRA 2007; Schreier et al., PRB 2008</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>B. Junction Loss {"&"} Quality</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Description</th><th>Optimal / Best Value</th><th>Good Range</th><th>Acceptable Range</th><th>Poor / Worst Value</th><th>Physical Significance</th><th>Key References</th></tr></thead><tbody><tr><td>Junction Loss Tangent</td><td>tan delta_J</td><td>dimensionless</td><td>Intrinsic dielectric loss of AlOx tunnel barrier; limits junction Q and T_1.</td><td>{"<"} 3×10⁻⁶</td><td>{"<"} 1×10⁻⁵</td><td>1×10⁻⁵ – 1×10⁻⁴</td><td>{">"} 1×10⁻³</td><td>TLS in AlOx barrier is historically the primary T_1 limit; improved by ALD or crystalline barriers.</td><td>Martinis et al., PRL 2005; Müller et al., PRB 2019</td></tr><tr><td>Junction Subgap Resistance</td><td>R_sg</td><td>GΩ</td><td>Subgap resistance of junction; represents quasiparticle leakage channel.</td><td>{">"} 100 GΩ</td><td>10 – 100 GΩ</td><td>1 – 10 GΩ</td><td>{"<"} 100 MΩ</td><td>Low R_sg indicates excess quasiparticle density; limits T_1 via quasiparticle poisoning.</td><td>Aumentado et al., PRL 2004; Aumentado et workbook. J. Low Temp. Phys. 2011</td></tr><tr><td>Flux Noise Spectral Density</td><td>S_Φ(1Hz)</td><td>µΦ₀²/Hz</td><td>Amplitude of 1/f flux noise at 1 Hz; governs dephasing for flux-sensitive qubits.</td><td>{"<"} 1 µΦ₀²/Hz</td><td>1 – 5 µΦ₀²/Hz</td><td>5 – 20 µΦ₀²/Hz</td><td>{">"} 50 µΦ₀²/Hz</td><td>Arises from surface spin fluctuators; EPR current participation at surfaces informs sensitivity.</td><td>Yoshihara et al., PRL 2006; Bialczak et al., PRL 2007</td></tr><tr><td>Charge Noise Spectral Density</td><td>S_q(1Hz)</td><td>e²/Hz</td><td>Amplitude of 1/f charge noise; relevant for charge-sensitive qubits.</td><td>{"<"} 10⁻⁷ e²/Hz</td><td>{"<"} 10⁻⁶ e²/Hz</td><td>10⁻⁶ – 10⁻⁵ e²/Hz</td><td>{">"} 10⁻⁴ e²/Hz</td><td>Exponentially suppressed in transmon regime; relevant for qubits with EJ/EC {"<"} 20.</td><td>Ithier et al., PRB 2005; Paladino et al., RMP 2014</td></tr></tbody></table></div></details>
          ...
          <details className="result-category" id="epr-summary-table"><summary>Summary Table</summary>
            ...
            <div className="result-nested inner">
              ...
              <details className="result-subcategory"><summary>Core EPR</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>1</td><td>Core EPR</td><td>Junction Participation Ratio</td><td>p_J</td><td>—</td><td>0.90–0.99</td><td>0.80–0.99</td><td>0.50–0.79</td><td>{"<"} 0.30</td><td>Sets anharmonicity {"&"} qubit nonlinearity</td><td>Increase pad size, reduce gap to substrate</td><td>Minev et al., Nature 2021</td></tr><tr><td>2</td><td>Core EPR</td><td>Resonator Junction Participation</td><td>p_J^res</td><td>—</td><td>{"<"} 1×10⁻³</td><td>{"<"} 1×10⁻²</td><td>1×10⁻²–5×10⁻²</td><td>{">"} 0.10</td><td>Determines Purcell T_1 limit</td><td>Increase qubit-resonator detuning</td><td>Reed et al., PRL 2010</td></tr><tr><td>3</td><td>Core EPR</td><td>ZPF Voltage across Junction</td><td>V_zpf</td><td>µV</td><td>10–50 µV</td><td>5–100 µV</td><td>1–200 µV</td><td>{"<"} 0.5 µV</td><td>Governs qubit-photon coupling</td><td>Optimise mode volume and pad geometry</td><td>Minev et al., Nature 2021</td></tr><tr><td>4</td><td>Core EPR</td><td>ZPF Phase</td><td>varphi_zpf</td><td>rad</td><td>0.1–0.5 rad</td><td>0.05–0.6 rad</td><td>0.6–0.9 rad</td><td>{">"} 1.0 rad</td><td>Validity of dispersive approximation</td><td>Reduce anharmonicity target or redesign</td><td>Minev Thesis 2018</td></tr><tr><td>5</td><td>Core EPR</td><td>Anharmonicity (EPR)</td><td>alpha / 2pi</td><td>MHz</td><td>150–350 MHz</td><td>100–400 MHz</td><td>50–99 MHz</td><td>{"<"} 30 MHz</td><td>Gate speed and leakage limit</td><td>Lower E_J / E_C ratio; smaller junction</td><td>Koch et al., PRA 2007</td></tr><tr><td>6</td><td>Core EPR</td><td>Dispersive Shift chi</td><td>chi/2π</td><td>MHz</td><td>0.5–3 MHz</td><td>0.1–5 MHz</td><td>0.01–0.09 MHz</td><td>{"<"} 0.01 MHz</td><td>Readout contrast</td><td>Adjust g/|Δ| ratio via geometry</td><td>Blais et al., PRA 2004</td></tr><tr><td>7</td><td>Core EPR</td><td>Cross-Kerr ZZ</td><td>zeta_ij / 2pi</td><td>MHz</td><td>{"<"} 0.01 MHz</td><td>{"<"} 0.10 MHz</td><td>0.10–0.50 MHz</td><td>{">"} 1.0 MHz</td><td>Always-on 2Q gate error</td><td>Tunable coupler; echo sequences</td><td>Kandala et al., Nature 2021</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>Qubit Performance</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>8</td><td>Qubit Performance</td><td>Energy Relaxation T_1</td><td>T_1</td><td>µs</td><td>{">"} 500 µs</td><td>100–500 µs</td><td>10–99 µs</td><td>{"<"} 1 µs</td><td>Hard limit on gate fidelity</td><td>Reduce dominant loss channel from EPR</td><td>Wang et al., PRApplied 2022</td></tr><tr><td>9</td><td>Qubit Performance</td><td>Coherence Time T2*</td><td>T2*</td><td>µs</td><td>{">"} 300 µs</td><td>100–300 µs</td><td>20–99 µs</td><td>{"<"} 10 µs</td><td>Practical dephasing limit</td><td>Reduce flux/charge noise; surface cleaning</td><td>Krantz et al., APR 2019</td></tr><tr><td>10</td><td>Qubit Performance</td><td>Qubit Quality Factor</td><td>Q_q</td><td>—</td><td>{">"} 10⁷</td><td>10⁶–10⁷</td><td>10⁵–10⁶</td><td>{"<"} 10⁴</td><td>Universal figure of merit</td><td>Reduce all participation-weighted losses</td><td>Ganjam et al., NC 2023</td></tr><tr><td>11</td><td>Qubit Performance</td><td>Single-Qubit Gate Fidelity</td><td>F_1Q</td><td>%</td><td>{">"} 99.9%</td><td>99.5–99.9%</td><td>99.0–99.4%</td><td>{"<"} 98%</td><td>Surface-code threshold</td><td>Increase T_1/T2; optimise DRAG pulses</td><td>Barends et al., Nature 2014</td></tr><tr><td>12</td><td>Qubit Performance</td><td>Two-Qubit Gate Fidelity</td><td>F_2Q</td><td>%</td><td>{">"} 99.5%</td><td>99.0–99.5%</td><td>97.0–98.9%</td><td>{"<"} 95%</td><td>2Q error correction threshold</td><td>Reduce ZZ via tunable coupler design</td><td>Arute et al., Nature 2019</td></tr><tr><td>13</td><td>Qubit Performance</td><td>E_J / E_C Ratio</td><td>E_J / E_C</td><td>—</td><td>50–100</td><td>40–120</td><td>20–39</td><td>{"<"} 10</td><td>Charge noise protection</td><td>Increase shunt capacitance C_S</td><td>Koch et al., PRA 2007</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>Resonator & Coupling</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>14</td><td>Resonator & Coupling</td><td>Resonator Frequency</td><td>omega_r / 2pi</td><td>GHz</td><td>6.5–8.5 GHz</td><td>5–10 GHz</td><td>3–5 GHz</td><td>{"<"} 2 GHz</td><td>Dispersive regime requirement</td><td>Adjust resonator length/capacitance</td><td>Blais et al., PRA 2004</td></tr><tr><td>15</td><td>Resonator & Coupling</td><td>Resonator Internal Q</td><td>Q_int</td><td>—</td><td>{">"} 10⁵</td><td>10⁴–10⁵</td><td>10³–10⁴</td><td>{"<"} 500</td><td>Readout SNR and back-action</td><td>Improve substrate and metal quality</td><td>Megrant et al., APL 2012</td></tr><tr><td>16</td><td>Resonator & Coupling</td><td>Coupling Strength g / 2pi</td><td>g / 2pi</td><td>MHz</td><td>50–150 MHz</td><td>20–200 MHz</td><td>5–19 MHz</td><td>{"<"} 2 MHz</td><td>Sets chi and readout bandwidth</td><td>Adjust coupling capacitor geometry</td><td>Wallraff et al., Nature 2004</td></tr><tr><td>17</td><td>Resonator & Coupling</td><td>Purcell Decay Rate</td><td>γ_P/2π</td><td>kHz</td><td>{"<"} 1 kHz</td><td>1–10 kHz</td><td>10–100 kHz</td><td>{">"} 500 kHz</td><td>T_1 limit via resonator</td><td>Add Purcell filter; increase detuning</td><td>Houck et al., PRL 2008</td></tr><tr><td>18</td><td>Resonator & Coupling</td><td>Residual ZZ Static</td><td>zeta_ZZ / 2pi</td><td>kHz</td><td>{"<"} 10 kHz</td><td>{"<"} 100 kHz</td><td>100–500 kHz</td><td>{">"} 1 MHz</td><td>Conditional phase error</td><td>Tunable coupler; frequency detuning</td><td>Ku et al., PRL 2020</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>Loss & Dissipation</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>19</td><td>Loss & Dissipation</td><td>Bulk Substrate Loss Tangent</td><td>tan delta_bulk</td><td>—</td><td>{"<"} 1×10⁻⁷</td><td>{"<"} 1×10⁻⁶</td><td>1×10⁻⁶–1×10⁻⁵</td><td>{">"} 1×10⁻⁴</td><td>Bulk energy dissipation</td><td>Use float-zone Si or sapphire</td><td>Martinis et al., PRL 2005</td></tr><tr><td>20</td><td>Loss & Dissipation</td><td>Metal-Substrate Interface Loss</td><td>tan delta_MS</td><td>—</td><td>{"<"} 1×10⁻³</td><td>{"<"} 3×10⁻³</td><td>3×10⁻³–1×10⁻²</td><td>{">"} 5×10⁻²</td><td>Dominant TLS loss channel</td><td>Ion mill before deposition; clean surfaces</td><td>Wang et al., APL 2015</td></tr><tr><td>21</td><td>Loss & Dissipation</td><td>Surface Participation (MS)</td><td>p_MS</td><td>—</td><td>{"<"} 5×10⁻⁴</td><td>{"<"} 2×10⁻³</td><td>2×10⁻³–1×10⁻²</td><td>{">"} 5×10⁻²</td><td>Weights MS interface loss to T_1</td><td>Wider gaps; ground plane design</td><td>Wenner et al., APL 2011</td></tr><tr><td>22</td><td>Loss & Dissipation</td><td>TLS-Limited Q</td><td>Q_TLS</td><td>—</td><td>{">"} 3×10⁶</td><td>10⁶–3×10⁶</td><td>10⁵–10⁶</td><td>{"<"} 10⁴</td><td>TLS bath limitation</td><td>Surface treatment; new barrier materials</td><td>Müller et al., PRB 2019</td></tr><tr><td>23</td><td>Loss & Dissipation</td><td>Seam Loss Rate (3D)</td><td>gamma_seam / 2pi</td><td>kHz</td><td>{"<"} 1 kHz</td><td>{"<"} 5 kHz</td><td>5–50 kHz</td><td>{">"} 200 kHz</td><td>3D cavity assembly limit</td><td>Indium sealing; tighter tolerances</td><td>Reagor et al., PRB 2016</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>Junction Parameters</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>24</td><td>Junction Parameters</td><td>Josephson Inductance</td><td>L_J</td><td>nH</td><td>5–20 nH</td><td>2–50 nH</td><td>50–200 nH</td><td>{">"} 500 nH</td><td>Sets qubit frequency</td><td>Junction area and J_c control</td><td>Koch et al., PRA 2007</td></tr><tr><td>25</td><td>Junction Parameters</td><td>Josephson Energy</td><td>E_J / h</td><td>GHz</td><td>10–50 GHz</td><td>5–100 GHz</td><td>100–500 GHz</td><td>{">"} 1 THz</td><td>Qubit spectrum with EC</td><td>Barrier thickness and area</td><td>Nakamura et al., Nature 1999</td></tr><tr><td>26</td><td>Junction Parameters</td><td>Charging Energy</td><td>E_C / h</td><td>MHz</td><td>150–350 MHz</td><td>100–500 MHz</td><td>500–1000 MHz</td><td>{">"} 2 GHz</td><td>Anharmonicity and charge sensitivity</td><td>Shunt capacitor area tuning</td><td>Koch et al., PRA 2007</td></tr><tr><td>27</td><td>Junction Parameters</td><td>Junction Loss Tangent</td><td>tan delta_J</td><td>—</td><td>{"<"} 3×10⁻⁶</td><td>{"<"} 1×10⁻⁵</td><td>1×10⁻⁵–1×10⁻⁴</td><td>{">"} 1×10⁻³</td><td>Intrinsic junction T_1 limit</td><td>ALD AlOx; crystalline barriers</td><td>Martinis et al., PRL 2005</td></tr></tbody></table></div></details>

              <details className="result-subcategory"><summary>Simulation</summary><div className="result-table-wrap"><table className="data-table"><thead><tr><th>#</th><th>Category</th><th>Parameter</th><th>Symbol</th><th>Unit</th><th>Optimal Value</th><th>Good Range</th><th>Acceptable Range</th><th>Worst Value</th><th>Physical Significance</th><th>Improvement Strategy</th><th>Reference</th></tr></thead><tbody><tr><td>28</td><td>Simulation</td><td>Eigenfrequency Convergence</td><td>Delta f / f</td><td>ppm</td><td>{"<"} 5 ppm</td><td>{"<"} 50 ppm</td><td>50–500 ppm</td><td>{">"} 1000 ppm</td><td>Accuracy of all extracted parameters</td><td>More refinement passes; finer mesh</td><td>Minev Thesis Yale 2018</td></tr><tr><td>29</td><td>Simulation</td><td>Energy Error</td><td>Delta U / U</td><td>%</td><td>{"<"} 0.1%</td><td>{"<"} 0.5%</td><td>0.5–2%</td><td>{">"} 5%</td><td>Bounds participation ratio error</td><td>Increase mesh density at interfaces</td><td>Ansys HFSS Docs 2023</td></tr><tr><td>30</td><td>Simulation</td><td>Participation Sum Check</td><td>sum p</td><td>—</td><td>0.99–1.01</td><td>0.97–1.03</td><td>0.93–1.07</td><td>{"<"} 0.90 or {">"} 1.10</td><td>Simulation completeness check</td><td>Include all eigenmodes up to 20 GHz</td><td>Minev et al., Nature 2021</td></tr></tbody></table></div></details>
