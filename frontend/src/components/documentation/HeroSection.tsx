    ...
    <div className={cn("hero-section py-2", className)}>
      ...
      <div className="metrics-grid grid gap-3.5 grid-cols-1 sm:grid-cols-3">
        <DocumentationCard
          type="metric"
          title=".qc / .qcl"
          subtitle="source files for superconducting quantum chip descriptions"
        />
        <DocumentationCard
          type="metric"
          title="3"
          subtitle="compilation targets: Qiskit Metal, JSON IR, and SPICE"
        />
        <DocumentationCard
          type="metric"
          title="Production"
          subtitle="Enterprise-grade quantum chip synthesis and verification pipeline"
        />
      </div>
    </div>
  );
