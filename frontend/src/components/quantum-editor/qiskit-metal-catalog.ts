...
export const QISKIT_CATALOG: QiskitComponent[] = [
  ...
  },
  {
    ...
    defaultParams: {
      ...
      plate1_pos_y: "0",
      squid_gap: "100um",
      segment_a_length: "100um",
      segment_a_width: "10um",
      JJ_gap: "5um",
      segment_b_length: "50um",
      segment_b_width: "10um",
      segment_c_width: "10um",
  ...
  // ───────────── Resonators ─────────────
  {
    ...
    pins: ["readout"],
    tags: ["resonator", "readout", "cpw", "folded"],
  },
  {
