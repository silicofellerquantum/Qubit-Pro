 ...
 *    previously showed 50um as a placeholder hint ΓÇö 30um is the correct value.
 */

// ΓöÇΓöÇ Per-component default maps ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
 ...
 * - Partial match second (e.g. "RouteMeanderPathlength" ΓåÆ RouteMeander defaults).
...
export function getRouteDefaults(routeComponentId?: string): Record<string, string> {
    ...
    // Partial match ΓÇö case-insensitive substring
 ...
 * Existing user-set overrides in `current` are preserved and take precedence ΓÇö
